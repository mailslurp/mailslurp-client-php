...
class CreateWebhookOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets event_name
     *
     * @param string|null $event_name Optional webhook event name. Default is `EMAIL_RECEIVED`. Payload differ according to the webhook event name.
     *
     * @return $this
     */
     ...
     * Sets url
     *
     * @param string|null $url Public URL on your server that MailSlurp can post WebhookNotification payload to when an email is received. The payload of the submitted JSON is described by https://api.mailslurp.com/schemas/webhook-payload
     *
     * @return $this
     */

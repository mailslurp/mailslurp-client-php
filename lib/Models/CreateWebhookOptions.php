...
class CreateWebhookOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets url
     *
     * @param string $url Public URL on your server that MailSlurp can post WebhookNotification payload to when an email is received or an event is trigger. The payload of the submitted JSON is dependent on the webhook event type. The default `EMAIL_RECEIVED` payload is described by `https://php.api.mailslurp.com/schemas/webhook-payload`. The other events, `NEW_EMAIL`, `NEW_CONTACT`, and `NEW_ATTACHMENT` are described by `https://php.api.mailslurp.com/schemas/webhook-new-email-payload`, `https://php.api.mailslurp.com/schemas/webhook-new-contact-payload`,`https://php.api.mailslurp.com/schemas/webhook-new-attachment-payload` respectively.
     *
     * @return $this
     */

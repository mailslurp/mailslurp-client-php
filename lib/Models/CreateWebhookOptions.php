...
class CreateWebhookOptions implements ModelInterface, ArrayAccess
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['include_headers'] = isset($data['include_headers']) ? $data['include_headers'] : null;
    }
     ...
     * Sets event_name
     *
     * @param string $event_name Optional webhook event name. Default is `EMAIL_RECEIVED` and is triggered when an email is received by the inbox associated with the webhook. Payload differ according to the webhook event name.
     *
     * @return $this
     */

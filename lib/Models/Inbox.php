...
class Inbox implements ModelInterface, ArrayAccess
{
     ...
     * Sets read_only
     *
     * @param bool|null $read_only Is the inbox readOnly for the caller. Read only means can not be deleted or modified.
     *
     * @return $this
     */
     ...
     * Sets team_access
     *
     * @param bool|null $team_access Does inbox permit team access for organization team members. If so team users can use inbox and emails associated with it.
     *
     * @return $this
     */

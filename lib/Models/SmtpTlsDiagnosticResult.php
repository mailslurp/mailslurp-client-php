...
/**
 * SmtpTlsDiagnosticResult Class Doc Comment
 *
 * @category Class
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 ...
 */
class SmtpTlsDiagnosticResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmtpTlsDiagnosticResult';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('negotiated', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['negotiated'] === null) {
            $invalidProperties[] = "'negotiated' can't be null";
        }
    ...
    {
        return $this->container['negotiated'];
    }

    /**
     * Sets negotiated
     *
     * @param bool $negotiated negotiated
     *
     * @return self
     */
    public function setNegotiated($negotiated)
    {
        ...
        if (is_null($negotiated)) {
            throw new \InvalidArgumentException('non-nullable negotiated cannot be null');
        }

        $this->container['negotiated'] = $negotiated;

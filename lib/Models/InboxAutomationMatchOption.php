...
/**
 * InboxAutomationMatchOption Class Doc Comment
 *
 * @category Class
 * @description Single inbox automation match rule.
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class InboxAutomationMatchOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'InboxAutomationMatchOption';
    ...
    */
     ...
     * Sets field
     *
     * @param string $field Supported fields for inbox forwarder and replier automation matching.
     *
     * @return self
     */
     ...
     * Sets should
     *
     * @param string $should Comparison mode for inbox automation matching.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value Pattern or value to compare against the selected field.
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling InboxAutomationMatchOption., must be bigger than or equal to 1.');
        }

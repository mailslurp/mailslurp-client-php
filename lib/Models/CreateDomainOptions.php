...
class CreateDomainOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets domain_type
     *
     * @param string|null $domain_type Domain type to create. HTTP or SMTP domain. HTTP domain uses MailSlurps SES MX records. SMTP uses a custom SMTP server MX record
     *
     * @return $this
     */

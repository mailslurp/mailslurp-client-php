...
class CreateInboxDto implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param bool|null $allow_team_access Grant team access to this inbox and the emails that belong to it for team members of your organization.
     *
     * @return $this
     */
     ...
     * Sets inbox_type
     *
     * @param string|null $inbox_type HTTP (default) or SMTP inbox type. HTTP inboxes are best for testing while SMTP inboxes are more reliable for public inbound email consumption. When using custom domains the domain type must match the inbox type. HTTP inboxes are processed by AWS SES while SMTP inboxes use a custom mail server running at `mx.mailslurp.com`.
     *
     * @return $this
     */

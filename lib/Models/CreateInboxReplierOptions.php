...
class CreateInboxReplierOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets inbox_id
     *
     * @param string|null $inbox_id Inbox ID to attach replier to
     *
     * @return self
     */
     ...
     * Sets field
     *
     * @param string|null $field Field to match against to trigger inbox replier for inbound email
     *
     * @return self
     */
     ...
     * Sets match
     *
     * @param string|null $match String or wildcard style match for field specified when evaluating reply rules. Use `*` to match anything.
     *
     * @return self
     */

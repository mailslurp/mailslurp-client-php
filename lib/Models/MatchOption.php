...
class MatchOption implements ModelInterface, ArrayAccess
{
     ...
     * Sets field
     *
     * @param string|null $field Fields of an email object that can be used to filter results
     *
     * @return $this
     */
     ...
     * Sets should
     *
     * @param string|null $should How the value of the email field specified should be compared to the value given in the match options.
     *
     * @return $this
     */

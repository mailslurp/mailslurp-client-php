...
class InboxDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const FUNCTIONS_AS_ACCOUNT = 'ACCOUNT';
    public const FUNCTIONS_AS_GUEST = 'GUEST';
    public const FUNCTIONS_AS_OAUTH_CONNECTION_GMAIL = 'OAUTH_CONNECTION_GMAIL';
    ...
    public function getFunctionsAsAllowableValues()
    {
        return [
            ...
            self::FUNCTIONS_AS_ACCOUNT,
            self::FUNCTIONS_AS_GUEST,
            self::FUNCTIONS_AS_OAUTH_CONNECTION_GMAIL,
        ];
    }
    ...
    */
     ...
     * Sets user_id
     *
     * @param string $user_id ID of user that inbox belongs to
     *
     * @return self
     */
     ...
     * Sets local_part
     *
     * @param string|null $local_part Local part of email addresses before the @ symbol
     *
     * @return self
     */
     ...
     * Sets domain
     *
     * @param string|null $domain Domain name of the email address
     *
     * @return self
     */
     ...
     * Sets account_region
     *
     * @param string|null $account_region Region of the inbox
     *
     * @return self
     */

...
class SearchInboxesOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const INBOX_FUNCTION_ACCOUNT = 'ACCOUNT';
    public const INBOX_FUNCTION_GUEST = 'GUEST';
    public const INBOX_FUNCTION_OAUTH_CONNECTION_GMAIL = 'OAUTH_CONNECTION_GMAIL';
    ...
    public function getInboxFunctionAllowableValues()
    {
        return [
            ...
            self::INBOX_FUNCTION_ACCOUNT,
            self::INBOX_FUNCTION_GUEST,
            self::INBOX_FUNCTION_OAUTH_CONNECTION_GMAIL,
        ];
    }
    ...
    */
     ...
     * Sets search
     *
     * @param string|null $search Optionally filter by search words partial matching name and email address
     *
     * @return self
     */

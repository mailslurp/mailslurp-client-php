...
class TestNewInboxForwarderOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['inbox_forwarder_test_options'] = $data['inbox_forwarder_test_options'] ?? null;
        $this->container['create_inbox_forwarder_options'] = $data['create_inbox_forwarder_options'] ?? null;
    }

...
class SendEmailOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets from_name
     *
     * @param string|null $from_name Optional from name if not passed with address. If you set `useInboxName` to `true` the from field will include the inbox name as a display name
     *
     * @return self
     */

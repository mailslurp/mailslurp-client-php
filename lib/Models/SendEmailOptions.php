...
class SendEmailOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['add_tracking_pixel'] = $data['add_tracking_pixel'] ?? null;
        $this->container['filter_bounced_recipients'] = $data['filter_bounced_recipients'] ?? null;
        $this->container['validate_email_addresses'] = $data['validate_email_addresses'] ?? null;
    }
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['to_contacts']) && (count($this->container['to_contacts']) > 10)) {
            $invalidProperties[] = "invalid value for 'to_contacts', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['to_contacts']) && (count($this->container['to_contacts']) < 0)) {
            $invalidProperties[] = "invalid value for 'to_contacts', number of items must be greater than or equal to 0.";
        }

        if (!is_null($this->container['to']) && (count($this->container['to']) > 10)) {
            $invalidProperties[] = "invalid value for 'to', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['to']) && (count($this->container['to']) < 0)) {
            $invalidProperties[] = "invalid value for 'to', number of items must be greater than or equal to 0.";
        }

        if (!is_null($this->container['cc']) && (count($this->container['cc']) > 10)) {
            $invalidProperties[] = "invalid value for 'cc', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['cc']) && (count($this->container['cc']) < 0)) {
            $invalidProperties[] = "invalid value for 'cc', number of items must be greater than or equal to 0.";
        }

        if (!is_null($this->container['bcc']) && (count($this->container['bcc']) > 10)) {
            $invalidProperties[] = "invalid value for 'bcc', number of items must be less than or equal to 10.";
        }

        if (!is_null($this->container['bcc']) && (count($this->container['bcc']) < 0)) {
            $invalidProperties[] = "invalid value for 'bcc', number of items must be greater than or equal to 0.";
        }
    ...
    public function setToContacts($to_contacts)
    {
        ...
        if (!is_null($to_contacts) && (count($to_contacts) > 10)) {
            throw new \InvalidArgumentException('invalid value for $to_contacts when calling SendEmailOptions., number of items must be less than or equal to 10.');
        }
        if (!is_null($to_contacts) && (count($to_contacts) < 0)) {
            throw new \InvalidArgumentException('invalid length for $to_contacts when calling SendEmailOptions., number of items must be greater than or equal to 0.');
        }
    ...
    public function setTo($to)
    {
        ...
        if (!is_null($to) && (count($to) > 10)) {
            throw new \InvalidArgumentException('invalid value for $to when calling SendEmailOptions., number of items must be less than or equal to 10.');
        }
        if (!is_null($to) && (count($to) < 0)) {
            throw new \InvalidArgumentException('invalid length for $to when calling SendEmailOptions., number of items must be greater than or equal to 0.');
        }
    ...
    public function setCc($cc)
    {
        ...
        if (!is_null($cc) && (count($cc) > 10)) {
            throw new \InvalidArgumentException('invalid value for $cc when calling SendEmailOptions., number of items must be less than or equal to 10.');
        }
        if (!is_null($cc) && (count($cc) < 0)) {
            throw new \InvalidArgumentException('invalid length for $cc when calling SendEmailOptions., number of items must be greater than or equal to 0.');
        }
    ...
    public function setBcc($bcc)
    {
        ...
        if (!is_null($bcc) && (count($bcc) > 10)) {
            throw new \InvalidArgumentException('invalid value for $bcc when calling SendEmailOptions., number of items must be less than or equal to 10.');
        }
        if (!is_null($bcc) && (count($bcc) < 0)) {
            throw new \InvalidArgumentException('invalid length for $bcc when calling SendEmailOptions., number of items must be greater than or equal to 0.');
        }

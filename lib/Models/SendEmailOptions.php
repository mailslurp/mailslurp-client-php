...
class SendEmailOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets html
     *
     * @param bool|null $html Optional HTML flag (Deprecated: use isHTML instead)
     *
     * @return $this
     */
     ...
     * Sets use_inbox_name
     *
     * @param bool|null $use_inbox_name Use name of inbox as sender email address name. Will construct RFC 5322 email address with `Inbox name <inbox@address.com>`
     *
     * @return $this
     */

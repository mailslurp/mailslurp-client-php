...
class OrganizationInboxProjection implements ModelInterface, ArrayAccess
{
     ...
     * Sets virtual_inbox
     *
     * @param bool|null $virtual_inbox Virtual inbox can receive email but will not send emails to real recipients. Will save sent email record but never send an actual email. Perfect for testing mail server actions.
     *
     * @return $this
     */

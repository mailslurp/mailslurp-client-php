...
class SmsPreview implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets body
     *
     * @param string $body TXT message content
     *
     * @return self
     */
     ...
     * Sets phone_number
     *
     * @param string $phone_number ID of the phone number that received this SMS
     *
     * @return self
     */
     ...
     * Sets read
     *
     * @param bool $read Is the message read or unread
     *
     * @return self
     */

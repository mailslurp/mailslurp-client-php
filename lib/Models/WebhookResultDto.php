...
class WebhookResultDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets webhook_event
     *
     * @param string|null $webhook_event webhook_event
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getWebhookEventAllowableValues();
        if (!is_null($webhook_event) && !in_array($webhook_event, $allowedValues, true)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'webhook_event', must be one of '%s'",
                    implode("', '", $allowedValues)
     ...
     *
     * @param int|null $response_time_millis response_time_millis
     *
     * @return $this
     */

...
class WebhookResultDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const WEBHOOK_EVENT_NEW_AI_TRANSFORM_RESULT = 'NEW_AI_TRANSFORM_RESULT';
    ...
    public const WEBHOOK_EVENT_NEW_GUEST_USER = 'NEW_GUEST_USER';
    ...
    public function getWebhookEventAllowableValues()
    {
        return [
            ...
            self::WEBHOOK_EVENT_NEW_AI_TRANSFORM_RESULT,
            ...
            self::WEBHOOK_EVENT_NEW_GUEST_USER,
        ];
    }
    ...
    */
    ...
    public function setAiTransformerId($ai_transformer_id)
    {
        ...
        if (is_null($ai_transformer_id)) {
            array_push($this->openAPINullablesSetToNull, 'ai_transformer_id');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ai_transformer_id', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }

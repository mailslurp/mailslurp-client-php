...
class CreateEmergencyAddressOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public const ISO_COUNTRY_CODE_CA = 'CA';
    public const ISO_COUNTRY_CODE_EE = 'EE';
    public const ISO_COUNTRY_CODE_HK = 'HK';
    public const ISO_COUNTRY_CODE_PL = 'PL';
    public const ISO_COUNTRY_CODE_CH = 'CH';
    public const ISO_COUNTRY_CODE_PT = 'PT';
    public const ISO_COUNTRY_CODE_NL = 'NL';
    public const ISO_COUNTRY_CODE_IL = 'IL';
    public const ISO_COUNTRY_CODE_SE = 'SE';
    ...
    public function getIsoCountryCodeAllowableValues()
    {
        return [
            ...
            self::ISO_COUNTRY_CODE_CA,
            self::ISO_COUNTRY_CODE_EE,
            self::ISO_COUNTRY_CODE_HK,
            self::ISO_COUNTRY_CODE_PL,
            self::ISO_COUNTRY_CODE_CH,
            self::ISO_COUNTRY_CODE_PT,
            self::ISO_COUNTRY_CODE_NL,
            self::ISO_COUNTRY_CODE_IL,
            self::ISO_COUNTRY_CODE_SE,
        ];
    }

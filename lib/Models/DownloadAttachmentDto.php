...
class DownloadAttachmentDto implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $base64_file_contents Base64 encoded string of attachment bytes. Decode the base64 string to get the raw file bytes
     *
     * @return $this
     */
     ...
     * Sets size_bytes
     *
     * @param int|null $size_bytes Size in bytes of attachment
     *
     * @return $this
     */

...
class DownloadAttachmentDto implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string|null $base64_file_contents Base64 encoded string of attachment bytes. Decode the base64 encoded string to get the raw contents. If the file has a content type such as `text/html` you can read the contents directly by converting it to string using `utf-8` encoding.
     *
     * @return $this
     */
     ...
     * Sets content_type
     *
     * @param string|null $content_type Content type of attachment. Examples are `image/png`, `application/msword`, `text/csv` etc.
     *
     * @return $this
     */
     ...
     * Sets size_bytes
     *
     * @param int|null $size_bytes Size in bytes of attachment content
     *
     * @return $this
     */

...
/**
 * MissedSmsDto Class Doc Comment
 *
 * @category Class
 * @description Missed SMS
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class MissedSmsDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'MissedSmsDto';
    ...
    */
     ...
     * Sets to_number
     *
     * @param string|null $to_number to_number
     *
     * @return self
     */
    public function setToNumber($to_number)
    {
        ...
        if (is_null($to_number)) {
            array_push($this->openAPINullablesSetToNull, 'to_number');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('to_number', $nullablesSetToNull);
            if ($index !== FALSE) {

...
class EmailProjection implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('imap_uid', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['imap_uid'];
    }

    /**
     * Sets imap_uid
     *
     * @param int|null $imap_uid imap_uid
     *
     * @return self
     */
    public function setImapUid($imap_uid)
    {

        if (is_null($imap_uid)) {
            array_push($this->openAPINullablesSetToNull, 'imap_uid');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('imap_uid', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        ...
        $this->container['imap_uid'] = $imap_uid;

 ...
 * @link     https://openapi-generator.tech
 */
class VerifyEmailAddressOptions implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['mail_server_domain'] = isset($data['mail_server_domain']) ? $data['mail_server_domain'] : null;

...
class ExpirationDefaults implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['default_expiration_millis'] = $data['default_expiration_millis'] ?? null;
        $this->container['max_expiration_millis'] = $data['max_expiration_millis'] ?? null;
        $this->container['default_expires_at'] = $data['default_expires_at'] ?? null;
        $this->container['can_permanent_inbox'] = $data['can_permanent_inbox'] ?? null;
        $this->container['next_inbox_allows_permanent'] = $data['next_inbox_allows_permanent'] ?? null;
    }

...
class WaitForConditions implements ModelInterface, ArrayAccess
{
     ...
     * Sets count
     *
     * @param int|null $count Number of results that should match conditions
     *
     * @return $this
     */
     ...
     * Sets count_type
     *
     * @param string|null $count_type Should exactly count number of results be returned or at least that many.
     *
     * @return $this
     */
     ...
     * Sets inbox_id
     *
     * @param string|null $inbox_id Inbox to search within
     *
     * @return $this
     */
     ...
     * Sets matches
     *
     * @param \MailSlurp\Models\MatchOption[]|null $matches Conditions that should be matched
     *
     * @return $this
     */
     ...
     * Sets timeout
     *
     * @param int|null $timeout Max time in milliseconds to wait until conditions are met
     *
     * @return $this
     */
     ...
     * Sets unread_only
     *
     * @param bool|null $unread_only Apply only to unread emails
     *
     * @return $this
     */

...
class WaitForConditions implements ModelInterface, ArrayAccess
{
     ...
     * Sets count_type
     *
     * @param string|null $count_type How should the found count be compared to the expected count.
     *
     * @return $this
     */
     ...
     * Sets inbox_id
     *
     * @param string|null $inbox_id ID of inbox to search within and apply conditions to. Essentially filtering the emails found to give a count.
     *
     * @return $this
     */
     ...
     * Sets timeout
     *
     * @param int|null $timeout Max time in milliseconds to retry the `waitFor` operation until conditions are met.
     *
     * @return $this
     */

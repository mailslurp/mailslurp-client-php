...
class InboxForwarderTestOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets test_value
     *
     * @param string|null $test_value Simple value to test against the forwarder's simple field/match rule. Required when emailId is not provided.
     *
     * @return self
     */
    public function setTestValue($test_value)
    {
        ...
        if (is_null($test_value)) {
            array_push($this->openAPINullablesSetToNull, 'test_value');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('test_value', $nullablesSetToNull);
            if ($index !== FALSE) {
     ...
     * Sets email_id
     *
     * @param string|null $email_id Optional email ID to evaluate the forwarder using full inbound email content (headers, recipients, and attachments).
     *
     * @return self
     */

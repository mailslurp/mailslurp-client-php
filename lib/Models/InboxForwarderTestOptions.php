 ...
 * @link     https://openapi-generator.tech
 */
class InboxForwarderTestOptions implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['test_value'] = isset($data['test_value']) ? $data['test_value'] : null;
    }
     ...
     * Sets test_value
     *
     * @param string|null $test_value test_value
     *
     * @return $this
     */

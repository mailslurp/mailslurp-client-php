...
class WebhookEmailOpenedPayload implements ModelInterface, ArrayAccess
{
     ...
     * Sets pixel_id
     *
     * @param string|null $pixel_id ID of the tracking pixel
     *
     * @return $this
     */
     ...
     * Sets recipient
     *
     * @param string|null $recipient Email address for the recipient of the tracking pixel
     *
     * @return $this
     */
     ...
     * Sets sent_email_id
     *
     * @param string|null $sent_email_id ID of sent email
     *
     * @return $this
     */

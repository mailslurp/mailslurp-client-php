...
/**
 * AIMappingMatchOption Class Doc Comment
 *
 * @category Class
 * @description Options for matching when an AI transform mapping should trigger. Each match option object contains a &#x60;field&#x60;, &#x60;should&#x60; and &#x60;value&#x60; property. Together they form logical conditions such as &#x60;SUBJECT&#x60; should &#x60;CONTAIN&#x60; value.
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class AIMappingMatchOption implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'AIMappingMatchOption';
    ...
    */
     ...
     * Sets field
     *
     * @param string $field Fields of an email, sms, or attachment object that can be used to filter results
     *
     * @return self
     */
     ...
     * Sets should
     *
     * @param string $should How the value of the field specified should be compared to the value given in the match options.
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param string $value The value you wish to compare with the value of the field specified using the `should` value passed. For example `BODY` should `CONTAIN` a value passed. When should value is `MATCH` pass a regex
     *
     * @return self
     */
    public function setValue($value)
    {
        ...
        if ((mb_strlen($value) < 1)) {
            throw new \InvalidArgumentException('invalid length for $value when calling AIMappingMatchOption., must be bigger than or equal to 1.');
        }

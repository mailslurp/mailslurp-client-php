...
class Email implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
     ...
     * Sets external_id
     *
     * @param string|null $external_id UID used by external IMAP server to identify email
     *
     * @return self
     */
     ...
     * Sets favourite
     *
     * @param bool|null $favourite Is email favourited
     *
     * @return self
     */
     ...
     * Sets size_bytes
     *
     * @param int|null $size_bytes Size of raw email message in bytes
     *
     * @return self
     */

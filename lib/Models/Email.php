...
class Email implements ModelInterface, ArrayAccess
{
     ...
     * Sets body_excerpt
     *
     * @param string|null $body_excerpt An excerpt of the body of the email message
     *
     * @return $this
     */
     ...
     * Sets read
     *
     * @param bool|null $read Read flag. Has the email ever been viewed in the dashboard or fetched via the API? If so the email is marked as read.
     *
     * @return $this
     */

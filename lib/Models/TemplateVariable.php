 ...
 * @link     https://openapi-generator.tech
 */
class TemplateVariable implements ModelInterface, ArrayAccess
{
    ...
    public function listInvalidProperties()
    {
        ...
        if (!is_null($this->container['variable_type']) && !in_array($this->container['variable_type'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value for 'variable_type', must be one of '%s'",
     ...
     * Sets variable_type
     *
     * @param string|null $variable_type variable_type
     *
     * @return $this
     */
    ...
    {
        $allowedValues = $this->getVariableTypeAllowableValues();
        if (!is_null($variable_type) && !in_array($variable_type, $allowedValues, true)) {

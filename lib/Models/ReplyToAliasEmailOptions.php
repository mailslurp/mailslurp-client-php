...
class ReplyToAliasEmailOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets body
     *
     * @param string|null $body Body of the reply email you want to send
     *
     * @return $this
     */
     ...
     * Sets is_html
     *
     * @param bool|null $is_html Is the reply HTML
     *
     * @return $this
     */
     ...
     * Sets send_strategy
     *
     * @param string|null $send_strategy When to send the email. Typically immediately
     *
     * @return $this
     */
     ...
     *
     * @param object|null $template_variables Template variables if using a template
     *
     * @return $this
     */

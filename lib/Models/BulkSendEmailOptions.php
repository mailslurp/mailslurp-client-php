...
class BulkSendEmailOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['inbox_ids']) < 1)) {
            $invalidProperties[] = "invalid value for 'inbox_ids', number of items must be greater than or equal to 1.";
        }
    ...
    public function setInboxIds($inbox_ids)
    {
        ...
        if ((count($inbox_ids) < 1)) {
            throw new \InvalidArgumentException('invalid length for $inbox_ids when calling BulkSendEmailOptions., number of items must be greater than or equal to 1.');
        }

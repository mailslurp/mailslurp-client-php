...
class PageSentEmailProjection implements ModelInterface, ArrayAccess
{
     ...
     * Sets content
     *
     * @param \MailSlurp\Models\SentEmailProjection[]|null $content Collection of items
     *
     * @return $this
     */
     ...
     * Sets number
     *
     * @param int|null $number Page number starting at 0
     *
     * @return $this
     */
     ...
     *
     * @param int|null $number_of_elements Number of items returned
     *
     * @return $this
     */
     ...
     * Sets size
     *
     * @param int|null $size Size of page requested
     *
     * @return $this
     */
     ...
     * Sets total_elements
     *
     * @param int|null $total_elements Total number of items available for querying
     *
     * @return $this
     */

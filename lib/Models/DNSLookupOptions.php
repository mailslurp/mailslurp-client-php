...
class DNSLookupOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((count($this->container['record_types']) < 1)) {
            $invalidProperties[] = "invalid value for 'record_types', number of items must be greater than or equal to 1.";
        }
    ...
    public function setHostname($hostname)
    {
        ...
        if ((mb_strlen($hostname) < 1)) {
            throw new \InvalidArgumentException('invalid length for $hostname when calling DNSLookupOptions., must be bigger than or equal to 1.');
        }
    ...
    public function setRecordTypes($record_types)
    {
        ...
        if ((count($record_types) < 1)) {
            throw new \InvalidArgumentException('invalid length for $record_types when calling DNSLookupOptions., number of items must be greater than or equal to 1.');
        }

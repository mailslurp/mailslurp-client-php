...
class DNSLookupOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets hostname
     *
     * @param string|null $hostname List of record types you wish to query such as MX, DNS, TXT, NS, A etc.
     *
     * @return $this
     */
     ...
     *
     * @param bool|null $omit_final_dns_dot Optionally control whether to omit the final dot in full DNS name values.
     *
     * @return $this
     */
     ...
     * Sets record_types
     *
     * @param string[]|null $record_types List of record types you wish to query such as MX, DNS, TXT, NS, A etc.
     *
     * @return $this
     */
    public function setRecordTypes($record_types)
    {
        ...
        if (!is_null($record_types) && array_diff($record_types, $allowedValues)) {

...
class DomainDto implements ModelInterface, ArrayAccess
{
     ...
     * Sets dkim_tokens
     *
     * @param string[]|null $dkim_tokens DNS records for DKIM approval
     *
     * @return $this
     */
     ...
     *
     * @param string|null $verification_token A TXT record that you must place in the DNS settings of the domain to complete domain verification
     *
     * @return $this
     */

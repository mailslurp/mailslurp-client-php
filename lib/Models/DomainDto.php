...
class DomainDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPIFormats = [
        ...
        'dkim_tokens' => null,
        'duplicate_records_message' => null,
        'has_duplicate_records' => null,
    ...
    protected static array $openAPINullables = [
		...
		'dkim_tokens' => false,
		'duplicate_records_message' => true,
		'has_duplicate_records' => false,
    ...
    protected static $setters = [
        ...
        'duplicate_records_message' => 'setDuplicateRecordsMessage',
        'has_duplicate_records' => 'setHasDuplicateRecords',
    ...
    protected static $getters = [
        ...
        'duplicate_records_message' => 'getDuplicateRecordsMessage',
        'has_duplicate_records' => 'getHasDuplicateRecords',
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('duplicate_records_message', $data ?? [], null);
        $this->setIfExists('has_duplicate_records', $data ?? [], null);
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['has_duplicate_records'] === null) {
            $invalidProperties[] = "'has_duplicate_records' can't be null";
        }
    ...
    /**
     * Gets duplicate_records_message
     *
     * @return string|null
     */
    public function getDuplicateRecordsMessage()
    {
        return $this->container['duplicate_records_message'];
    }

    /**
     * Sets duplicate_records_message
     *
     * @param string|null $duplicate_records_message If the domain is duplicate records.
     *
     * @return self
     */
    public function setDuplicateRecordsMessage($duplicate_records_message)
    {

        if (is_null($duplicate_records_message)) {
            array_push($this->openAPINullablesSetToNull, 'duplicate_records_message');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('duplicate_records_message', $nullablesSetToNull);
            if ($index !== FALSE) {
        ...
        $this->container['duplicate_records_message'] = $duplicate_records_message;

        return $this;
    }

    /**
     * Gets has_duplicate_records
     *
     * @return bool
     */
    public function getHasDuplicateRecords()
    {
        return $this->container['has_duplicate_records'];
    }

    /**
     * Sets has_duplicate_records
     *
     * @param bool $has_duplicate_records Whether the domain has duplicated required records. If true then see the domain in the dashboard app.
     *
     * @return self
     */
    public function setHasDuplicateRecords($has_duplicate_records)
    {

        if (is_null($has_duplicate_records)) {
            throw new \InvalidArgumentException('non-nullable has_duplicate_records cannot be null');
        }

        $this->container['has_duplicate_records'] = $has_duplicate_records;

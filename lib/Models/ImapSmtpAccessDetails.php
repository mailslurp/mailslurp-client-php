...
class ImapSmtpAccessDetails implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['smtp_server_host'] = $data['smtp_server_host'] ?? null;
        $this->container['smtp_server_port'] = $data['smtp_server_port'] ?? null;
        $this->container['smtp_username'] = $data['smtp_username'] ?? null;
        $this->container['smtp_password'] = $data['smtp_password'] ?? null;
        $this->container['imap_server_host'] = $data['imap_server_host'] ?? null;
        $this->container['imap_server_port'] = $data['imap_server_port'] ?? null;
        $this->container['imap_username'] = $data['imap_username'] ?? null;
        $this->container['imap_password'] = $data['imap_password'] ?? null;
    }

...
/**
 * CreateOwnedAliasOptions Class Doc Comment
 *
 * @category Class
 ...
 * @link     https://openapi-generator.tech
 */
class CreateOwnedAliasOptions implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CreateOwnedAliasOptions';
     ...
     * Sets email_address
     *
     * @param string|null $email_address Email address to be hidden behind alias
     *
     * @return $this
     */
     ...
     * Sets inbox_id
     *
     * @param string|null $inbox_id Optional inbox ID to attach to alias. Emails received by this inbox will be forwarded to the alias email address
     *
     * @return $this
     */

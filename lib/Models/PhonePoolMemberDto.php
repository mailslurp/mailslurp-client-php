...
/**
 * PhonePoolMemberDto Class Doc Comment
 *
 * @category Class
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 ...
 */
class PhonePoolMemberDto implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhonePoolMemberDto';
    ...
    protected static $openAPITypes = [
        ...
        'phone_name' => 'string',
        'created_at' => '\DateTime',
        'active_lease' => '\MailSlurp\Models\PhonePoolLeaseDto'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('active_lease', $data ?? [], null);
    }
    ...
    */
     ...
     * Gets active_lease
     *
     * @return \MailSlurp\Models\PhonePoolLeaseDto|null
     */
    public function getActiveLease()
    {
        return $this->container['active_lease'];
    }

    /**
     * Sets active_lease
     *
     * @param \MailSlurp\Models\PhonePoolLeaseDto|null $active_lease active_lease
     *
     * @return self
     */
    public function setActiveLease($active_lease)
    {

        if (is_null($active_lease)) {
            throw new \InvalidArgumentException('non-nullable active_lease cannot be null');
        }

        $this->container['active_lease'] = $active_lease;

...
/**
 * SmtpAuthDiagnosticResult Class Doc Comment
 *
 * @category Class
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 ...
 */
class SmtpAuthDiagnosticResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'SmtpAuthDiagnosticResult';
    ...
    */
     ...
     * Sets mechanism
     *
     * @param string|null $mechanism mechanism
     *
     * @return self
     */
    public function setMechanism($mechanism)
    {
        ...
        if (is_null($mechanism)) {
            array_push($this->openAPINullablesSetToNull, 'mechanism');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('mechanism', $nullablesSetToNull);
            if ($index !== FALSE) {

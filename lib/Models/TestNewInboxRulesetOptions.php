...
class TestNewInboxRulesetOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'inbox_ruleset_test_options' => '\MailSlurp\Models\RulesetTestOptions',
        'create_ruleset_options' => '\MailSlurp\Models\CreateRulesetOptions'
    ];
    ...
    protected static $setters = [
        ...
        'create_ruleset_options' => 'setCreateRulesetOptions'
    ];
    ...
    protected static $getters = [
        ...
        'create_ruleset_options' => 'getCreateRulesetOptions'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('create_ruleset_options', $data ?? [], null);
    }
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ($this->container['create_ruleset_options'] === null) {
            $invalidProperties[] = "'create_ruleset_options' can't be null";
        }
     ...
     *
     * @return \MailSlurp\Models\RulesetTestOptions
     */
     ...
     *
     * @param \MailSlurp\Models\RulesetTestOptions $inbox_ruleset_test_options inbox_ruleset_test_options
     *
     * @return self
     */
    ...
    /**
     * Gets create_ruleset_options
     *
     * @return \MailSlurp\Models\CreateRulesetOptions
     */
    public function getCreateRulesetOptions()
    {
        return $this->container['create_ruleset_options'];
    }

    /**
     * Sets create_ruleset_options
     *
     * @param \MailSlurp\Models\CreateRulesetOptions $create_ruleset_options create_ruleset_options
     *
     * @return self
     */
    public function setCreateRulesetOptions($create_ruleset_options)
    {

        if (is_null($create_ruleset_options)) {
            throw new \InvalidArgumentException('non-nullable create_ruleset_options cannot be null');
        }

        $this->container['create_ruleset_options'] = $create_ruleset_options;

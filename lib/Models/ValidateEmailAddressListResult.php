...
class ValidateEmailAddressListResult implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['valid_email_addresses'] = $data['valid_email_addresses'] ?? null;
        $this->container['invalid_email_addresses'] = $data['invalid_email_addresses'] ?? null;
        $this->container['result_map_email_address_is_valid'] = $data['result_map_email_address_is_valid'] ?? null;
    }

 ...
 * @link     https://openapi-generator.tech
 */
class EmailPreviewUrls implements ModelInterface, ArrayAccess
{
    ...
    {
        $this->container['raw_smtp_message_url'] = isset($data['raw_smtp_message_url']) ? $data['raw_smtp_message_url'] : null;
        $this->container['plain_html_body_url'] = isset($data['plain_html_body_url']) ? $data['plain_html_body_url'] : null;
    }

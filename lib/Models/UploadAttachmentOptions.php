...
class UploadAttachmentOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    */
    ...
    public function listInvalidProperties()
    {
        ...
        if ((mb_strlen($this->container['base64_contents']) < 1)) {
            $invalidProperties[] = "invalid value for 'base64_contents', the character length must be bigger than or equal to 1.";
        }
    ...
    public function setBase64Contents($base64_contents)
    {
        ...
        if ((mb_strlen($base64_contents) < 1)) {
            throw new \InvalidArgumentException('invalid length for $base64_contents when calling UploadAttachmentOptions., must be bigger than or equal to 1.');
        }

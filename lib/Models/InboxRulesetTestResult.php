 ...
 * @link     https://openapi-generator.tech
 */
class InboxRulesetTestResult implements ModelInterface, ArrayAccess
{
    ...
    protected static $openAPITypes = [
        'ruleset_matches' => 'map[string,bool]',
        'matches' => 'bool'
    ];
    ...
    {
        $this->container['ruleset_matches'] = isset($data['ruleset_matches']) ? $data['ruleset_matches'] : null;
     ...
     *
     * @param map[string,bool]|null $ruleset_matches Map of inbox ruleset ID to boolean of if target matches
     *
     * @return $this
     */
     ...
     * Sets matches
     *
     * @param bool|null $matches matches
     *
     * @return $this
     */

...
class CreateAliasOptions implements ModelInterface, ArrayAccess
{
     ...
     * Sets email_address
     *
     * @param string|null $email_address Email address to be hidden behind alias. Emails sent to the alias email address will be forwarded to this address. If you want to enable replies set useThreads true and the reply-to for the email will allow outbound communication via a thread.
     *
     * @return $this
     */
     ...
     * Sets use_threads
     *
     * @param bool|null $use_threads Enable threads options. If true emails will be sent with a unique reply-to thread address. This means you can reply to the forwarded email and it will be sent to the recipients via your alias address. That way a thread conversation is preserved.
     *
     * @return $this
     */

...
/**
 * CheckDnsPropagationOptions Class Doc Comment
 *
 * @category Class
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 ...
 */
class CheckDnsPropagationOptions implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'CheckDnsPropagationOptions';
    ...
    */
    ...
    public function setHost($host)
    {
        ...
        if ((mb_strlen($host) < 1)) {
            throw new \InvalidArgumentException('invalid length for $host when calling CheckDnsPropagationOptions., must be bigger than or equal to 1.');
        }

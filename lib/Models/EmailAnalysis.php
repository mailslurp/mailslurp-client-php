...
class EmailAnalysis implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->container['spam_verdict'] = $data['spam_verdict'] ?? null;
        $this->container['virus_verdict'] = $data['virus_verdict'] ?? null;
        $this->container['spf_verdict'] = $data['spf_verdict'] ?? null;
        $this->container['dkim_verdict'] = $data['dkim_verdict'] ?? null;
        $this->container['dmarc_verdict'] = $data['dmarc_verdict'] ?? null;
    }

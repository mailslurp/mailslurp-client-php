 ...
 * @link     https://openapi-generator.tech
 */
class ConditionOption implements ModelInterface, ArrayAccess
{
     ...
     * Sets condition
     *
     * @param string|null $condition The condition to evaluate against the email
     *
     * @return $this
     */
     ...
     * Sets value
     *
     * @param string|null $value What the condition should evaluate to. A string 'TRUE|FALSE' not a boolean.
     *
     * @return $this
     */

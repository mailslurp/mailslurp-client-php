...
/**
 * PhonePlanAvailabilityItem Class Doc Comment
 *
 * @category Class
 * @package  MailSlurp
 * @author   OpenAPI Generator team
 ...
 */
class PhonePlanAvailabilityItem implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PhonePlanAvailabilityItem';
    ...
    public const AVAILABILITY_STATUS_NON_MATCHING_SUBSCRIPTION_CURRENCY = 'NON_MATCHING_SUBSCRIPTION_CURRENCY';
    public const AVAILABILITY_STATUS_NON_MATCHING_SUBSCRIPTION_TYPE = 'NON_MATCHING_SUBSCRIPTION_TYPE';
    public const AVAILABILITY_STATUS_ALREADY_ASSIGNED = 'ALREADY_ASSIGNED';
    public const VARIANTS_LOCAL = 'LOCAL';
    public const VARIANTS_MOBILE = 'MOBILE';
    public const VARIANTS_TOLL_FREE = 'TOLL_FREE';
    ...
    public function getAvailabilityStatusAllowableValues()
    {
        return [
            ...
            self::AVAILABILITY_STATUS_NON_MATCHING_SUBSCRIPTION_CURRENCY,
            self::AVAILABILITY_STATUS_NON_MATCHING_SUBSCRIPTION_TYPE,
            self::AVAILABILITY_STATUS_ALREADY_ASSIGNED,
        ];
    }
     ...
     * @return string[]
     */
    public function getVariantsAllowableValues()
    {
        return [
            self::VARIANTS_LOCAL,
            self::VARIANTS_MOBILE,
            self::VARIANTS_TOLL_FREE,
        ];
    }
    ...
    */
     ...
     * Sets variants
     *
     * @param string[]|null $variants variants
     *
     * @return self
     */
    public function setVariants($variants)
    {
        $allowedValues = $this->getVariantsAllowableValues();
        if (!is_null($variants) && array_diff($variants, $allowedValues)) {
            throw new \InvalidArgumentException(
                sprintf(
                    "Invalid value for 'variants', must be one of '%s'",
                    implode("', '", $allowedValues)
                )
            );
        }

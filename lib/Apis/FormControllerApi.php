...
/**
     ...
     * @return string
     */
    public function submitForm($_to = null, $_subject = null, $_email_address = null, $_success_message = null, $_spam_check = null, $other_parameters = null, string $contentType = self::contentTypes['submitForm'][0])
    {
        list($response) = $this->submitFormWithHttpInfo($_to, $_subject, $_email_address, $_success_message, $_spam_check, $other_parameters, $contentType);
        return $response;
    }
     ...
     */
    public function submitFormWithHttpInfo($_to = null, $_subject = null, $_email_address = null, $_success_message = null, $_spam_check = null, $other_parameters = null, string $contentType = self::contentTypes['submitForm'][0])
    {
        $request = $this->submitFormRequest($_to, $_subject, $_email_address, $_success_message, $_spam_check, $other_parameters, $contentType);
     ...
     */
    public function submitFormAsync($_to = null, $_subject = null, $_email_address = null, $_success_message = null, $_spam_check = null, $other_parameters = null, string $contentType = self::contentTypes['submitForm'][0])
    {
        return $this->submitFormAsyncWithHttpInfo($_to, $_subject, $_email_address, $_success_message, $_spam_check, $other_parameters, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitFormAsyncWithHttpInfo($_to = null, $_subject = null, $_email_address = null, $_success_message = null, $_spam_check = null, $other_parameters = null, string $contentType = self::contentTypes['submitForm'][0])
    {
        $returnType = 'string';
        $request = $this->submitFormRequest($_to, $_subject, $_email_address, $_success_message, $_spam_check, $other_parameters, $contentType);
     ...
     */
    public function submitFormRequest($_to = null, $_subject = null, $_email_address = null, $_success_message = null, $_spam_check = null, $other_parameters = null, string $contentType = self::contentTypes['submitForm'][0])
    {

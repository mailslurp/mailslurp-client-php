...
class FormControllerApi
{
     ...
     * @return string
     */
    public function submitForm($_email_address = null, $_redirect_to = null, $_spam_check = null, $_subject = null, $_success_message = null, $_to = null, $other_parameters = null)
    {
        list($response) = $this->submitFormWithHttpInfo($_email_address, $_redirect_to, $_spam_check, $_subject, $_success_message, $_to, $other_parameters);
        return $response;
    }
     ...
     */
    public function submitFormWithHttpInfo($_email_address = null, $_redirect_to = null, $_spam_check = null, $_subject = null, $_success_message = null, $_to = null, $other_parameters = null)
    {
        $request = $this->submitFormRequest($_email_address, $_redirect_to, $_spam_check, $_subject, $_success_message, $_to, $other_parameters);
     ...
     */
    public function submitFormAsync($_email_address = null, $_redirect_to = null, $_spam_check = null, $_subject = null, $_success_message = null, $_to = null, $other_parameters = null)
    {
        return $this->submitFormAsyncWithHttpInfo($_email_address, $_redirect_to, $_spam_check, $_subject, $_success_message, $_to, $other_parameters)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function submitFormAsyncWithHttpInfo($_email_address = null, $_redirect_to = null, $_spam_check = null, $_subject = null, $_success_message = null, $_to = null, $other_parameters = null)
    {
        $returnType = 'string';
        $request = $this->submitFormRequest($_email_address, $_redirect_to, $_spam_check, $_subject, $_success_message, $_to, $other_parameters);
     ...
     */
    protected function submitFormRequest($_email_address = null, $_redirect_to = null, $_spam_check = null, $_subject = null, $_success_message = null, $_to = null, $other_parameters = null)
    {

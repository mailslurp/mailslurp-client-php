...
/**
     ...
     */
    public function getAllSmsMessages($phone_number = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $search = null, $favourite = false, $include = null, string $contentType = self::contentTypes['getAllSmsMessages'][0])
    {
        list($response) = $this->getAllSmsMessagesWithHttpInfo($phone_number, $page, $size, $sort, $since, $before, $search, $favourite, $include, $contentType);
        return $response;
    }
     ...
     */
    public function getAllSmsMessagesWithHttpInfo($phone_number = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $search = null, $favourite = false, $include = null, string $contentType = self::contentTypes['getAllSmsMessages'][0])
    {
        $request = $this->getAllSmsMessagesRequest($phone_number, $page, $size, $sort, $since, $before, $search, $favourite, $include, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllSmsMessagesAsync($phone_number = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $search = null, $favourite = false, $include = null, string $contentType = self::contentTypes['getAllSmsMessages'][0])
    {
        return $this->getAllSmsMessagesAsyncWithHttpInfo($phone_number, $page, $size, $sort, $since, $before, $search, $favourite, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllSmsMessagesAsyncWithHttpInfo($phone_number = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $search = null, $favourite = false, $include = null, string $contentType = self::contentTypes['getAllSmsMessages'][0])
    {
        $returnType = '\MailSlurp\Models\PageSmsProjection';
        $request = $this->getAllSmsMessagesRequest($phone_number, $page, $size, $sort, $since, $before, $search, $favourite, $include, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllSmsMessagesRequest($phone_number = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $search = null, $favourite = false, $include = null, string $contentType = self::contentTypes['getAllSmsMessages'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSmsCodes'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\ExtractCodesResult
     */
    public function getSmsCodes($sms_id, $extract_codes_options = null, string $contentType = self::contentTypes['getSmsCodes'][0])
    {
        list($response) = $this->getSmsCodesWithHttpInfo($sms_id, $extract_codes_options, $contentType);
        return $response;
    }

    /**
     * Operation getSmsCodesWithHttpInfo
     *
     * Extract verification codes from an SMS
     *
     * @param  string $sms_id ID of SMS to extract codes from (required)
     ...
     */
    public function getSmsCodesWithHttpInfo($sms_id, $extract_codes_options = null, string $contentType = self::contentTypes['getSmsCodes'][0])
    {
        $request = $this->getSmsCodesRequest($sms_id, $extract_codes_options, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSmsCodesAsync($sms_id, $extract_codes_options = null, string $contentType = self::contentTypes['getSmsCodes'][0])
    {
        return $this->getSmsCodesAsyncWithHttpInfo($sms_id, $extract_codes_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getSmsCodesAsyncWithHttpInfo
     *
     * Extract verification codes from an SMS
     *
     * @param  string $sms_id ID of SMS to extract codes from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSmsCodesAsyncWithHttpInfo($sms_id, $extract_codes_options = null, string $contentType = self::contentTypes['getSmsCodes'][0])
    {
        $returnType = '\MailSlurp\Models\ExtractCodesResult';
        $request = $this->getSmsCodesRequest($sms_id, $extract_codes_options, $contentType);
    ...
    /**
     * Create request for operation 'getSmsCodes'
     *
     * @param  string $sms_id ID of SMS to extract codes from (required)
     * @param  \MailSlurp\Models\ExtractCodesOptions $extract_codes_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getSmsCodes'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSmsCodesRequest($sms_id, $extract_codes_options = null, string $contentType = self::contentTypes['getSmsCodes'][0])
    {

        // verify the required parameter 'sms_id' is set
        if ($sms_id === null || (is_array($sms_id) && count($sms_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sms_id when calling getSmsCodes'
            );
        }



        $resourcePath = '/sms/{smsId}/codes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation markAllSmsAsRead
     *
     * Mark all SMS messages as read or unread
     *
     * @param  bool $read read (optional, default to true)
     * @param  string $phone_number_id phone_number_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markAllSmsAsRead'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function markAllSmsAsRead($read = true, $phone_number_id = null, string $contentType = self::contentTypes['markAllSmsAsRead'][0])
    {
        $this->markAllSmsAsReadWithHttpInfo($read, $phone_number_id, $contentType);
    }

    /**
     * Operation markAllSmsAsReadWithHttpInfo
     *
     * Mark all SMS messages as read or unread
     *
     * @param  bool $read (optional, default to true)
     * @param  string $phone_number_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markAllSmsAsRead'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function markAllSmsAsReadWithHttpInfo($read = true, $phone_number_id = null, string $contentType = self::contentTypes['markAllSmsAsRead'][0])
    {
        $request = $this->markAllSmsAsReadRequest($read, $phone_number_id, $contentType);
    ...
    /**
     * Operation markAllSmsAsReadAsync
     *
     * Mark all SMS messages as read or unread
     *
     * @param  bool $read (optional, default to true)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function markAllSmsAsReadAsync($read = true, $phone_number_id = null, string $contentType = self::contentTypes['markAllSmsAsRead'][0])
    {
        return $this->markAllSmsAsReadAsyncWithHttpInfo($read, $phone_number_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation markAllSmsAsReadAsyncWithHttpInfo
     *
     * Mark all SMS messages as read or unread
     *
     * @param  bool $read (optional, default to true)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function markAllSmsAsReadAsyncWithHttpInfo($read = true, $phone_number_id = null, string $contentType = self::contentTypes['markAllSmsAsRead'][0])
    {
        $returnType = '';
        $request = $this->markAllSmsAsReadRequest($read, $phone_number_id, $contentType);
    ...
    /**
     * Create request for operation 'markAllSmsAsRead'
     *
     * @param  bool $read (optional, default to true)
     * @param  string $phone_number_id (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markAllSmsAsRead'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function markAllSmsAsReadRequest($read = true, $phone_number_id = null, string $contentType = self::contentTypes['markAllSmsAsRead'][0])
    {




        $resourcePath = '/sms/read';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation markSmsAsRead
     *
     * Mark an SMS as read or unread
     *
     * @param  string $sms_id sms_id (required)
     * @param  bool $read read (optional, default to true)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markSmsAsRead'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\SmsDto
     */
    public function markSmsAsRead($sms_id, $read = true, string $contentType = self::contentTypes['markSmsAsRead'][0])
    {
        list($response) = $this->markSmsAsReadWithHttpInfo($sms_id, $read, $contentType);
        return $response;
    }

    /**
     * Operation markSmsAsReadWithHttpInfo
     *
     * Mark an SMS as read or unread
     *
     * @param  string $sms_id (required)
     ...
     * @return array of \MailSlurp\Models\SmsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function markSmsAsReadWithHttpInfo($sms_id, $read = true, string $contentType = self::contentTypes['markSmsAsRead'][0])
    {
        $request = $this->markSmsAsReadRequest($sms_id, $read, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function markSmsAsReadAsync($sms_id, $read = true, string $contentType = self::contentTypes['markSmsAsRead'][0])
    {
        return $this->markSmsAsReadAsyncWithHttpInfo($sms_id, $read, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation markSmsAsReadAsyncWithHttpInfo
     *
     * Mark an SMS as read or unread
     *
     * @param  string $sms_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function markSmsAsReadAsyncWithHttpInfo($sms_id, $read = true, string $contentType = self::contentTypes['markSmsAsRead'][0])
    {
        $returnType = '\MailSlurp\Models\SmsDto';
        $request = $this->markSmsAsReadRequest($sms_id, $read, $contentType);
    ...
    /**
     * Create request for operation 'markSmsAsRead'
     *
     * @param  string $sms_id (required)
     * @param  bool $read (optional, default to true)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['markSmsAsRead'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function markSmsAsReadRequest($sms_id, $read = true, string $contentType = self::contentTypes['markSmsAsRead'][0])
    {

        // verify the required parameter 'sms_id' is set
        if ($sms_id === null || (is_array($sms_id) && count($sms_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $sms_id when calling markSmsAsRead'
            );
        }



        $resourcePath = '/sms/{smsId}/read';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

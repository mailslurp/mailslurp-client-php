...
/**
     ...
     * @return \MailSlurp\Models\PhoneNumberDto
     */
    public function getPhoneNumberByName(string $contentType = self::contentTypes['getPhoneNumberByName'][0])
    {
        list($response) = $this->getPhoneNumberByNameWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PhoneNumberDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPhoneNumberByNameWithHttpInfo(string $contentType = self::contentTypes['getPhoneNumberByName'][0])
    {
        $request = $this->getPhoneNumberByNameRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumberByNameAsync(string $contentType = self::contentTypes['getPhoneNumberByName'][0])
    {
        return $this->getPhoneNumberByNameAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumberByNameAsyncWithHttpInfo(string $contentType = self::contentTypes['getPhoneNumberByName'][0])
    {
        $returnType = '\MailSlurp\Models\PhoneNumberDto';
        $request = $this->getPhoneNumberByNameRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPhoneNumberByNameRequest(string $contentType = self::contentTypes['getPhoneNumberByName'][0])
    {
     ...
     * @return \MailSlurp\Models\PhoneNumberDto
     */
    public function getPhoneNumberByPhoneNumber(string $contentType = self::contentTypes['getPhoneNumberByPhoneNumber'][0])
    {
        list($response) = $this->getPhoneNumberByPhoneNumberWithHttpInfo($contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PhoneNumberDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPhoneNumberByPhoneNumberWithHttpInfo(string $contentType = self::contentTypes['getPhoneNumberByPhoneNumber'][0])
    {
        $request = $this->getPhoneNumberByPhoneNumberRequest($contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumberByPhoneNumberAsync(string $contentType = self::contentTypes['getPhoneNumberByPhoneNumber'][0])
    {
        return $this->getPhoneNumberByPhoneNumberAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumberByPhoneNumberAsyncWithHttpInfo(string $contentType = self::contentTypes['getPhoneNumberByPhoneNumber'][0])
    {
        $returnType = '\MailSlurp\Models\PhoneNumberDto';
        $request = $this->getPhoneNumberByPhoneNumberRequest($contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPhoneNumberByPhoneNumberRequest(string $contentType = self::contentTypes['getPhoneNumberByPhoneNumber'][0])
    {

...
class PhoneControllerApi
{
     ...
     */
    protected function createEmergencyAddressRequest($create_emergency_address_options)
    {
        ...
        if (isset($create_emergency_address_options)) {
            $_tempBody = $create_emergency_address_options;
        }
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteEmergencyAddressRequest($address_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deletePhoneNumberRequest($phone_number_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmergencyAddressRequest($address_id)
    {
        // verify the required parameter 'address_id' is set
        if ($address_id === null || (is_array($address_id) && count($address_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmergencyAddressesRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPhoneNumbersRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getPhonePlansRequest()
    {

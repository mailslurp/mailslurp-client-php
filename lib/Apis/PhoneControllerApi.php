...
class PhoneControllerApi
{
     ...
     */
    public function getPhoneNumbers($phone_country = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        list($response) = $this->getPhoneNumbersWithHttpInfo($phone_country, $page, $size, $sort, $since, $before);
        return $response;
    }
     ...
     */
    public function getPhoneNumbersWithHttpInfo($phone_country = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $request = $this->getPhoneNumbersRequest($phone_country, $page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumbersAsync($phone_country = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        return $this->getPhoneNumbersAsyncWithHttpInfo($phone_country, $page, $size, $sort, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumbersAsyncWithHttpInfo($phone_country = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\PagePhoneNumberProjection';
        $request = $this->getPhoneNumbersRequest($phone_country, $page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPhoneNumbersRequest($phone_country = null, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        ...
        if ($phone_country !== null) {
            if('form' === 'form' && is_array($phone_country)) {
                foreach($phone_country as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['phoneCountry'] = $phone_country;
            }
        }
        // query params
        if ($page !== null) {
     ...
     * @return void
     */
    public function testPhoneNumberSendSms($phone_number_id, $test_phone_number_options, $x_test_id = null)
    {
        $this->testPhoneNumberSendSmsWithHttpInfo($phone_number_id, $test_phone_number_options, $x_test_id);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function testPhoneNumberSendSmsWithHttpInfo($phone_number_id, $test_phone_number_options, $x_test_id = null)
    {
        $request = $this->testPhoneNumberSendSmsRequest($phone_number_id, $test_phone_number_options, $x_test_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testPhoneNumberSendSmsAsync($phone_number_id, $test_phone_number_options, $x_test_id = null)
    {
        return $this->testPhoneNumberSendSmsAsyncWithHttpInfo($phone_number_id, $test_phone_number_options, $x_test_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function testPhoneNumberSendSmsAsyncWithHttpInfo($phone_number_id, $test_phone_number_options, $x_test_id = null)
    {
        $returnType = '';
        $request = $this->testPhoneNumberSendSmsRequest($phone_number_id, $test_phone_number_options, $x_test_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testPhoneNumberSendSmsRequest($phone_number_id, $test_phone_number_options, $x_test_id = null)
    {
        // verify the required parameter 'phone_number_id' is set
        if ($phone_number_id === null || (is_array($phone_number_id) && count($phone_number_id) === 0)) {
            throw new \InvalidArgumentException(

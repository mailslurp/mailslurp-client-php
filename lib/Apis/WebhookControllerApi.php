...
/**
     ...
     */
    public function getAllWebhookResults($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
        list($response) = $this->getAllWebhookResultsWithHttpInfo($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType);
        return $response;
    }
     ...
     */
    public function getAllWebhookResultsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
        $request = $this->getAllWebhookResultsRequest($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookResultsAsync($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
        return $this->getAllWebhookResultsAsyncWithHttpInfo($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookResultsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookResult';
        $request = $this->getAllWebhookResultsRequest($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllWebhookResultsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
     ...
     * @return \MailSlurp\Models\PageWebhookResult
     */
    public function getWebhookResults($webhook_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getWebhookResults'][0])
    {
        list($response) = $this->getWebhookResultsWithHttpInfo($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookResultsWithHttpInfo($webhook_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getWebhookResults'][0])
    {
        $request = $this->getWebhookResultsRequest($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookResultsAsync($webhook_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getWebhookResults'][0])
    {
        return $this->getWebhookResultsAsyncWithHttpInfo($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookResultsAsyncWithHttpInfo($webhook_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getWebhookResults'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookResult';
        $request = $this->getWebhookResultsRequest($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getWebhookResultsRequest($webhook_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, string $contentType = self::contentTypes['getWebhookResults'][0])
    {

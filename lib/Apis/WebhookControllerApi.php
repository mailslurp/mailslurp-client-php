...
class WebhookControllerApi
{
     ...
     */
    public function getAllWebhookResults($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        list($response) = $this->getAllWebhookResultsWithHttpInfo($before, $page, $search_filter, $since, $size, $sort, $unseen_only);
        return $response;
    }
     ...
     */
    public function getAllWebhookResultsWithHttpInfo($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        $request = $this->getAllWebhookResultsRequest($before, $page, $search_filter, $since, $size, $sort, $unseen_only);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookResultsAsync($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        return $this->getAllWebhookResultsAsyncWithHttpInfo($before, $page, $search_filter, $since, $size, $sort, $unseen_only)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookResultsAsyncWithHttpInfo($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        $returnType = '\MailSlurp\Models\PageWebhookResult';
        $request = $this->getAllWebhookResultsRequest($before, $page, $search_filter, $since, $size, $sort, $unseen_only);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllWebhookResultsRequest($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        ...
        // query params
        if (is_array($unseen_only)) {
            $unseen_only = ObjectSerializer::serializeCollection($unseen_only, '', true);
        }
        if ($unseen_only !== null) {
     ...
     */
    public function getAllWebhooks($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'DESC')
    {
        list($response) = $this->getAllWebhooksWithHttpInfo($before, $page, $search_filter, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllWebhooksWithHttpInfo($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'DESC')
    {
        $request = $this->getAllWebhooksRequest($before, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'DESC')
    {
        return $this->getAllWebhooksAsyncWithHttpInfo($before, $page, $search_filter, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'DESC')
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getAllWebhooksRequest($before, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllWebhooksRequest($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'DESC')
    {
     ...
     * @return \MailSlurp\Models\PageWebhookProjection
     */
    public function getInboxWebhooksPaginated($inbox_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getInboxWebhooksPaginatedWithHttpInfo($inbox_id, $before, $page, $search_filter, $since, $size, $sort);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxWebhooksPaginatedWithHttpInfo($inbox_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getInboxWebhooksPaginatedRequest($inbox_id, $before, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksPaginatedAsync($inbox_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getInboxWebhooksPaginatedAsyncWithHttpInfo($inbox_id, $before, $page, $search_filter, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksPaginatedAsyncWithHttpInfo($inbox_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getInboxWebhooksPaginatedRequest($inbox_id, $before, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxWebhooksPaginatedRequest($inbox_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \MailSlurp\Models\PageWebhookResult
     */
    public function getWebhookResults($webhook_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        list($response) = $this->getWebhookResultsWithHttpInfo($webhook_id, $before, $page, $search_filter, $since, $size, $sort, $unseen_only);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookResultsWithHttpInfo($webhook_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        $request = $this->getWebhookResultsRequest($webhook_id, $before, $page, $search_filter, $since, $size, $sort, $unseen_only);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookResultsAsync($webhook_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        return $this->getWebhookResultsAsyncWithHttpInfo($webhook_id, $before, $page, $search_filter, $since, $size, $sort, $unseen_only)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookResultsAsyncWithHttpInfo($webhook_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        $returnType = '\MailSlurp\Models\PageWebhookResult';
        $request = $this->getWebhookResultsRequest($webhook_id, $before, $page, $search_filter, $since, $size, $sort, $unseen_only);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhookResultsRequest($webhook_id, $before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unseen_only = null)
    {
        // verify the required parameter 'webhook_id' is set
        if ($webhook_id === null || (is_array($webhook_id) && count($webhook_id) === 0)) {
            throw new \InvalidArgumentException(

...
/**
    ...
    /**
     * Operation createWebhookForAITransformer
     *
     * Attach a WebHook URL to an AI transformer
     *
     * @param  string $transformer_id transformer_id (required)
     * @param  \MailSlurp\Models\CreateWebhookOptions $create_webhook_options create_webhook_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWebhookForAITransformer'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\WebhookDto
     */
    public function createWebhookForAITransformer($transformer_id, $create_webhook_options, string $contentType = self::contentTypes['createWebhookForAITransformer'][0])
    {
        list($response) = $this->createWebhookForAITransformerWithHttpInfo($transformer_id, $create_webhook_options, $contentType);
        return $response;
    }

    /**
     * Operation createWebhookForAITransformerWithHttpInfo
     *
     * Attach a WebHook URL to an AI transformer
     *
     ...
     * @return array of \MailSlurp\Models\WebhookDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function createWebhookForAITransformerWithHttpInfo($transformer_id, $create_webhook_options, string $contentType = self::contentTypes['createWebhookForAITransformer'][0])
    {
        $request = $this->createWebhookForAITransformerRequest($transformer_id, $create_webhook_options, $contentType);
    ...
    /**
     * Operation createWebhookForAITransformerAsync
     *
     * Attach a WebHook URL to an AI transformer
     *
     * @param  string $transformer_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebhookForAITransformerAsync($transformer_id, $create_webhook_options, string $contentType = self::contentTypes['createWebhookForAITransformer'][0])
    {
        return $this->createWebhookForAITransformerAsyncWithHttpInfo($transformer_id, $create_webhook_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createWebhookForAITransformerAsyncWithHttpInfo
     *
     * Attach a WebHook URL to an AI transformer
     *
     * @param  string $transformer_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createWebhookForAITransformerAsyncWithHttpInfo($transformer_id, $create_webhook_options, string $contentType = self::contentTypes['createWebhookForAITransformer'][0])
    {
        $returnType = '\MailSlurp\Models\WebhookDto';
        $request = $this->createWebhookForAITransformerRequest($transformer_id, $create_webhook_options, $contentType);
    ...
    /**
     * Create request for operation 'createWebhookForAITransformer'
     *
     * @param  string $transformer_id (required)
     * @param  \MailSlurp\Models\CreateWebhookOptions $create_webhook_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createWebhookForAITransformer'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createWebhookForAITransformerRequest($transformer_id, $create_webhook_options, string $contentType = self::contentTypes['createWebhookForAITransformer'][0])
    {

        // verify the required parameter 'transformer_id' is set
        if ($transformer_id === null || (is_array($transformer_id) && count($transformer_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $transformer_id when calling createWebhookForAITransformer'
            );
        }
        ...
        if ($create_webhook_options === null || (is_array($create_webhook_options) && count($create_webhook_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_webhook_options when calling createWebhookForAITransformer'
            );
        }


        $resourcePath = '/ai-transformers/{transformerId}/webhooks';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        if ($transformer_id !== null) {
            $resourcePath = str_replace(
                '{' . 'transformerId' . '}',
                ObjectSerializer::toPathValue($transformer_id),
                $resourcePath
            );
        }
     ...
     */
    public function getAllAccountWebhooks($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, $event_type = null, $health = null, $search_filter = null, string $contentType = self::contentTypes['getAllAccountWebhooks'][0])
    {
        list($response) = $this->getAllAccountWebhooksWithHttpInfo($page, $size, $sort, $since, $before, $event_type, $health, $search_filter, $contentType);
        return $response;
    }
     ...
     */
    public function getAllAccountWebhooksWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, $event_type = null, $health = null, $search_filter = null, string $contentType = self::contentTypes['getAllAccountWebhooks'][0])
    {
        $request = $this->getAllAccountWebhooksRequest($page, $size, $sort, $since, $before, $event_type, $health, $search_filter, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAccountWebhooksAsync($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, $event_type = null, $health = null, $search_filter = null, string $contentType = self::contentTypes['getAllAccountWebhooks'][0])
    {
        return $this->getAllAccountWebhooksAsyncWithHttpInfo($page, $size, $sort, $since, $before, $event_type, $health, $search_filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllAccountWebhooksAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, $event_type = null, $health = null, $search_filter = null, string $contentType = self::contentTypes['getAllAccountWebhooks'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getAllAccountWebhooksRequest($page, $size, $sort, $since, $before, $event_type, $health, $search_filter, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllAccountWebhooksRequest($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, $event_type = null, $health = null, $search_filter = null, string $contentType = self::contentTypes['getAllAccountWebhooks'][0])
    {
    ...
    /**
     * Operation getAllWebhookEndpoints
     *
     ...
     * @param  string $health Filter by webhook health (optional)
     * @param  string $event_type Optional event type (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllWebhookEndpoints'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageWebhookEndpointProjection
     */
    public function getAllWebhookEndpoints($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, string $contentType = self::contentTypes['getAllWebhookEndpoints'][0])
    {
        list($response) = $this->getAllWebhookEndpointsWithHttpInfo($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $contentType);
        return $response;
    }

    /**
     * Operation getAllWebhookEndpointsWithHttpInfo
     *
     * List Webhooks endpoints Paginated
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\PageWebhookEndpointProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWebhookEndpointsWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, string $contentType = self::contentTypes['getAllWebhookEndpoints'][0])
    {
        $request = $this->getAllWebhookEndpointsRequest($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\PageWebhookEndpointProjection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\PageWebhookEndpointProjection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\PageWebhookEndpointProjection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\PageWebhookEndpointProjection';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\PageWebhookEndpointProjection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAllWebhookEndpointsAsync
     *
     * List Webhooks endpoints Paginated
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookEndpointsAsync($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, string $contentType = self::contentTypes['getAllWebhookEndpoints'][0])
    {
        return $this->getAllWebhookEndpointsAsyncWithHttpInfo($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllWebhookEndpointsAsyncWithHttpInfo
     *
     * List Webhooks endpoints Paginated
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookEndpointsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, string $contentType = self::contentTypes['getAllWebhookEndpoints'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookEndpointProjection';
        $request = $this->getAllWebhookEndpointsRequest($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $contentType);
    ...
    /**
     * Create request for operation 'getAllWebhookEndpoints'
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     * @param  int $size Optional page size for paginated result list. (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'DESC')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllWebhookEndpointsRequest($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, string $contentType = self::contentTypes['getAllWebhookEndpoints'][0])
    {

        if ($page !== null && $page > 9223372036854775807) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebhookControllerApi.getAllWebhookEndpoints, must be smaller than or equal to 9223372036854775807.');
        }
        if ($page !== null && $page < 0) {
            throw new \InvalidArgumentException('invalid value for "$page" when calling WebhookControllerApi.getAllWebhookEndpoints, must be bigger than or equal to 0.');
        }
        
        if ($size !== null && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling WebhookControllerApi.getAllWebhookEndpoints, must be smaller than or equal to 100.');
        }
        if ($size !== null && $size < 1) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling WebhookControllerApi.getAllWebhookEndpoints, must be bigger than or equal to 1.');
        }
     ...
     */
    public function getAllWebhookResults($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, $result_type = null, $event_name = null, $min_status_code = null, $max_status_code = null, $inbox_id = null, $sms_id = null, $attachment_id = null, $email_id = null, $phone_id = null, $ai_transformer_id = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
        list($response) = $this->getAllWebhookResultsWithHttpInfo($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $result_type, $event_name, $min_status_code, $max_status_code, $inbox_id, $sms_id, $attachment_id, $email_id, $phone_id, $ai_transformer_id, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getAllWebhookResultsRequest($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $result_type, $event_name, $min_status_code, $max_status_code, $inbox_id, $sms_id, $attachment_id, $email_id, $phone_id, $ai_transformer_id, $contentType);
    ...
    {
        return $this->getAllWebhookResultsAsyncWithHttpInfo($page, $size, $sort, $search_filter, $since, $before, $unseen_only, $result_type, $event_name, $min_status_code, $max_status_code, $inbox_id, $sms_id, $attachment_id, $email_id, $phone_id, $ai_transformer_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    public function getAllWebhookResultsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, $result_type = null, $event_name = null, $min_status_code = null, $max_status_code = null, $inbox_id = null, $sms_id = null, $attachment_id = null, $email_id = null, $phone_id = null, $ai_transformer_id = null, string $contentType = self::contentTypes['getAllWebhookResults'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $ai_transformer_id,
            'aiTransformerId', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  bool $include_account_wide Include account scope webhooks when passing phoneId, inboxId, or aiTransformerId filters (optional)
     ...
     * @return \MailSlurp\Models\PageWebhookProjection
     */
    public function getAllWebhooks($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $ai_transformer_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, $event_type_source = null, $include_account_wide = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        list($response) = $this->getAllWebhooksWithHttpInfo($page, $size, $sort, $search_filter, $since, $inbox_id, $ai_transformer_id, $phone_id, $before, $health, $event_type, $url, $event_type_source, $include_account_wide, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWebhooksWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $ai_transformer_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, $event_type_source = null, $include_account_wide = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        $request = $this->getAllWebhooksRequest($page, $size, $sort, $search_filter, $since, $inbox_id, $ai_transformer_id, $phone_id, $before, $health, $event_type, $url, $event_type_source, $include_account_wide, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $ai_transformer_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, $event_type_source = null, $include_account_wide = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        return $this->getAllWebhooksAsyncWithHttpInfo($page, $size, $sort, $search_filter, $since, $inbox_id, $ai_transformer_id, $phone_id, $before, $health, $event_type, $url, $event_type_source, $include_account_wide, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $ai_transformer_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, $event_type_source = null, $include_account_wide = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getAllWebhooksRequest($page, $size, $sort, $search_filter, $since, $inbox_id, $ai_transformer_id, $phone_id, $before, $health, $event_type, $url, $event_type_source, $include_account_wide, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllWebhooksRequest($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $ai_transformer_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, $event_type_source = null, $include_account_wide = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $event_type_source,
            'eventTypeSource', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            ...
            'includeAccountWide', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  string $health Filter by webhook health (optional)
     * @param  string $event_type Optional event type (optional)
     * @param  bool $include_account_wide Include account scope inbox webhooks (optional)
     ...
     * @return \MailSlurp\Models\PageWebhookProjection
     */
    public function getInboxWebhooksPaginated($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $health = null, $event_type = null, $include_account_wide = null, string $contentType = self::contentTypes['getInboxWebhooksPaginated'][0])
    {
        list($response) = $this->getInboxWebhooksPaginatedWithHttpInfo($inbox_id, $page, $size, $sort, $search_filter, $since, $before, $health, $event_type, $include_account_wide, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxWebhooksPaginatedWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $health = null, $event_type = null, $include_account_wide = null, string $contentType = self::contentTypes['getInboxWebhooksPaginated'][0])
    {
        $request = $this->getInboxWebhooksPaginatedRequest($inbox_id, $page, $size, $sort, $search_filter, $since, $before, $health, $event_type, $include_account_wide, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksPaginatedAsync($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $health = null, $event_type = null, $include_account_wide = null, string $contentType = self::contentTypes['getInboxWebhooksPaginated'][0])
    {
        return $this->getInboxWebhooksPaginatedAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $search_filter, $since, $before, $health, $event_type, $include_account_wide, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksPaginatedAsyncWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $health = null, $event_type = null, $include_account_wide = null, string $contentType = self::contentTypes['getInboxWebhooksPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getInboxWebhooksPaginatedRequest($inbox_id, $page, $size, $sort, $search_filter, $since, $before, $health, $event_type, $include_account_wide, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxWebhooksPaginatedRequest($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $health = null, $event_type = null, $include_account_wide = null, string $contentType = self::contentTypes['getInboxWebhooksPaginated'][0])
    {
     ...
     * @param  string $search_filter Optional search filter (optional)
     * @param  string $health Filter by webhook health (optional)
     * @param  bool $include_account_wide Include account scope phone webhooks (optional)
     ...
     * @return \MailSlurp\Models\PageWebhookProjection
     */
    public function getPhoneNumberWebhooksPaginated($phone_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $event_type = null, $search_filter = null, $health = null, $include_account_wide = null, string $contentType = self::contentTypes['getPhoneNumberWebhooksPaginated'][0])
    {
        list($response) = $this->getPhoneNumberWebhooksPaginatedWithHttpInfo($phone_id, $page, $size, $sort, $since, $before, $event_type, $search_filter, $health, $include_account_wide, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getPhoneNumberWebhooksPaginatedWithHttpInfo($phone_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $event_type = null, $search_filter = null, $health = null, $include_account_wide = null, string $contentType = self::contentTypes['getPhoneNumberWebhooksPaginated'][0])
    {
        $request = $this->getPhoneNumberWebhooksPaginatedRequest($phone_id, $page, $size, $sort, $since, $before, $event_type, $search_filter, $health, $include_account_wide, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumberWebhooksPaginatedAsync($phone_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $event_type = null, $search_filter = null, $health = null, $include_account_wide = null, string $contentType = self::contentTypes['getPhoneNumberWebhooksPaginated'][0])
    {
        return $this->getPhoneNumberWebhooksPaginatedAsyncWithHttpInfo($phone_id, $page, $size, $sort, $since, $before, $event_type, $search_filter, $health, $include_account_wide, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getPhoneNumberWebhooksPaginatedAsyncWithHttpInfo($phone_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $event_type = null, $search_filter = null, $health = null, $include_account_wide = null, string $contentType = self::contentTypes['getPhoneNumberWebhooksPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getPhoneNumberWebhooksPaginatedRequest($phone_id, $page, $size, $sort, $since, $before, $event_type, $search_filter, $health, $include_account_wide, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getPhoneNumberWebhooksPaginatedRequest($phone_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $event_type = null, $search_filter = null, $health = null, $include_account_wide = null, string $contentType = self::contentTypes['getPhoneNumberWebhooksPaginated'][0])
    {
    ...
    /**
     * Operation getTestWebhookPayloadNewAITransformResult
     *
     * Get webhook test payload for new ai transform result event
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTestWebhookPayloadNewAITransformResult'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\WebhookNewAITransformResultPayload
     */
    public function getTestWebhookPayloadNewAITransformResult(string $contentType = self::contentTypes['getTestWebhookPayloadNewAITransformResult'][0])
    {
        list($response) = $this->getTestWebhookPayloadNewAITransformResultWithHttpInfo($contentType);
        return $response;
    }

    /**
     * Operation getTestWebhookPayloadNewAITransformResultWithHttpInfo
     *
     * Get webhook test payload for new ai transform result event
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTestWebhookPayloadNewAITransformResult'] to see the possible values for this operation
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\WebhookNewAITransformResultPayload, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTestWebhookPayloadNewAITransformResultWithHttpInfo(string $contentType = self::contentTypes['getTestWebhookPayloadNewAITransformResult'][0])
    {
        $request = $this->getTestWebhookPayloadNewAITransformResultRequest($contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\WebhookNewAITransformResultPayload' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\WebhookNewAITransformResultPayload' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\WebhookNewAITransformResultPayload', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\WebhookNewAITransformResultPayload';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\WebhookNewAITransformResultPayload',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getTestWebhookPayloadNewAITransformResultAsync
     *
     * Get webhook test payload for new ai transform result event
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTestWebhookPayloadNewAITransformResult'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTestWebhookPayloadNewAITransformResultAsync(string $contentType = self::contentTypes['getTestWebhookPayloadNewAITransformResult'][0])
    {
        return $this->getTestWebhookPayloadNewAITransformResultAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTestWebhookPayloadNewAITransformResultAsyncWithHttpInfo
     *
     * Get webhook test payload for new ai transform result event
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTestWebhookPayloadNewAITransformResult'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTestWebhookPayloadNewAITransformResultAsyncWithHttpInfo(string $contentType = self::contentTypes['getTestWebhookPayloadNewAITransformResult'][0])
    {
        $returnType = '\MailSlurp\Models\WebhookNewAITransformResultPayload';
        $request = $this->getTestWebhookPayloadNewAITransformResultRequest($contentType);
    ...
    /**
     * Create request for operation 'getTestWebhookPayloadNewAITransformResult'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTestWebhookPayloadNewAITransformResult'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTestWebhookPayloadNewAITransformResultRequest(string $contentType = self::contentTypes['getTestWebhookPayloadNewAITransformResult'][0])
    {


        $resourcePath = '/webhooks/test/new-ai-transform-result-payload';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \MailSlurp\Models\PageWebhookResult
     */
    public function getWebhookResults($webhook_id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $unseen_only = null, $result_type = null, $event_name = null, $min_status_code = null, $max_status_code = null, $inbox_id = null, $sms_id = null, $attachment_id = null, $email_id = null, $phone_id = null, $ai_transformer_id = null, string $contentType = self::contentTypes['getWebhookResults'][0])
    {
        list($response) = $this->getWebhookResultsWithHttpInfo($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $result_type, $event_name, $min_status_code, $max_status_code, $inbox_id, $sms_id, $attachment_id, $email_id, $phone_id, $ai_transformer_id, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->getWebhookResultsRequest($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $result_type, $event_name, $min_status_code, $max_status_code, $inbox_id, $sms_id, $attachment_id, $email_id, $phone_id, $ai_transformer_id, $contentType);
    ...
    {
        return $this->getWebhookResultsAsyncWithHttpInfo($webhook_id, $page, $size, $sort, $search_filter, $since, $before, $unseen_only, $result_type, $event_name, $min_status_code, $max_status_code, $inbox_id, $sms_id, $attachment_id, $email_id, $phone_id, $ai_transformer_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\WebhookProjection[]
     * @deprecated
     */
    public function getWebhooks($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getWebhooks'][0])
    {
        list($response) = $this->getWebhooksWithHttpInfo($inbox_id, $page, $size, $sort, $contentType);
        return $response;
    }
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\WebhookProjection[], HTTP status code, HTTP response headers (array of strings)
     * @deprecated
     */
    public function getWebhooksWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getWebhooks'][0])
    {
        $request = $this->getWebhooksRequest($inbox_id, $page, $size, $sort, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\WebhookProjection[]' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\WebhookProjection[]' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\WebhookProjection[]', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\WebhookProjection[]';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\WebhookProjection[]',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @deprecated
     */
    public function getWebhooksAsync($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getWebhooks'][0])
    {
        return $this->getWebhooksAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getWebhooksAsyncWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getWebhooks'][0])
    {
        $returnType = '\MailSlurp\Models\WebhookProjection[]';
        $request = $this->getWebhooksRequest($inbox_id, $page, $size, $sort, $contentType);
     ...
     * @deprecated
     */
    public function getWebhooksRequest($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getWebhooks'][0])
    {
     ...
     * @param  string $ai_transformer_id ai_transformer_id (optional)
     * @param  string $phone_number_id phone_number_id (optional)
     * @param  bool $override_auth override_auth (optional)
     ...
     * @return \MailSlurp\Models\WebhookDto
     */
    public function updateWebhook($webhook_id, $create_webhook_options, $inbox_id = null, $ai_transformer_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        list($response) = $this->updateWebhookWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id, $ai_transformer_id, $phone_number_id, $override_auth, $contentType);
        return $response;
    }
     ...
     * @param  bool $override_auth (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['updateWebhook'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\WebhookDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWebhookWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id = null, $ai_transformer_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        $request = $this->updateWebhookRequest($webhook_id, $create_webhook_options, $inbox_id, $ai_transformer_id, $phone_number_id, $override_auth, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsync($webhook_id, $create_webhook_options, $inbox_id = null, $ai_transformer_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        return $this->updateWebhookAsyncWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id, $ai_transformer_id, $phone_number_id, $override_auth, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsyncWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id = null, $ai_transformer_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        $returnType = '\MailSlurp\Models\WebhookDto';
        $request = $this->updateWebhookRequest($webhook_id, $create_webhook_options, $inbox_id, $ai_transformer_id, $phone_number_id, $override_auth, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWebhookRequest($webhook_id, $create_webhook_options, $inbox_id = null, $ai_transformer_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        ...
        if ($create_webhook_options === null || (is_array($create_webhook_options) && count($create_webhook_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_webhook_options when calling updateWebhook'
            );
        }

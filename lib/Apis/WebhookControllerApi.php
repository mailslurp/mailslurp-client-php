...
class WebhookControllerApi
{
     ...
     */
    public function getAllWebhookResults($page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllWebhookResultsWithHttpInfo($page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllWebhookResultsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllWebhookResultsRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookResultsAsync($page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getAllWebhookResultsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhookResultsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageWebhookResult';
        $request = $this->getAllWebhookResultsRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllWebhookResultsRequest($page = 0, $size = 20, $sort = 'ASC')
    {
     ...
     * @return \MailSlurp\Models\PageWebhookResult
     */
    public function getWebhookResults($webhook_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getWebhookResultsWithHttpInfo($webhook_id, $page, $size, $sort);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getWebhookResultsWithHttpInfo($webhook_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getWebhookResultsRequest($webhook_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookResultsAsync($webhook_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getWebhookResultsAsyncWithHttpInfo($webhook_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getWebhookResultsAsyncWithHttpInfo($webhook_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageWebhookResult';
        $request = $this->getWebhookResultsRequest($webhook_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhookResultsRequest($webhook_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'webhook_id' is set
        if ($webhook_id === null || (is_array($webhook_id) && count($webhook_id) === 0)) {
            throw new \InvalidArgumentException(

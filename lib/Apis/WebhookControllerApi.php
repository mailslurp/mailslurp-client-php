...
class WebhookControllerApi
{
     ...
     */
    public function getAllWebhooks($page = 0, $search_filter = null, $size = 20, $sort = 'DESC')
    {
     ...
     */
    public function getAllWebhooksWithHttpInfo($page = 0, $search_filter = null, $size = 20, $sort = 'DESC')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync($page = 0, $search_filter = null, $size = 20, $sort = 'DESC')
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo($page = 0, $search_filter = null, $size = 20, $sort = 'DESC')
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getAllWebhooksRequest($page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllWebhooksRequest($page = 0, $search_filter = null, $size = 20, $sort = 'DESC')
    {

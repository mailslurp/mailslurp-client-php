...
/**
     ...
     * @return \MailSlurp\Models\PageWebhookProjection
     */
    public function getAllWebhooks($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        list($response) = $this->getAllWebhooksWithHttpInfo($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $url, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageWebhookProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllWebhooksWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        $request = $this->getAllWebhooksRequest($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $url, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsync($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        return $this->getAllWebhooksAsyncWithHttpInfo($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $url, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllWebhooksAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
        $returnType = '\MailSlurp\Models\PageWebhookProjection';
        $request = $this->getAllWebhooksRequest($page, $size, $sort, $search_filter, $since, $inbox_id, $phone_id, $before, $health, $event_type, $url, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllWebhooksRequest($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $inbox_id = null, $phone_id = null, $before = null, $health = null, $event_type = null, $url = null, string $contentType = self::contentTypes['getAllWebhooks'][0])
    {
     ...
     * @return \MailSlurp\Models\WebhookDto
     */
    public function updateWebhook($webhook_id, $create_webhook_options, $inbox_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        list($response) = $this->updateWebhookWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id, $phone_number_id, $override_auth, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\WebhookDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateWebhookWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        $request = $this->updateWebhookRequest($webhook_id, $create_webhook_options, $inbox_id, $phone_number_id, $override_auth, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsync($webhook_id, $create_webhook_options, $inbox_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        return $this->updateWebhookAsyncWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id, $phone_number_id, $override_auth, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateWebhookAsyncWithHttpInfo($webhook_id, $create_webhook_options, $inbox_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {
        $returnType = '\MailSlurp\Models\WebhookDto';
        $request = $this->updateWebhookRequest($webhook_id, $create_webhook_options, $inbox_id, $phone_number_id, $override_auth, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateWebhookRequest($webhook_id, $create_webhook_options, $inbox_id = null, $phone_number_id = null, $override_auth = null, string $contentType = self::contentTypes['updateWebhook'][0])
    {

...
class WebhookControllerApi
{
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\WebhookPayload
     */
    public function getTestWebhookPayload()
    {
        list($response) = $this->getTestWebhookPayloadWithHttpInfo();
        return $response;
    }
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\WebhookPayload, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTestWebhookPayloadWithHttpInfo()
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\WebhookPayload' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\WebhookPayload', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\WebhookPayload';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\WebhookPayload',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTestWebhookPayloadAsync()
    {
        return $this->getTestWebhookPayloadAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTestWebhookPayloadAsyncWithHttpInfo()
    {
        $returnType = '\MailSlurp\Models\WebhookPayload';
        $request = $this->getTestWebhookPayloadRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTestWebhookPayloadRequest()
    {

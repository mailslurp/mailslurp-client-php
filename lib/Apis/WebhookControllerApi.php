...
class WebhookControllerApi
{
     ...
     */
    protected function createAccountWebhookRequest($create_webhook_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteAllWebhooksRequest($before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteWebhookByIdRequest($webhook_id)
    {
        // verify the required parameter 'webhook_id' is set
        if ($webhook_id === null || (is_array($webhook_id) && count($webhook_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getJsonSchemaForWebhookEventRequest($event)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTestWebhookPayloadBounceRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getTestWebhookPayloadBounceRecipientRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getWebhookResultsUnseenErrorCountRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateWebhookHeadersRequest($webhook_id, $webhook_headers)
    {
        // verify the required parameter 'webhook_id' is set
        if ($webhook_id === null || (is_array($webhook_id) && count($webhook_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function verifyWebhookSignatureRequest($verify_webhook_signature_options)
    {
        ...
        if (isset($verify_webhook_signature_options)) {
            $_tempBody = $verify_webhook_signature_options;
        }

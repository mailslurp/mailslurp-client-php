...
class MissedEmailControllerApi
{
     ...
     */
    public function getAllMissedEmails($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllMissedEmailsWithHttpInfo($page, $search_filter, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllMissedEmailsWithHttpInfo($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllMissedEmailsRequest($page, $search_filter, $size, $sort);
     ...
     */
    public function getAllMissedEmailsAsync($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAllMissedEmailsAsyncWithHttpInfo($page, $search_filter, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllMissedEmailsAsyncWithHttpInfo($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageMissedEmailProjection';
        $request = $this->getAllMissedEmailsRequest($page, $search_filter, $size, $sort);
     ...
     */
    protected function getAllMissedEmailsRequest($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {

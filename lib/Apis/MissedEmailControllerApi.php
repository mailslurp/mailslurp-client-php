...
class MissedEmailControllerApi
{
     ...
     */
    public function getAllMissedEmailsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $inbox_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllUnknownMissedEmailsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, $inbox_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getMissedEmailRequest($missed_email_id)
    {
     ...
     * @return void
     */
    public function restoreMissedEmails()
    {
        $this->restoreMissedEmailsWithHttpInfo();
    }
     ...
     */
    public function restoreMissedEmailsWithHttpInfo()
    {
        $request = $this->restoreMissedEmailsRequest();
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restoreMissedEmailsAsync()
    {
        return $this->restoreMissedEmailsAsyncWithHttpInfo()
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function restoreMissedEmailsAsyncWithHttpInfo()
    {
        $returnType = '';
        $request = $this->restoreMissedEmailsRequest();
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function restoreMissedEmailsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function waitForNthMissedEmailRequest($index, $inbox_id = null, $timeout = null, $since = null, $before = null)
    {

...
class InboxControllerApi
{
     ...
     */
    protected function createInboxRequest($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function deleteAllInboxEmailsRequest($inbox_id)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllInboxesRequest($page = 0, $size = 20, $sort = 'ASC', $favourite = false, $search = null, $tag = null, $team_access = null, $since = null, $before = null, $inbox_type = null, $domain_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getDeliveryStatusesByInboxIdRequest($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxByNameRequest($name)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendEmailWithQueueRequest($inbox_id, $validate_before_enqueue, $send_email_options)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(

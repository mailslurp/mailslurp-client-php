...
/**
     ...
     */
    public function createInbox($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createInbox'][0])
    {
        list($response) = $this->createInboxWithHttpInfo($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $contentType);
        return $response;
    }
     ...
     */
    public function createInboxWithHttpInfo($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createInbox'][0])
    {
        $request = $this->createInboxRequest($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxAsync($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createInbox'][0])
    {
        return $this->createInboxAsyncWithHttpInfo($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxAsyncWithHttpInfo($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createInbox'][0])
    {
        $returnType = '\MailSlurp\Models\InboxDto';
        $request = $this->createInboxRequest($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createInboxRequest($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createInbox'][0])
    {
     ...
     */
    public function doesInboxExist($email_address, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        list($response) = $this->doesInboxExistWithHttpInfo($email_address, $contentType);
        return $response;
    }
     ...
     */
    public function doesInboxExistWithHttpInfo($email_address, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        $request = $this->doesInboxExistRequest($email_address, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doesInboxExistAsync($email_address, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        return $this->doesInboxExistAsyncWithHttpInfo($email_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doesInboxExistAsyncWithHttpInfo($email_address, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        $returnType = '\MailSlurp\Models\InboxExistsDto';
        $request = $this->doesInboxExistRequest($email_address, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function doesInboxExistRequest($email_address, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
     ...
     */
    public function getAllInboxes($page = 0, $size = 20, $sort = 'ASC', $favourite = false, $search = null, $tag = null, $team_access = null, $since = null, $before = null, $inbox_type = null, $domain_id = null, string $contentType = self::contentTypes['getAllInboxes'][0])
    {
        list($response) = $this->getAllInboxesWithHttpInfo($page, $size, $sort, $favourite, $search, $tag, $team_access, $since, $before, $inbox_type, $domain_id, $contentType);
        return $response;
    }
     ...
     */
    public function getAllInboxesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $favourite = false, $search = null, $tag = null, $team_access = null, $since = null, $before = null, $inbox_type = null, $domain_id = null, string $contentType = self::contentTypes['getAllInboxes'][0])
    {
        $request = $this->getAllInboxesRequest($page, $size, $sort, $favourite, $search, $tag, $team_access, $since, $before, $inbox_type, $domain_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxesAsync($page = 0, $size = 20, $sort = 'ASC', $favourite = false, $search = null, $tag = null, $team_access = null, $since = null, $before = null, $inbox_type = null, $domain_id = null, string $contentType = self::contentTypes['getAllInboxes'][0])
    {
        return $this->getAllInboxesAsyncWithHttpInfo($page, $size, $sort, $favourite, $search, $tag, $team_access, $since, $before, $inbox_type, $domain_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $favourite = false, $search = null, $tag = null, $team_access = null, $since = null, $before = null, $inbox_type = null, $domain_id = null, string $contentType = self::contentTypes['getAllInboxes'][0])
    {
        $returnType = '\MailSlurp\Models\PageInboxProjection';
        $request = $this->getAllInboxesRequest($page, $size, $sort, $favourite, $search, $tag, $team_access, $since, $before, $inbox_type, $domain_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllInboxesRequest($page = 0, $size = 20, $sort = 'ASC', $favourite = false, $search = null, $tag = null, $team_access = null, $since = null, $before = null, $inbox_type = null, $domain_id = null, string $contentType = self::contentTypes['getAllInboxes'][0])
    {
     ...
     * @deprecated
     */
    public function getInboxes($size = 100, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        list($response) = $this->getInboxesWithHttpInfo($size, $sort, $since, $before, $contentType);
        return $response;
    }
     ...
     * @deprecated
     */
    public function getInboxesWithHttpInfo($size = 100, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        $request = $this->getInboxesRequest($size, $sort, $since, $before, $contentType);
     ...
     * @deprecated
     */
    public function getInboxesAsync($size = 100, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        return $this->getInboxesAsyncWithHttpInfo($size, $sort, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getInboxesAsyncWithHttpInfo($size = 100, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        $returnType = '\MailSlurp\Models\InboxDto[]';
        $request = $this->getInboxesRequest($size, $sort, $since, $before, $contentType);
     ...
     * @deprecated
     */
    public function getInboxesRequest($size = 100, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxes'][0])
    {

...
class InboxControllerApi
{
     ...
     * @param  bool $favourite Is the inbox favorited. Favouriting inboxes is typically done in the dashboard for quick access or filtering (optional)
     ...
     */
    public function createInbox($description = null, $email_address = null, $expires_at = null, $expires_in = null, $favourite = null, $name = null, $tags = null, $use_domain_pool = null)
    {
        list($response) = $this->createInboxWithHttpInfo($description, $email_address, $expires_at, $expires_in, $favourite, $name, $tags, $use_domain_pool);
        return $response;
    }
     ...
     */
    public function createInboxWithHttpInfo($description = null, $email_address = null, $expires_at = null, $expires_in = null, $favourite = null, $name = null, $tags = null, $use_domain_pool = null)
    {
        $request = $this->createInboxRequest($description, $email_address, $expires_at, $expires_in, $favourite, $name, $tags, $use_domain_pool);
     ...
     */
    public function createInboxAsync($description = null, $email_address = null, $expires_at = null, $expires_in = null, $favourite = null, $name = null, $tags = null, $use_domain_pool = null)
    {
        return $this->createInboxAsyncWithHttpInfo($description, $email_address, $expires_at, $expires_in, $favourite, $name, $tags, $use_domain_pool)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxAsyncWithHttpInfo($description = null, $email_address = null, $expires_at = null, $expires_in = null, $favourite = null, $name = null, $tags = null, $use_domain_pool = null)
    {
        $returnType = '\MailSlurp\Models\Inbox';
        $request = $this->createInboxRequest($description, $email_address, $expires_at, $expires_in, $favourite, $name, $tags, $use_domain_pool);
     ...
     */
    protected function createInboxRequest($description = null, $email_address = null, $expires_at = null, $expires_in = null, $favourite = null, $name = null, $tags = null, $use_domain_pool = null)
    {
     ...
     */
    public function getEmails($inbox_id, $limit = null, $min_count = null, $retry_timeout = null, $since = null, $size = null, $sort = null)
    {
        list($response) = $this->getEmailsWithHttpInfo($inbox_id, $limit, $min_count, $retry_timeout, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getEmailsWithHttpInfo($inbox_id, $limit = null, $min_count = null, $retry_timeout = null, $since = null, $size = null, $sort = null)
    {
        $request = $this->getEmailsRequest($inbox_id, $limit, $min_count, $retry_timeout, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsAsync($inbox_id, $limit = null, $min_count = null, $retry_timeout = null, $since = null, $size = null, $sort = null)
    {
        return $this->getEmailsAsyncWithHttpInfo($inbox_id, $limit, $min_count, $retry_timeout, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsAsyncWithHttpInfo($inbox_id, $limit = null, $min_count = null, $retry_timeout = null, $since = null, $size = null, $sort = null)
    {
        $returnType = '\MailSlurp\Models\EmailPreview[]';
        $request = $this->getEmailsRequest($inbox_id, $limit, $min_count, $retry_timeout, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmailsRequest($inbox_id, $limit = null, $min_count = null, $retry_timeout = null, $since = null, $size = null, $sort = null)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
    ...
    /**
     * Operation getExpiredInboxRecordById
     *
     ...
     */
    public function getExpiredInboxRecordById($expired_id)
    {
        list($response) = $this->getExpiredInboxRecordByIdWithHttpInfo($expired_id);
        return $response;
    }

    /**
     * Operation getExpiredInboxRecordByIdWithHttpInfo
     *
     * Get an expired inbox record
     *
     * @param  string $expired_id ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId) (required)
     ...
     */
    public function getExpiredInboxRecordByIdWithHttpInfo($expired_id)
    {
        $request = $this->getExpiredInboxRecordByIdRequest($expired_id);
    ...
    /**
     * Operation getExpiredInboxRecordByIdAsync
     *
     * Get an expired inbox record
     *
     * @param  string $expired_id ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxRecordByIdAsync($expired_id)
    {
        return $this->getExpiredInboxRecordByIdAsyncWithHttpInfo($expired_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExpiredInboxRecordByIdAsyncWithHttpInfo
     *
     * Get an expired inbox record
     *
     * @param  string $expired_id ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxRecordByIdAsyncWithHttpInfo($expired_id)
    {
        $returnType = '\MailSlurp\Models\ExpiredInboxDto';
        $request = $this->getExpiredInboxRecordByIdRequest($expired_id);
    ...
    /**
     * Create request for operation 'getExpiredInboxRecordById'
     *
     * @param  string $expired_id ID of the ExpiredInboxRecord you want to retrieve. This is different from the ID of the inbox you are interested in. See other methods for getting ExpiredInboxRecord for an inbox inboxId) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExpiredInboxRecordByIdRequest($expired_id)
    {
        // verify the required parameter 'expired_id' is set
        if ($expired_id === null || (is_array($expired_id) && count($expired_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $expired_id when calling getExpiredInboxRecordById'
            );
        }

        $resourcePath = '/inboxes/expired-records/{expiredId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getExpiredInboxRecordByInboxId
     *
     ...
     * @return \MailSlurp\Models\ExpiredInboxDto
     */
    public function getExpiredInboxRecordByInboxId($inbox_id)
    {
        list($response) = $this->getExpiredInboxRecordByInboxIdWithHttpInfo($inbox_id);
        return $response;
    }

    /**
     * Operation getExpiredInboxRecordByInboxIdWithHttpInfo
     *
     * Get expired inbox record for a previously existing inbox
     *
     * @param  string $inbox_id ID of inbox you want to retrieve (not the inbox ID) (required)
     ...
     * @return array of \MailSlurp\Models\ExpiredInboxDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getExpiredInboxRecordByInboxIdWithHttpInfo($inbox_id)
    {
        $request = $this->getExpiredInboxRecordByInboxIdRequest($inbox_id);
    ...
    /**
     * Operation getExpiredInboxRecordByInboxIdAsync
     *
     * Get expired inbox record for a previously existing inbox
     *
     * @param  string $inbox_id ID of inbox you want to retrieve (not the inbox ID) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxRecordByInboxIdAsync($inbox_id)
    {
        return $this->getExpiredInboxRecordByInboxIdAsyncWithHttpInfo($inbox_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExpiredInboxRecordByInboxIdAsyncWithHttpInfo
     *
     * Get expired inbox record for a previously existing inbox
     *
     * @param  string $inbox_id ID of inbox you want to retrieve (not the inbox ID) (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxRecordByInboxIdAsyncWithHttpInfo($inbox_id)
    {
        $returnType = '\MailSlurp\Models\ExpiredInboxDto';
        $request = $this->getExpiredInboxRecordByInboxIdRequest($inbox_id);
    ...
    /**
     * Create request for operation 'getExpiredInboxRecordByInboxId'
     *
     * @param  string $inbox_id ID of inbox you want to retrieve (not the inbox ID) (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExpiredInboxRecordByInboxIdRequest($inbox_id)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getExpiredInboxRecordByInboxId'
            );
        }

        $resourcePath = '/inboxes/{inboxId}/expired-record';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getExpiredInboxRecords
     *
     ...
     */
    public function getExpiredInboxRecords($page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getExpiredInboxRecordsWithHttpInfo($page, $size, $sort);
        return $response;
    }

    /**
     * Operation getExpiredInboxRecordsWithHttpInfo
     *
     * List records of expired inboxes
     *
     * @param  int $page Optional page index in inbox sent email list pagination (optional, default to 0)
     ...
     */
    public function getExpiredInboxRecordsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getExpiredInboxRecordsRequest($page, $size, $sort);
    ...
    /**
     * Operation getExpiredInboxRecordsAsync
     *
     * List records of expired inboxes
     *
     * @param  int $page Optional page index in inbox sent email list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxRecordsAsync($page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getExpiredInboxRecordsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getExpiredInboxRecordsAsyncWithHttpInfo
     *
     * List records of expired inboxes
     *
     * @param  int $page Optional page index in inbox sent email list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxRecordsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageExpiredInboxRecordProjection';
        $request = $this->getExpiredInboxRecordsRequest($page, $size, $sort);
    ...
    /**
     * Create request for operation 'getExpiredInboxRecords'
     *
     * @param  int $page Optional page index in inbox sent email list pagination (optional, default to 0)
     * @param  int $size Optional page size in inbox sent email list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExpiredInboxRecordsRequest($page = 0, $size = 20, $sort = 'ASC')
    {

        $resourcePath = '/inboxes/expired-records';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return \MailSlurp\Models\Inbox[]
     */
    public function getInboxes($size = 100, $sort = 'ASC')
    {
        list($response) = $this->getInboxesWithHttpInfo($size, $sort);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\Inbox[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxesWithHttpInfo($size = 100, $sort = 'ASC')
    {
        $request = $this->getInboxesRequest($size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxesAsync($size = 100, $sort = 'ASC')
    {
        return $this->getInboxesAsyncWithHttpInfo($size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxesAsyncWithHttpInfo($size = 100, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\Inbox[]';
        $request = $this->getInboxesRequest($size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxesRequest($size = 100, $sort = 'ASC')
    {

...
/**
     ...
     */
    public function createInbox($email_address = null, $tags = null, $name = null, $description = null, $use_domain_pool = null, $favourite = null, $expires_at = null, $expires_in = null, $allow_team_access = null, $inbox_type = null, $virtual_inbox = null, $use_short_address = null, $domain_id = null, $domain_name = null, string $contentType = self::contentTypes['createInbox'][0])
    {
        list($response) = $this->createInboxWithHttpInfo($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $domain_id, $domain_name, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createInboxRequest($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $domain_id, $domain_name, $contentType);
    ...
    {
        return $this->createInboxAsyncWithHttpInfo($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox, $use_short_address, $domain_id, $domain_name, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }

...
class InboxControllerApi
{
     ...
     * @return void
     */
    public function listInboxRulesets($inbox_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $this->listInboxRulesetsWithHttpInfo($inbox_id, $page, $size, $sort);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function listInboxRulesetsWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->listInboxRulesetsRequest($inbox_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listInboxRulesetsAsync($inbox_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->listInboxRulesetsAsyncWithHttpInfo($inbox_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function listInboxRulesetsAsyncWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '';
        $request = $this->listInboxRulesetsRequest($inbox_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function listInboxRulesetsRequest($inbox_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(

...
class InboxControllerApi
{
    ...
    protected function createInboxRequest($description = null, $email_address = null, $expires_at = null, $favourite = null, $name = null, $tags = null)
    {
        ...
        // query params
        if ($favourite !== null) {
            $queryParams['favourite'] = ObjectSerializer::toQueryValue($favourite);
        }
        // query params
        if ($name !== null) {
     ...
     */
    public function getAllInboxes($favourite = false, $page = 0, $search = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllInboxesWithHttpInfo($favourite, $page, $search, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllInboxesWithHttpInfo($favourite = false, $page = 0, $search = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllInboxesRequest($favourite, $page, $search, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxesAsync($favourite = false, $page = 0, $search = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAllInboxesAsyncWithHttpInfo($favourite, $page, $search, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxesAsyncWithHttpInfo($favourite = false, $page = 0, $search = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageInboxProjection';
        $request = $this->getAllInboxesRequest($favourite, $page, $search, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllInboxesRequest($favourite = false, $page = 0, $search = null, $size = 20, $sort = 'ASC')
    {

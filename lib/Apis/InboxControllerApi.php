...
class InboxControllerApi
{
     ...
     */
    public function getEmails($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_ = null, $limit = null, $sort_the_results_by_received_date_and_direction_asc_or_desc = null, $retry_timeout = null, $delay_timeout = null, $min_count = null, $unread_only = null, $before = null, $since = null)
    {
        list($response) = $this->getEmailsWithHttpInfo($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_, $limit, $sort_the_results_by_received_date_and_direction_asc_or_desc, $retry_timeout, $delay_timeout, $min_count, $unread_only, $before, $since);
        return $response;
    }
     ...
     */
    public function getEmailsWithHttpInfo($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_ = null, $limit = null, $sort_the_results_by_received_date_and_direction_asc_or_desc = null, $retry_timeout = null, $delay_timeout = null, $min_count = null, $unread_only = null, $before = null, $since = null)
    {
        $request = $this->getEmailsRequest($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_, $limit, $sort_the_results_by_received_date_and_direction_asc_or_desc, $retry_timeout, $delay_timeout, $min_count, $unread_only, $before, $since);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsAsync($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_ = null, $limit = null, $sort_the_results_by_received_date_and_direction_asc_or_desc = null, $retry_timeout = null, $delay_timeout = null, $min_count = null, $unread_only = null, $before = null, $since = null)
    {
        return $this->getEmailsAsyncWithHttpInfo($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_, $limit, $sort_the_results_by_received_date_and_direction_asc_or_desc, $retry_timeout, $delay_timeout, $min_count, $unread_only, $before, $since)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsAsyncWithHttpInfo($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_ = null, $limit = null, $sort_the_results_by_received_date_and_direction_asc_or_desc = null, $retry_timeout = null, $delay_timeout = null, $min_count = null, $unread_only = null, $before = null, $since = null)
    {
        $returnType = '\MailSlurp\Models\EmailPreview[]';
        $request = $this->getEmailsRequest($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_, $limit, $sort_the_results_by_received_date_and_direction_asc_or_desc, $retry_timeout, $delay_timeout, $min_count, $unread_only, $before, $since);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmailsRequest($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_ = null, $limit = null, $sort_the_results_by_received_date_and_direction_asc_or_desc = null, $retry_timeout = null, $delay_timeout = null, $min_count = null, $unread_only = null, $before = null, $since = null)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(

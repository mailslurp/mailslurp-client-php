...
/**
     ...
     */
    public function createInboxRuleset($inbox_id, $create_ruleset_options, string $contentType = self::contentTypes['createInboxRuleset'][0])
    {
        list($response) = $this->createInboxRulesetWithHttpInfo($inbox_id, $create_ruleset_options, $contentType);
        return $response;
    }
     ...
     */
    public function createInboxRulesetWithHttpInfo($inbox_id, $create_ruleset_options, string $contentType = self::contentTypes['createInboxRuleset'][0])
    {
        $request = $this->createInboxRulesetRequest($inbox_id, $create_ruleset_options, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxRulesetAsync($inbox_id, $create_ruleset_options, string $contentType = self::contentTypes['createInboxRuleset'][0])
    {
        return $this->createInboxRulesetAsyncWithHttpInfo($inbox_id, $create_ruleset_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxRulesetAsyncWithHttpInfo($inbox_id, $create_ruleset_options, string $contentType = self::contentTypes['createInboxRuleset'][0])
    {
        $returnType = '\MailSlurp\Models\RulesetDto';
        $request = $this->createInboxRulesetRequest($inbox_id, $create_ruleset_options, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createInboxRulesetRequest($inbox_id, $create_ruleset_options, string $contentType = self::contentTypes['createInboxRuleset'][0])
    {
        ...
        if ($create_ruleset_options === null || (is_array($create_ruleset_options) && count($create_ruleset_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_ruleset_options when calling createInboxRuleset'
            );
        }
    ...
    public function deleteAllInboxesByDescriptionRequest($description, string $contentType = self::contentTypes['deleteAllInboxesByDescription'][0])
    {
        ...
        if (strlen($description) < 1) {
            throw new \InvalidArgumentException('invalid length for "$description" when calling InboxControllerApi.deleteAllInboxesByDescription, must be bigger than or equal to 1.');
        }
    ...
    public function deleteAllInboxesByNameRequest($name, string $contentType = self::contentTypes['deleteAllInboxesByName'][0])
    {
        ...
        if (strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for "$name" when calling InboxControllerApi.deleteAllInboxesByName, must be bigger than or equal to 1.');
        }
    ...
    public function deleteAllInboxesByTagRequest($tag, string $contentType = self::contentTypes['deleteAllInboxesByTag'][0])
    {
        ...
        if (strlen($tag) < 1) {
            throw new \InvalidArgumentException('invalid length for "$tag" when calling InboxControllerApi.deleteAllInboxesByTag, must be bigger than or equal to 1.');
        }
     ...
     * @param  bool $allow_catch_all Allow catch all (optional)
     ...
     */
    public function doesInboxExist($email_address, $allow_catch_all = null, $ip_address = null, $sender = null, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        list($response) = $this->doesInboxExistWithHttpInfo($email_address, $allow_catch_all, $ip_address, $sender, $contentType);
        return $response;
    }
     ...
     */
    public function doesInboxExistWithHttpInfo($email_address, $allow_catch_all = null, $ip_address = null, $sender = null, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        $request = $this->doesInboxExistRequest($email_address, $allow_catch_all, $ip_address, $sender, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doesInboxExistAsync($email_address, $allow_catch_all = null, $ip_address = null, $sender = null, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        return $this->doesInboxExistAsyncWithHttpInfo($email_address, $allow_catch_all, $ip_address, $sender, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doesInboxExistAsyncWithHttpInfo($email_address, $allow_catch_all = null, $ip_address = null, $sender = null, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
        $returnType = '\MailSlurp\Models\InboxExistsDto';
        $request = $this->doesInboxExistRequest($email_address, $allow_catch_all, $ip_address, $sender, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function doesInboxExistRequest($email_address, $allow_catch_all = null, $ip_address = null, $sender = null, string $contentType = self::contentTypes['doesInboxExist'][0])
    {
    ...
    /**
     * Operation doesInboxHaveAutomations
     *
     * Does inbox have automations
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doesInboxHaveAutomations'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function doesInboxHaveAutomations(string $contentType = self::contentTypes['doesInboxHaveAutomations'][0])
    {
        $this->doesInboxHaveAutomationsWithHttpInfo($contentType);
    }

    /**
     * Operation doesInboxHaveAutomationsWithHttpInfo
     *
     * Does inbox have automations
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doesInboxHaveAutomations'] to see the possible values for this operation
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function doesInboxHaveAutomationsWithHttpInfo(string $contentType = self::contentTypes['doesInboxHaveAutomations'][0])
    {
        $request = $this->doesInboxHaveAutomationsRequest($contentType);
    ...
    /**
     * Operation doesInboxHaveAutomationsAsync
     *
     * Does inbox have automations
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doesInboxHaveAutomations'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doesInboxHaveAutomationsAsync(string $contentType = self::contentTypes['doesInboxHaveAutomations'][0])
    {
        return $this->doesInboxHaveAutomationsAsyncWithHttpInfo($contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation doesInboxHaveAutomationsAsyncWithHttpInfo
     *
     * Does inbox have automations
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doesInboxHaveAutomations'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function doesInboxHaveAutomationsAsyncWithHttpInfo(string $contentType = self::contentTypes['doesInboxHaveAutomations'][0])
    {
        $returnType = '';
        $request = $this->doesInboxHaveAutomationsRequest($contentType);
    ...
    /**
     * Create request for operation 'doesInboxHaveAutomations'
     *
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['doesInboxHaveAutomations'] to see the possible values for this operation
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    public function doesInboxHaveAutomationsRequest(string $contentType = self::contentTypes['doesInboxHaveAutomations'][0])
    {


        $resourcePath = '/inboxes/automations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllPlusAddresses'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PagePlusAddressProjection
     */
    public function getAllPlusAddresses($page = 0, $size = 20, $sort = 'ASC', $inbox_id = null, string $contentType = self::contentTypes['getAllPlusAddresses'][0])
    {
        list($response) = $this->getAllPlusAddressesWithHttpInfo($page, $size, $sort, $inbox_id, $contentType);
        return $response;
    }

    /**
     * Operation getAllPlusAddressesWithHttpInfo
     *
     * Get all sub address plus address aliases for an inbox
     *
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\PagePlusAddressProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllPlusAddressesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $inbox_id = null, string $contentType = self::contentTypes['getAllPlusAddresses'][0])
    {
        $request = $this->getAllPlusAddressesRequest($page, $size, $sort, $inbox_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\PagePlusAddressProjection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\PagePlusAddressProjection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\PagePlusAddressProjection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\PagePlusAddressProjection';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\PagePlusAddressProjection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAllPlusAddressesAsync
     *
     * Get all sub address plus address aliases for an inbox
     *
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllPlusAddressesAsync($page = 0, $size = 20, $sort = 'ASC', $inbox_id = null, string $contentType = self::contentTypes['getAllPlusAddresses'][0])
    {
        return $this->getAllPlusAddressesAsyncWithHttpInfo($page, $size, $sort, $inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllPlusAddressesAsyncWithHttpInfo
     *
     * Get all sub address plus address aliases for an inbox
     *
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllPlusAddressesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $inbox_id = null, string $contentType = self::contentTypes['getAllPlusAddresses'][0])
    {
        $returnType = '\MailSlurp\Models\PagePlusAddressProjection';
        $request = $this->getAllPlusAddressesRequest($page, $size, $sort, $inbox_id, $contentType);
    ...
    /**
     * Create request for operation 'getAllPlusAddresses'
     *
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     * @param  int $size Optional page size in inbox tracking pixel list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllPlusAddressesRequest($page = 0, $size = 20, $sort = 'ASC', $inbox_id = null, string $contentType = self::contentTypes['getAllPlusAddresses'][0])
    {
        ...
        $resourcePath = '/inboxes/plus-addresses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     */
    public function getAllScheduledJobs($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getAllScheduledJobs'][0])
    {
        list($response) = $this->getAllScheduledJobsWithHttpInfo($page, $size, $sort, $since, $before, $inbox_id, $contentType);
        return $response;
    }
     ...
     */
    public function getAllScheduledJobsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getAllScheduledJobs'][0])
    {
        $request = $this->getAllScheduledJobsRequest($page, $size, $sort, $since, $before, $inbox_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllScheduledJobsAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getAllScheduledJobs'][0])
    {
        return $this->getAllScheduledJobsAsyncWithHttpInfo($page, $size, $sort, $since, $before, $inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllScheduledJobsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getAllScheduledJobs'][0])
    {
        $returnType = '\MailSlurp\Models\PageScheduledJobs';
        $request = $this->getAllScheduledJobsRequest($page, $size, $sort, $since, $before, $inbox_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllScheduledJobsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getAllScheduledJobs'][0])
    {
    ...
    public function getInboxByEmailAddressRequest($email_address, string $contentType = self::contentTypes['getInboxByEmailAddress'][0])
    {
        ...
        if (strlen($email_address) < 1) {
            throw new \InvalidArgumentException('invalid length for "$email_address" when calling InboxControllerApi.getInboxByEmailAddress, must be bigger than or equal to 1.');
        }
    ...
    public function getInboxByNameRequest($name, string $contentType = self::contentTypes['getInboxByName'][0])
    {
        ...
        if (strlen($name) < 1) {
            throw new \InvalidArgumentException('invalid length for "$name" when calling InboxControllerApi.getInboxByName, must be bigger than or equal to 1.');
        }
     ...
     * @param  bool $sync_connectors Sync connectors before fetching emails (optional)
     ...
     */
    public function getInboxEmailsPaginated($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $sync_connectors = null, string $contentType = self::contentTypes['getInboxEmailsPaginated'][0])
    {
        list($response) = $this->getInboxEmailsPaginatedWithHttpInfo($inbox_id, $page, $size, $sort, $since, $before, $sync_connectors, $contentType);
        return $response;
    }
     ...
     */
    public function getInboxEmailsPaginatedWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $sync_connectors = null, string $contentType = self::contentTypes['getInboxEmailsPaginated'][0])
    {
        $request = $this->getInboxEmailsPaginatedRequest($inbox_id, $page, $size, $sort, $since, $before, $sync_connectors, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxEmailsPaginatedAsync($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $sync_connectors = null, string $contentType = self::contentTypes['getInboxEmailsPaginated'][0])
    {
        return $this->getInboxEmailsPaginatedAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $since, $before, $sync_connectors, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxEmailsPaginatedAsyncWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $sync_connectors = null, string $contentType = self::contentTypes['getInboxEmailsPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailPreview';
        $request = $this->getInboxEmailsPaginatedRequest($inbox_id, $page, $size, $sort, $since, $before, $sync_connectors, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxEmailsPaginatedRequest($inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $sync_connectors = null, string $contentType = self::contentTypes['getInboxEmailsPaginated'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $sync_connectors,
            'syncConnectors', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddress'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PlusAddressDto
     */
    public function getInboxPlusAddress($plus_address_id, $inbox_id, string $contentType = self::contentTypes['getInboxPlusAddress'][0])
    {
        list($response) = $this->getInboxPlusAddressWithHttpInfo($plus_address_id, $inbox_id, $contentType);
        return $response;
    }

    /**
     * Operation getInboxPlusAddressWithHttpInfo
     *
     * Get sub address plus address for an inbox
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\PlusAddressDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxPlusAddressWithHttpInfo($plus_address_id, $inbox_id, string $contentType = self::contentTypes['getInboxPlusAddress'][0])
    {
        $request = $this->getInboxPlusAddressRequest($plus_address_id, $inbox_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\PlusAddressDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\PlusAddressDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\PlusAddressDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\PlusAddressDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\PlusAddressDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getInboxPlusAddressAsync
     *
     * Get sub address plus address for an inbox
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressAsync($plus_address_id, $inbox_id, string $contentType = self::contentTypes['getInboxPlusAddress'][0])
    {
        return $this->getInboxPlusAddressAsyncWithHttpInfo($plus_address_id, $inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxPlusAddressAsyncWithHttpInfo
     *
     * Get sub address plus address for an inbox
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressAsyncWithHttpInfo($plus_address_id, $inbox_id, string $contentType = self::contentTypes['getInboxPlusAddress'][0])
    {
        $returnType = '\MailSlurp\Models\PlusAddressDto';
        $request = $this->getInboxPlusAddressRequest($plus_address_id, $inbox_id, $contentType);
    ...
    /**
     * Create request for operation 'getInboxPlusAddress'
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     * @param  string $inbox_id ID of the inbox you want to fetch (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddress'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxPlusAddressRequest($plus_address_id, $inbox_id, string $contentType = self::contentTypes['getInboxPlusAddress'][0])
    {

        // verify the required parameter 'plus_address_id' is set
        if ($plus_address_id === null || (is_array($plus_address_id) && count($plus_address_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $plus_address_id when calling getInboxPlusAddress'
            );
        }
        ...
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxPlusAddress'
            );
        }


        $resourcePath = '/inboxes/{inboxId}/plus-addresses/{plusAddressId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // path params
        if ($plus_address_id !== null) {
            $resourcePath = str_replace(
                '{' . 'plusAddressId' . '}',
                ObjectSerializer::toPathValue($plus_address_id),
                $resourcePath
            );
        }
        // path params
    ...
    /**
     * Operation getInboxPlusAddressById
     *
     * Get sub address plus address by ID
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     * @param  string $inbox_id ID of the inbox you want to filter for (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddressById'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PlusAddressDto
     */
    public function getInboxPlusAddressById($plus_address_id, $inbox_id = null, string $contentType = self::contentTypes['getInboxPlusAddressById'][0])
    {
        list($response) = $this->getInboxPlusAddressByIdWithHttpInfo($plus_address_id, $inbox_id, $contentType);
        return $response;
    }

    /**
     * Operation getInboxPlusAddressByIdWithHttpInfo
     *
     * Get sub address plus address by ID
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     ...
     * @return array of \MailSlurp\Models\PlusAddressDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxPlusAddressByIdWithHttpInfo($plus_address_id, $inbox_id = null, string $contentType = self::contentTypes['getInboxPlusAddressById'][0])
    {
        $request = $this->getInboxPlusAddressByIdRequest($plus_address_id, $inbox_id, $contentType);
    ...
    /**
     * Operation getInboxPlusAddressByIdAsync
     *
     * Get sub address plus address by ID
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressByIdAsync($plus_address_id, $inbox_id = null, string $contentType = self::contentTypes['getInboxPlusAddressById'][0])
    {
        return $this->getInboxPlusAddressByIdAsyncWithHttpInfo($plus_address_id, $inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxPlusAddressByIdAsyncWithHttpInfo
     *
     * Get sub address plus address by ID
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressByIdAsyncWithHttpInfo($plus_address_id, $inbox_id = null, string $contentType = self::contentTypes['getInboxPlusAddressById'][0])
    {
        $returnType = '\MailSlurp\Models\PlusAddressDto';
        $request = $this->getInboxPlusAddressByIdRequest($plus_address_id, $inbox_id, $contentType);
    ...
    /**
     * Create request for operation 'getInboxPlusAddressById'
     *
     * @param  string $plus_address_id ID of the plus address you want to fetch (required)
     * @param  string $inbox_id ID of the inbox you want to filter for (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddressById'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxPlusAddressByIdRequest($plus_address_id, $inbox_id = null, string $contentType = self::contentTypes['getInboxPlusAddressById'][0])
    {

        // verify the required parameter 'plus_address_id' is set
        if ($plus_address_id === null || (is_array($plus_address_id) && count($plus_address_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $plus_address_id when calling getInboxPlusAddressById'
            );
        }



        $resourcePath = '/inboxes/plus-addresses/{plusAddressId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getInboxPlusAddressEmails
     *
     ...
     * @param  \DateTime $since Optional filter by created after given date time (optional)
     * @param  \DateTime $before Optional filter by created before given date time (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddressEmails'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageEmailPreview
     */
    public function getInboxPlusAddressEmails($plus_address, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmails'][0])
    {
        list($response) = $this->getInboxPlusAddressEmailsWithHttpInfo($plus_address, $inbox_id, $page, $size, $sort, $since, $before, $contentType);
        return $response;
    }

    /**
     * Operation getInboxPlusAddressEmailsWithHttpInfo
     *
     * Get emails for a given inbox plus address
     *
     * @param  string $plus_address The plus address to fetch emails for. If your inbox address is &#x60;123@test.com&#x60; and the email was sent to &#x60;123+abc@test.com&#x60; then the plus address is &#x60;abc&#x60; (required)
     ...
     * @return array of \MailSlurp\Models\PageEmailPreview, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxPlusAddressEmailsWithHttpInfo($plus_address, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmails'][0])
    {
        $request = $this->getInboxPlusAddressEmailsRequest($plus_address, $inbox_id, $page, $size, $sort, $since, $before, $contentType);
    ...
    /**
     * Operation getInboxPlusAddressEmailsAsync
     *
     * Get emails for a given inbox plus address
     *
     * @param  string $plus_address The plus address to fetch emails for. If your inbox address is &#x60;123@test.com&#x60; and the email was sent to &#x60;123+abc@test.com&#x60; then the plus address is &#x60;abc&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressEmailsAsync($plus_address, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmails'][0])
    {
        return $this->getInboxPlusAddressEmailsAsyncWithHttpInfo($plus_address, $inbox_id, $page, $size, $sort, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxPlusAddressEmailsAsyncWithHttpInfo
     *
     * Get emails for a given inbox plus address
     *
     * @param  string $plus_address The plus address to fetch emails for. If your inbox address is &#x60;123@test.com&#x60; and the email was sent to &#x60;123+abc@test.com&#x60; then the plus address is &#x60;abc&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressEmailsAsyncWithHttpInfo($plus_address, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmails'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailPreview';
        $request = $this->getInboxPlusAddressEmailsRequest($plus_address, $inbox_id, $page, $size, $sort, $since, $before, $contentType);
    ...
    /**
     * Create request for operation 'getInboxPlusAddressEmails'
     *
     * @param  string $plus_address The plus address to fetch emails for. If your inbox address is &#x60;123@test.com&#x60; and the email was sent to &#x60;123+abc@test.com&#x60; then the plus address is &#x60;abc&#x60; (required)
     * @param  string $inbox_id ID of the inbox you want to send the email from (required)
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxPlusAddressEmailsRequest($plus_address, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmails'][0])
    {

        // verify the required parameter 'plus_address' is set
        if ($plus_address === null || (is_array($plus_address) && count($plus_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $plus_address when calling getInboxPlusAddressEmails'
            );
        }
        ...
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxPlusAddressEmails'
            );
        }
        ...
        $resourcePath = '/inboxes/{inboxId}/plus-addresses/emails';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getInboxPlusAddressEmailsForPlusAddressId
     *
     * Get emails for a given inbox plus address
     *
     ...
     * @param  \DateTime $since Optional filter by created after given date time (optional)
     * @param  \DateTime $before Optional filter by created before given date time (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddressEmailsForPlusAddressId'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageEmailPreview
     */
    public function getInboxPlusAddressEmailsForPlusAddressId($plus_address_id, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmailsForPlusAddressId'][0])
    {
        list($response) = $this->getInboxPlusAddressEmailsForPlusAddressIdWithHttpInfo($plus_address_id, $inbox_id, $page, $size, $sort, $since, $before, $contentType);
        return $response;
    }

    /**
     * Operation getInboxPlusAddressEmailsForPlusAddressIdWithHttpInfo
     *
     * Get emails for a given inbox plus address
     *
     * @param  string $plus_address_id The plus address ID to fetch emails for. (required)
     ...
     * @return array of \MailSlurp\Models\PageEmailPreview, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxPlusAddressEmailsForPlusAddressIdWithHttpInfo($plus_address_id, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmailsForPlusAddressId'][0])
    {
        $request = $this->getInboxPlusAddressEmailsForPlusAddressIdRequest($plus_address_id, $inbox_id, $page, $size, $sort, $since, $before, $contentType);
    ...
    /**
     * Operation getInboxPlusAddressEmailsForPlusAddressIdAsync
     *
     * Get emails for a given inbox plus address
     *
     * @param  string $plus_address_id The plus address ID to fetch emails for. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressEmailsForPlusAddressIdAsync($plus_address_id, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmailsForPlusAddressId'][0])
    {
        return $this->getInboxPlusAddressEmailsForPlusAddressIdAsyncWithHttpInfo($plus_address_id, $inbox_id, $page, $size, $sort, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxPlusAddressEmailsForPlusAddressIdAsyncWithHttpInfo
     *
     * Get emails for a given inbox plus address
     *
     * @param  string $plus_address_id The plus address ID to fetch emails for. (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressEmailsForPlusAddressIdAsyncWithHttpInfo($plus_address_id, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmailsForPlusAddressId'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailPreview';
        $request = $this->getInboxPlusAddressEmailsForPlusAddressIdRequest($plus_address_id, $inbox_id, $page, $size, $sort, $since, $before, $contentType);
    ...
    /**
     * Create request for operation 'getInboxPlusAddressEmailsForPlusAddressId'
     *
     * @param  string $plus_address_id The plus address ID to fetch emails for. (required)
     * @param  string $inbox_id ID of the inbox you want to send the email from (required)
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxPlusAddressEmailsForPlusAddressIdRequest($plus_address_id, $inbox_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getInboxPlusAddressEmailsForPlusAddressId'][0])
    {

        // verify the required parameter 'plus_address_id' is set
        if ($plus_address_id === null || (is_array($plus_address_id) && count($plus_address_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $plus_address_id when calling getInboxPlusAddressEmailsForPlusAddressId'
            );
        }
        ...
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxPlusAddressEmailsForPlusAddressId'
            );
        }
        ...
        $resourcePath = '/inboxes/{inboxId}/plus-addresses/{plusAddressId}/emails';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getInboxPlusAddresses
     *
     ...
     * @param  int $size Optional page size in inbox tracking pixel list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxPlusAddresses'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PagePlusAddressProjection
     */
    public function getInboxPlusAddresses($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getInboxPlusAddresses'][0])
    {
        list($response) = $this->getInboxPlusAddressesWithHttpInfo($inbox_id, $page, $size, $sort, $contentType);
        return $response;
    }

    /**
     * Operation getInboxPlusAddressesWithHttpInfo
     *
     * Get sub address plus address aliases for an inbox
     *
     * @param  string $inbox_id ID of the inbox you want to send the email from (required)
     ...
     * @return array of \MailSlurp\Models\PagePlusAddressProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxPlusAddressesWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getInboxPlusAddresses'][0])
    {
        $request = $this->getInboxPlusAddressesRequest($inbox_id, $page, $size, $sort, $contentType);
    ...
    /**
     * Operation getInboxPlusAddressesAsync
     *
     * Get sub address plus address aliases for an inbox
     *
     * @param  string $inbox_id ID of the inbox you want to send the email from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressesAsync($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getInboxPlusAddresses'][0])
    {
        return $this->getInboxPlusAddressesAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxPlusAddressesAsyncWithHttpInfo
     *
     * Get sub address plus address aliases for an inbox
     *
     * @param  string $inbox_id ID of the inbox you want to send the email from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxPlusAddressesAsyncWithHttpInfo($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getInboxPlusAddresses'][0])
    {
        $returnType = '\MailSlurp\Models\PagePlusAddressProjection';
        $request = $this->getInboxPlusAddressesRequest($inbox_id, $page, $size, $sort, $contentType);
    ...
    /**
     * Create request for operation 'getInboxPlusAddresses'
     *
     * @param  string $inbox_id ID of the inbox you want to send the email from (required)
     * @param  int $page Optional page index in inbox tracking pixel list pagination (optional, default to 0)
     * @param  int $size Optional page size in inbox tracking pixel list pagination (optional, default to 20)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxPlusAddressesRequest($inbox_id, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getInboxPlusAddresses'][0])
    {

        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxPlusAddresses'
            );
        }
        ...
        $resourcePath = '/inboxes/{inboxId}/plus-addresses';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getInboxSentCount
     *
     * Get sent email count in inbox
     *
     * @param  string $inbox_id Id of inbox that emails were sent from (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxSentCount'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\CountDto
     */
    public function getInboxSentCount($inbox_id, string $contentType = self::contentTypes['getInboxSentCount'][0])
    {
        list($response) = $this->getInboxSentCountWithHttpInfo($inbox_id, $contentType);
        return $response;
    }

    /**
     * Operation getInboxSentCountWithHttpInfo
     *
     * Get sent email count in inbox
     *
     * @param  string $inbox_id Id of inbox that emails were sent from (required)
     ...
     * @return array of \MailSlurp\Models\CountDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxSentCountWithHttpInfo($inbox_id, string $contentType = self::contentTypes['getInboxSentCount'][0])
    {
        $request = $this->getInboxSentCountRequest($inbox_id, $contentType);
    ...
    /**
     * Operation getInboxSentCountAsync
     *
     * Get sent email count in inbox
     *
     * @param  string $inbox_id Id of inbox that emails were sent from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxSentCountAsync($inbox_id, string $contentType = self::contentTypes['getInboxSentCount'][0])
    {
        return $this->getInboxSentCountAsyncWithHttpInfo($inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxSentCountAsyncWithHttpInfo
     *
     * Get sent email count in inbox
     *
     * @param  string $inbox_id Id of inbox that emails were sent from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxSentCountAsyncWithHttpInfo($inbox_id, string $contentType = self::contentTypes['getInboxSentCount'][0])
    {
        $returnType = '\MailSlurp\Models\CountDto';
        $request = $this->getInboxSentCountRequest($inbox_id, $contentType);
    ...
    /**
     * Create request for operation 'getInboxSentCount'
     *
     * @param  string $inbox_id Id of inbox that emails were sent from (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxSentCount'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxSentCountRequest($inbox_id, string $contentType = self::contentTypes['getInboxSentCount'][0])
    {

        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxSentCount'
            );
        }


        $resourcePath = '/inboxes/{inboxId}/sent/count';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return string[]
     */
    public function getInboxTags($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTags'][0])
    {
        list($response) = $this->getInboxTagsWithHttpInfo($page, $size, $sort, $search_filter, $contentType);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxTagsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTags'][0])
    {
        $request = $this->getInboxTagsRequest($page, $size, $sort, $search_filter, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxTagsAsync($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTags'][0])
    {
        return $this->getInboxTagsAsyncWithHttpInfo($page, $size, $sort, $search_filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxTagsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTags'][0])
    {
        $returnType = 'string[]';
        $request = $this->getInboxTagsRequest($page, $size, $sort, $search_filter, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxTagsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTags'][0])
    {
    ...
    /**
     * Operation getInboxTagsPaginated
     *
     ...
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  string $search_filter Optional search filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxTagsPaginated'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageInboxTags
     */
    public function getInboxTagsPaginated($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTagsPaginated'][0])
    {
        list($response) = $this->getInboxTagsPaginatedWithHttpInfo($page, $size, $sort, $search_filter, $contentType);
        return $response;
    }

    /**
     * Operation getInboxTagsPaginatedWithHttpInfo
     *
     * Get inbox tags paginated
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\PageInboxTags, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxTagsPaginatedWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTagsPaginated'][0])
    {
        $request = $this->getInboxTagsPaginatedRequest($page, $size, $sort, $search_filter, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\PageInboxTags' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\PageInboxTags' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\PageInboxTags', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\PageInboxTags';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\PageInboxTags',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getInboxTagsPaginatedAsync
     *
     * Get inbox tags paginated
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxTagsPaginatedAsync($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTagsPaginated'][0])
    {
        return $this->getInboxTagsPaginatedAsyncWithHttpInfo($page, $size, $sort, $search_filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxTagsPaginatedAsyncWithHttpInfo
     *
     * Get inbox tags paginated
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxTagsPaginatedAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTagsPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageInboxTags';
        $request = $this->getInboxTagsPaginatedRequest($page, $size, $sort, $search_filter, $contentType);
    ...
    /**
     * Create request for operation 'getInboxTagsPaginated'
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     * @param  int $size Optional page size in list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxTagsPaginatedRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxTagsPaginated'][0])
    {
        ...
        $resourcePath = '/inboxes/tags/paginated';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  \DateTime $before Optional filter by created before given date time (optional)
     * @param  string[] $include Optional inboxIds to include in result (optional)
     ...
     * @deprecated
     */
    public function getInboxes($size = 100, $sort = 'ASC', $since = null, $exclude_catch_all_inboxes = null, $before = null, $include = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        list($response) = $this->getInboxesWithHttpInfo($size, $sort, $since, $exclude_catch_all_inboxes, $before, $include, $contentType);
        return $response;
    }
     ...
     * @deprecated
     */
    public function getInboxesWithHttpInfo($size = 100, $sort = 'ASC', $since = null, $exclude_catch_all_inboxes = null, $before = null, $include = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        $request = $this->getInboxesRequest($size, $sort, $since, $exclude_catch_all_inboxes, $before, $include, $contentType);
     ...
     * @deprecated
     */
    public function getInboxesAsync($size = 100, $sort = 'ASC', $since = null, $exclude_catch_all_inboxes = null, $before = null, $include = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        return $this->getInboxesAsyncWithHttpInfo($size, $sort, $since, $exclude_catch_all_inboxes, $before, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @deprecated
     */
    public function getInboxesAsyncWithHttpInfo($size = 100, $sort = 'ASC', $since = null, $exclude_catch_all_inboxes = null, $before = null, $include = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
        $returnType = '\MailSlurp\Models\InboxDto[]';
        $request = $this->getInboxesRequest($size, $sort, $since, $exclude_catch_all_inboxes, $before, $include, $contentType);
     ...
     * @deprecated
     */
    public function getInboxesRequest($size = 100, $sort = 'ASC', $since = null, $exclude_catch_all_inboxes = null, $before = null, $include = null, string $contentType = self::contentTypes['getInboxes'][0])
    {
     ...
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  string $search_filter Optional search filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getInboxesByTag'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageInboxProjection
     */
    public function getInboxesByTag($tag, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxesByTag'][0])
    {
        list($response) = $this->getInboxesByTagWithHttpInfo($tag, $page, $size, $sort, $search_filter, $contentType);
        return $response;
    }

    /**
     * Operation getInboxesByTagWithHttpInfo
     *
     * Get inboxes for a tag
     *
     * @param  string $tag Tag to filter by (required)
     ...
     * @return array of \MailSlurp\Models\PageInboxProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxesByTagWithHttpInfo($tag, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxesByTag'][0])
    {
        $request = $this->getInboxesByTagRequest($tag, $page, $size, $sort, $search_filter, $contentType);
    ...
    /**
     * Operation getInboxesByTagAsync
     *
     * Get inboxes for a tag
     *
     * @param  string $tag Tag to filter by (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxesByTagAsync($tag, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxesByTag'][0])
    {
        return $this->getInboxesByTagAsyncWithHttpInfo($tag, $page, $size, $sort, $search_filter, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxesByTagAsyncWithHttpInfo
     *
     * Get inboxes for a tag
     *
     * @param  string $tag Tag to filter by (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxesByTagAsyncWithHttpInfo($tag, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxesByTag'][0])
    {
        $returnType = '\MailSlurp\Models\PageInboxProjection';
        $request = $this->getInboxesByTagRequest($tag, $page, $size, $sort, $search_filter, $contentType);
    ...
    /**
     * Create request for operation 'getInboxesByTag'
     *
     * @param  string $tag Tag to filter by (required)
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     * @param  int $size Optional page size in list pagination (optional, default to 20)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxesByTagRequest($tag, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, string $contentType = self::contentTypes['getInboxesByTag'][0])
    {

        // verify the required parameter 'tag' is set
        if ($tag === null || (is_array($tag) && count($tag) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $tag when calling getInboxesByTag'
            );
        }
        ...
        $resourcePath = '/inboxes/tags/inboxes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getOrCreateInboxPlusAddress
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrCreateInboxPlusAddress'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PlusAddressDto
     */
    public function getOrCreateInboxPlusAddress($inbox_id, $full_address, string $contentType = self::contentTypes['getOrCreateInboxPlusAddress'][0])
    {
        list($response) = $this->getOrCreateInboxPlusAddressWithHttpInfo($inbox_id, $full_address, $contentType);
        return $response;
    }

    /**
     * Operation getOrCreateInboxPlusAddressWithHttpInfo
     *
     * Get or create a plus address by full address
     *
     * @param  string $inbox_id ID of the inbox you want to target (required)
     ...
     * @return array of \MailSlurp\Models\PlusAddressDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrCreateInboxPlusAddressWithHttpInfo($inbox_id, $full_address, string $contentType = self::contentTypes['getOrCreateInboxPlusAddress'][0])
    {
        $request = $this->getOrCreateInboxPlusAddressRequest($inbox_id, $full_address, $contentType);
    ...
    /**
     * Operation getOrCreateInboxPlusAddressAsync
     *
     * Get or create a plus address by full address
     *
     * @param  string $inbox_id ID of the inbox you want to target (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrCreateInboxPlusAddressAsync($inbox_id, $full_address, string $contentType = self::contentTypes['getOrCreateInboxPlusAddress'][0])
    {
        return $this->getOrCreateInboxPlusAddressAsyncWithHttpInfo($inbox_id, $full_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrCreateInboxPlusAddressAsyncWithHttpInfo
     *
     * Get or create a plus address by full address
     *
     * @param  string $inbox_id ID of the inbox you want to target (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrCreateInboxPlusAddressAsyncWithHttpInfo($inbox_id, $full_address, string $contentType = self::contentTypes['getOrCreateInboxPlusAddress'][0])
    {
        $returnType = '\MailSlurp\Models\PlusAddressDto';
        $request = $this->getOrCreateInboxPlusAddressRequest($inbox_id, $full_address, $contentType);
    ...
    /**
     * Create request for operation 'getOrCreateInboxPlusAddress'
     *
     * @param  string $inbox_id ID of the inbox you want to target (required)
     * @param  string $full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrCreateInboxPlusAddress'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrCreateInboxPlusAddressRequest($inbox_id, $full_address, string $contentType = self::contentTypes['getOrCreateInboxPlusAddress'][0])
    {

        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getOrCreateInboxPlusAddress'
            );
        }
        ...
        if ($full_address === null || (is_array($full_address) && count($full_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $full_address when calling getOrCreateInboxPlusAddress'
            );
        }
        if (strlen($full_address) < 1) {
            throw new \InvalidArgumentException('invalid length for "$full_address" when calling InboxControllerApi.getOrCreateInboxPlusAddress, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/inboxes/{inboxId}/plus-addresses/get-or-create';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getOrCreatePlusAddressByFullAddress
     *
     * Get or create a plus address by full address without inbox ID
     *
     * @param  string $full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrCreatePlusAddressByFullAddress'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PlusAddressDto
     */
    public function getOrCreatePlusAddressByFullAddress($full_address, string $contentType = self::contentTypes['getOrCreatePlusAddressByFullAddress'][0])
    {
        list($response) = $this->getOrCreatePlusAddressByFullAddressWithHttpInfo($full_address, $contentType);
        return $response;
    }

    /**
     * Operation getOrCreatePlusAddressByFullAddressWithHttpInfo
     *
     * Get or create a plus address by full address without inbox ID
     *
     * @param  string $full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; (required)
     ...
     * @return array of \MailSlurp\Models\PlusAddressDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrCreatePlusAddressByFullAddressWithHttpInfo($full_address, string $contentType = self::contentTypes['getOrCreatePlusAddressByFullAddress'][0])
    {
        $request = $this->getOrCreatePlusAddressByFullAddressRequest($full_address, $contentType);
    ...
    /**
     * Operation getOrCreatePlusAddressByFullAddressAsync
     *
     * Get or create a plus address by full address without inbox ID
     *
     * @param  string $full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrCreatePlusAddressByFullAddressAsync($full_address, string $contentType = self::contentTypes['getOrCreatePlusAddressByFullAddress'][0])
    {
        return $this->getOrCreatePlusAddressByFullAddressAsyncWithHttpInfo($full_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOrCreatePlusAddressByFullAddressAsyncWithHttpInfo
     *
     * Get or create a plus address by full address without inbox ID
     *
     * @param  string $full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrCreatePlusAddressByFullAddressAsyncWithHttpInfo($full_address, string $contentType = self::contentTypes['getOrCreatePlusAddressByFullAddress'][0])
    {
        $returnType = '\MailSlurp\Models\PlusAddressDto';
        $request = $this->getOrCreatePlusAddressByFullAddressRequest($full_address, $contentType);
    ...
    /**
     * Create request for operation 'getOrCreatePlusAddressByFullAddress'
     *
     * @param  string $full_address Full recipient address including +suffix. Example: &#x60;inbox+alias@domain.com&#x60; (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOrCreatePlusAddressByFullAddress'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrCreatePlusAddressByFullAddressRequest($full_address, string $contentType = self::contentTypes['getOrCreatePlusAddressByFullAddress'][0])
    {

        // verify the required parameter 'full_address' is set
        if ($full_address === null || (is_array($full_address) && count($full_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $full_address when calling getOrCreatePlusAddressByFullAddress'
            );
        }
        if (strlen($full_address) < 1) {
            throw new \InvalidArgumentException('invalid length for "$full_address" when calling InboxControllerApi.getOrCreatePlusAddressByFullAddress, must be bigger than or equal to 1.');
        }
        

        $resourcePath = '/inboxes/get-or-create-plus-address';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  int $size Optional page size in list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getOutboxes'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageInboxProjection
     */
    public function getOutboxes($page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getOutboxes'][0])
    {
        list($response) = $this->getOutboxesWithHttpInfo($page, $size, $sort, $contentType);
        return $response;
    }

    /**
     * Operation getOutboxesWithHttpInfo
     *
     * List all inboxes with sent emails
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @return array of \MailSlurp\Models\PageInboxProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOutboxesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getOutboxes'][0])
    {
        $request = $this->getOutboxesRequest($page, $size, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOutboxesAsync($page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getOutboxes'][0])
    {
        return $this->getOutboxesAsyncWithHttpInfo($page, $size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getOutboxesAsyncWithHttpInfo
     *
     * List all inboxes with sent emails
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOutboxesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getOutboxes'][0])
    {
        $returnType = '\MailSlurp\Models\PageInboxProjection';
        $request = $this->getOutboxesRequest($page, $size, $sort, $contentType);
    ...
    /**
     * Create request for operation 'getOutboxes'
     *
     * @param  int $page Optional page index in list pagination (optional, default to 0)
     * @param  int $size Optional page size in list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOutboxesRequest($page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getOutboxes'][0])
    {
    ...
    /**
     * Operation importEmailIntoInbox
     *
     * Import email into inbox from base64 MIME
     *
     * @param  string $inbox_id inbox_id (required)
     * @param  \MailSlurp\Models\ImportEmailOptions $import_email_options import_email_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importEmailIntoInbox'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\Email
     */
    public function importEmailIntoInbox($inbox_id, $import_email_options, string $contentType = self::contentTypes['importEmailIntoInbox'][0])
    {
        list($response) = $this->importEmailIntoInboxWithHttpInfo($inbox_id, $import_email_options, $contentType);
        return $response;
    }

    /**
     * Operation importEmailIntoInboxWithHttpInfo
     *
     * Import email into inbox from base64 MIME
     *
     * @param  string $inbox_id (required)
     * @param  \MailSlurp\Models\ImportEmailOptions $import_email_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importEmailIntoInbox'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\Email, HTTP status code, HTTP response headers (array of strings)
     */
    public function importEmailIntoInboxWithHttpInfo($inbox_id, $import_email_options, string $contentType = self::contentTypes['importEmailIntoInbox'][0])
    {
        $request = $this->importEmailIntoInboxRequest($inbox_id, $import_email_options, $contentType);
    ...
    /**
     * Operation importEmailIntoInboxAsync
     *
     * Import email into inbox from base64 MIME
     *
     * @param  string $inbox_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importEmailIntoInboxAsync($inbox_id, $import_email_options, string $contentType = self::contentTypes['importEmailIntoInbox'][0])
    {
        return $this->importEmailIntoInboxAsyncWithHttpInfo($inbox_id, $import_email_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation importEmailIntoInboxAsyncWithHttpInfo
     *
     * Import email into inbox from base64 MIME
     *
     * @param  string $inbox_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importEmailIntoInboxAsyncWithHttpInfo($inbox_id, $import_email_options, string $contentType = self::contentTypes['importEmailIntoInbox'][0])
    {
        $returnType = '\MailSlurp\Models\Email';
        $request = $this->importEmailIntoInboxRequest($inbox_id, $import_email_options, $contentType);
    ...
    /**
     * Create request for operation 'importEmailIntoInbox'
     *
     * @param  string $inbox_id (required)
     * @param  \MailSlurp\Models\ImportEmailOptions $import_email_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importEmailIntoInbox'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function importEmailIntoInboxRequest($inbox_id, $import_email_options, string $contentType = self::contentTypes['importEmailIntoInbox'][0])
    {

        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling importEmailIntoInbox'
            );
        }

        // verify the required parameter 'import_email_options' is set
        if ($import_email_options === null || (is_array($import_email_options) && count($import_email_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $import_email_options when calling importEmailIntoInbox'
            );
        }


        $resourcePath = '/inboxes/{inboxId}/emails/import';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($import_email_options)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($import_email_options));
            } else {
                $httpBody = $import_email_options;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
    ...
    /**
     * Operation importEmailIntoInboxBytes
     *
     ...
     * @param  bool $run_pipeline run_pipeline (optional, default to false)
     * @param  bool $override_message_id override_message_id (optional, default to true)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importEmailIntoInboxBytes'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\Email
     */
    public function importEmailIntoInboxBytes($inbox_id, $body, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxBytes'][0])
    {
        list($response) = $this->importEmailIntoInboxBytesWithHttpInfo($inbox_id, $body, $external_id, $run_pipeline, $override_message_id, $contentType);
        return $response;
    }

    /**
     * Operation importEmailIntoInboxBytesWithHttpInfo
     *
     * Import email into inbox from raw MIME bytes
     *
     * @param  string $inbox_id (required)
     ...
     * @param  bool $run_pipeline (optional, default to false)
     * @param  bool $override_message_id (optional, default to true)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importEmailIntoInboxBytes'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\Email, HTTP status code, HTTP response headers (array of strings)
     */
    public function importEmailIntoInboxBytesWithHttpInfo($inbox_id, $body, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxBytes'][0])
    {
        $request = $this->importEmailIntoInboxBytesRequest($inbox_id, $body, $external_id, $run_pipeline, $override_message_id, $contentType);
    ...
    /**
     * Operation importEmailIntoInboxBytesAsync
     *
     * Import email into inbox from raw MIME bytes
     *
     * @param  string $inbox_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importEmailIntoInboxBytesAsync($inbox_id, $body, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxBytes'][0])
    {
        return $this->importEmailIntoInboxBytesAsyncWithHttpInfo($inbox_id, $body, $external_id, $run_pipeline, $override_message_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation importEmailIntoInboxBytesAsyncWithHttpInfo
     *
     * Import email into inbox from raw MIME bytes
     *
     * @param  string $inbox_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importEmailIntoInboxBytesAsyncWithHttpInfo($inbox_id, $body, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxBytes'][0])
    {
        $returnType = '\MailSlurp\Models\Email';
        $request = $this->importEmailIntoInboxBytesRequest($inbox_id, $body, $external_id, $run_pipeline, $override_message_id, $contentType);
    ...
    /**
     * Create request for operation 'importEmailIntoInboxBytes'
     *
     * @param  string $inbox_id (required)
     * @param  string $body (required)
     * @param  string $external_id (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function importEmailIntoInboxBytesRequest($inbox_id, $body, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxBytes'][0])
    {

        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling importEmailIntoInboxBytes'
            );
        }
        ...
        if ($body === null || (is_array($body) && count($body) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $body when calling importEmailIntoInboxBytes'
            );
        }
        ...
        $resourcePath = '/inboxes/{inboxId}/emails/import/raw';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $override_message_id,
            'overrideMessageId', // param base name
            'boolean', // openApiType
            'form', // style
            true, // explode
            false // required
    ...
    /**
     * Operation importEmailIntoInboxMultipart
     *
     ...
     * @param  bool $run_pipeline run_pipeline (optional, default to false)
     * @param  bool $override_message_id override_message_id (optional, default to true)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['importEmailIntoInboxMultipart'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\Email
     */
    public function importEmailIntoInboxMultipart($inbox_id, $file, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxMultipart'][0])
    {
        list($response) = $this->importEmailIntoInboxMultipartWithHttpInfo($inbox_id, $file, $external_id, $run_pipeline, $override_message_id, $contentType);
        return $response;
    }

    /**
     * Operation importEmailIntoInboxMultipartWithHttpInfo
     *
     * Import email into inbox from multipart EML upload
     *
     * @param  string $inbox_id (required)
     ...
     * @return array of \MailSlurp\Models\Email, HTTP status code, HTTP response headers (array of strings)
     */
    public function importEmailIntoInboxMultipartWithHttpInfo($inbox_id, $file, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxMultipart'][0])
    {
        $request = $this->importEmailIntoInboxMultipartRequest($inbox_id, $file, $external_id, $run_pipeline, $override_message_id, $contentType);
    ...
    /**
     * Operation importEmailIntoInboxMultipartAsync
     *
     * Import email into inbox from multipart EML upload
     *
     * @param  string $inbox_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importEmailIntoInboxMultipartAsync($inbox_id, $file, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxMultipart'][0])
    {
        return $this->importEmailIntoInboxMultipartAsyncWithHttpInfo($inbox_id, $file, $external_id, $run_pipeline, $override_message_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation importEmailIntoInboxMultipartAsyncWithHttpInfo
     *
     * Import email into inbox from multipart EML upload
     *
     * @param  string $inbox_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function importEmailIntoInboxMultipartAsyncWithHttpInfo($inbox_id, $file, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxMultipart'][0])
    {
        $returnType = '\MailSlurp\Models\Email';
        $request = $this->importEmailIntoInboxMultipartRequest($inbox_id, $file, $external_id, $run_pipeline, $override_message_id, $contentType);
    ...
    /**
     * Create request for operation 'importEmailIntoInboxMultipart'
     *
     * @param  string $inbox_id (required)
     * @param  \SplFileObject $file (required)
     * @param  string $external_id (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function importEmailIntoInboxMultipartRequest($inbox_id, $file, $external_id = null, $run_pipeline = false, $override_message_id = true, string $contentType = self::contentTypes['importEmailIntoInboxMultipart'][0])
    {

        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling importEmailIntoInboxMultipart'
            );
        }
        ...
        if ($file === null || (is_array($file) && count($file) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $file when calling importEmailIntoInboxMultipart'
            );
        }
        ...
        $resourcePath = '/inboxes/{inboxId}/emails/import/multipart';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
class DomainControllerApi
{
     ...
     *
     * @param  string $id id (required)
     * @param  \MailSlurp\Models\UpdateDomainOptions $update_domain_dto updateDomainDto (required)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\DomainDto
     */
    public function updateDomain($id, $update_domain_dto)
    {
        list($response) = $this->updateDomainWithHttpInfo($id, $update_domain_dto);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\DomainDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function updateDomainWithHttpInfo($id, $update_domain_dto)
    {
        $request = $this->updateDomainRequest($id, $update_domain_dto);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDomainAsync($id, $update_domain_dto)
    {
        return $this->updateDomainAsyncWithHttpInfo($id, $update_domain_dto)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function updateDomainAsyncWithHttpInfo($id, $update_domain_dto)
    {
        $returnType = '\MailSlurp\Models\DomainDto';
        $request = $this->updateDomainRequest($id, $update_domain_dto);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function updateDomainRequest($id, $update_domain_dto)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
        ...
        if ($update_domain_dto === null || (is_array($update_domain_dto) && count($update_domain_dto) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $update_domain_dto when calling updateDomain'
            );
        }
        ...
        // body params
        $_tempBody = null;
        if (isset($update_domain_dto)) {
            $_tempBody = $update_domain_dto;
        }

...
/**
    ...
    /**
     * Operation getAvailableDomainRegions
     *
     * Get all usable domains with account region status
     *
     * @param  string $inbox_type inbox_type (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableDomainRegions'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\DomainRegionGroupsDto
     */
    public function getAvailableDomainRegions($inbox_type = null, string $contentType = self::contentTypes['getAvailableDomainRegions'][0])
    {
        list($response) = $this->getAvailableDomainRegionsWithHttpInfo($inbox_type, $contentType);
        return $response;
    }

    /**
     * Operation getAvailableDomainRegionsWithHttpInfo
     *
     * Get all usable domains with account region status
     *
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\DomainRegionGroupsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAvailableDomainRegionsWithHttpInfo($inbox_type = null, string $contentType = self::contentTypes['getAvailableDomainRegions'][0])
    {
        $request = $this->getAvailableDomainRegionsRequest($inbox_type, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\DomainRegionGroupsDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\DomainRegionGroupsDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\DomainRegionGroupsDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\DomainRegionGroupsDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\DomainRegionGroupsDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAvailableDomainRegionsAsync
     *
     * Get all usable domains with account region status
     *
     * @param  string $inbox_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAvailableDomainRegionsAsync($inbox_type = null, string $contentType = self::contentTypes['getAvailableDomainRegions'][0])
    {
        return $this->getAvailableDomainRegionsAsyncWithHttpInfo($inbox_type, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAvailableDomainRegionsAsyncWithHttpInfo
     *
     * Get all usable domains with account region status
     *
     * @param  string $inbox_type (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAvailableDomainRegionsAsyncWithHttpInfo($inbox_type = null, string $contentType = self::contentTypes['getAvailableDomainRegions'][0])
    {
        $returnType = '\MailSlurp\Models\DomainRegionGroupsDto';
        $request = $this->getAvailableDomainRegionsRequest($inbox_type, $contentType);
    ...
    /**
     * Create request for operation 'getAvailableDomainRegions'
     *
     * @param  string $inbox_type (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAvailableDomainRegions'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAvailableDomainRegionsRequest($inbox_type = null, string $contentType = self::contentTypes['getAvailableDomainRegions'][0])
    {



        $resourcePath = '/domains/available-domain-regions';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
class DomainControllerApi
{
     ...
     */
    public function addDomainWildcardCatchAllRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createDomainRequest($create_domain_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteDomainRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateDomainRequest($id, $update_domain_options)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(

...
class ExtraOperationsApi
{
    ...
    /**
     * Operation createInboxWebhookUsingPOST
     *
     * Attach a webhook URL to an inbox
     *
     * @param  string $inbox_id inboxId (required)
     * @param  \MailSlurp\Models\CreateWebhookOptions $create_webhook_options options (required)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\Webhook
     */
    public function createInboxWebhookUsingPOST($inbox_id, $create_webhook_options)
    {
        list($response) = $this->createInboxWebhookUsingPOSTWithHttpInfo($inbox_id, $create_webhook_options);
        return $response;
    }

    /**
     * Operation createInboxWebhookUsingPOSTWithHttpInfo
     *
     * Attach a webhook URL to an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     */
    public function createInboxWebhookUsingPOSTWithHttpInfo($inbox_id, $create_webhook_options)
    {
        $request = $this->createInboxWebhookUsingPOSTRequest($inbox_id, $create_webhook_options);
    ...
    /**
     * Operation createInboxWebhookUsingPOSTAsync
     *
     * Attach a webhook URL to an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxWebhookUsingPOSTAsync($inbox_id, $create_webhook_options)
    {
        return $this->createInboxWebhookUsingPOSTAsyncWithHttpInfo($inbox_id, $create_webhook_options)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createInboxWebhookUsingPOSTAsyncWithHttpInfo
     *
     * Attach a webhook URL to an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createInboxWebhookUsingPOSTAsyncWithHttpInfo($inbox_id, $create_webhook_options)
    {
        $returnType = '\MailSlurp\Models\Webhook';
        $request = $this->createInboxWebhookUsingPOSTRequest($inbox_id, $create_webhook_options);
    ...
    /**
     * Create request for operation 'createInboxWebhookUsingPOST'
     *
     * @param  string $inbox_id inboxId (required)
     * @param  \MailSlurp\Models\CreateWebhookOptions $create_webhook_options options (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createInboxWebhookUsingPOSTRequest($inbox_id, $create_webhook_options)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling createInboxWebhookUsingPOST'
            );
        }
        ...
        if ($create_webhook_options === null || (is_array($create_webhook_options) && count($create_webhook_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $create_webhook_options when calling createInboxWebhookUsingPOST'
            );
        }
    ...
    /**
     * Operation getInboxWebhooksUsingDELETE
     *
     ...
     * @return void
     */
    public function getInboxWebhooksUsingDELETE($inbox_id, $webhook_id)
    {
        $this->getInboxWebhooksUsingDELETEWithHttpInfo($inbox_id, $webhook_id);
    }

    /**
     * Operation getInboxWebhooksUsingDELETEWithHttpInfo
     *
     * Delete and disable a webhook for an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxWebhooksUsingDELETEWithHttpInfo($inbox_id, $webhook_id)
    {
        $request = $this->getInboxWebhooksUsingDELETERequest($inbox_id, $webhook_id);
    ...
    /**
     * Operation getInboxWebhooksUsingDELETEAsync
     *
     * Delete and disable a webhook for an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksUsingDELETEAsync($inbox_id, $webhook_id)
    {
        return $this->getInboxWebhooksUsingDELETEAsyncWithHttpInfo($inbox_id, $webhook_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxWebhooksUsingDELETEAsyncWithHttpInfo
     *
     * Delete and disable a webhook for an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksUsingDELETEAsyncWithHttpInfo($inbox_id, $webhook_id)
    {
        $returnType = '';
        $request = $this->getInboxWebhooksUsingDELETERequest($inbox_id, $webhook_id);
    ...
    /**
     * Create request for operation 'getInboxWebhooksUsingDELETE'
     *
     * @param  string $inbox_id inboxId (required)
     * @param  string $webhook_id webhookId (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxWebhooksUsingDELETERequest($inbox_id, $webhook_id)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxWebhooksUsingDELETE'
            );
        }
        // verify the required parameter 'webhook_id' is set
        if ($webhook_id === null || (is_array($webhook_id) && count($webhook_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $webhook_id when calling getInboxWebhooksUsingDELETE'
            );
        }
    ...
    /**
     * Operation getInboxWebhooksUsingGET
     *
     ...
     * @return \MailSlurp\Models\Webhook[]
     */
    public function getInboxWebhooksUsingGET($inbox_id)
    {
        list($response) = $this->getInboxWebhooksUsingGETWithHttpInfo($inbox_id);
        return $response;
    }

    /**
     * Operation getInboxWebhooksUsingGETWithHttpInfo
     *
     * Get all webhooks for an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return array of \MailSlurp\Models\Webhook[], HTTP status code, HTTP response headers (array of strings)
     */
    public function getInboxWebhooksUsingGETWithHttpInfo($inbox_id)
    {
        $request = $this->getInboxWebhooksUsingGETRequest($inbox_id);
    ...
    /**
     * Operation getInboxWebhooksUsingGETAsync
     *
     * Get all webhooks for an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksUsingGETAsync($inbox_id)
    {
        return $this->getInboxWebhooksUsingGETAsyncWithHttpInfo($inbox_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getInboxWebhooksUsingGETAsyncWithHttpInfo
     *
     * Get all webhooks for an inbox
     *
     * @param  string $inbox_id inboxId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxWebhooksUsingGETAsyncWithHttpInfo($inbox_id)
    {
        $returnType = '\MailSlurp\Models\Webhook[]';
        $request = $this->getInboxWebhooksUsingGETRequest($inbox_id);
    ...
    /**
     * Create request for operation 'getInboxWebhooksUsingGET'
     *
     * @param  string $inbox_id inboxId (required)
     *
     * @throws \InvalidArgumentException
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxWebhooksUsingGETRequest($inbox_id)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $inbox_id when calling getInboxWebhooksUsingGET'
            );
        }

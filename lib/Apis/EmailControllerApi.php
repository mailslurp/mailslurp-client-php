...
class EmailControllerApi
{
     ...
     * @return \MailSlurp\Models\Email
     */
    public function getLatestEmailInInbox($inbox_id)
    {
     ...
     * @return array of \MailSlurp\Models\Email, HTTP status code, HTTP response headers (array of strings)
     */
    public function getLatestEmailInInboxWithHttpInfo($inbox_id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLatestEmailInInboxAsync($inbox_id)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getLatestEmailInInboxAsyncWithHttpInfo($inbox_id)
    {
        $returnType = '\MailSlurp\Models\Email';
        $request = $this->getLatestEmailInInboxRequest($inbox_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getLatestEmailInInboxRequest($inbox_id)
    {
     ...
     * @return void
     */
    public function sendEmailSourceOptional($send_email_options, $inbox_id = null, $use_domain_pool = null)
    {
        $this->sendEmailSourceOptionalWithHttpInfo($send_email_options, $inbox_id, $use_domain_pool);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendEmailSourceOptionalWithHttpInfo($send_email_options, $inbox_id = null, $use_domain_pool = null)
    {
        $request = $this->sendEmailSourceOptionalRequest($send_email_options, $inbox_id, $use_domain_pool);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailSourceOptionalAsync($send_email_options, $inbox_id = null, $use_domain_pool = null)
    {
        return $this->sendEmailSourceOptionalAsyncWithHttpInfo($send_email_options, $inbox_id, $use_domain_pool)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendEmailSourceOptionalAsyncWithHttpInfo($send_email_options, $inbox_id = null, $use_domain_pool = null)
    {
        $returnType = '';
        $request = $this->sendEmailSourceOptionalRequest($send_email_options, $inbox_id, $use_domain_pool);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendEmailSourceOptionalRequest($send_email_options, $inbox_id = null, $use_domain_pool = null)
    {

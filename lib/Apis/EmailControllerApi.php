...
/**
     ...
     */
    public function getEmailsOffsetPaginated($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        list($response) = $this->getEmailsOffsetPaginatedWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $contentType);
        return $response;
    }
     ...
     */
    public function getEmailsOffsetPaginatedWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        $request = $this->getEmailsOffsetPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsOffsetPaginatedAsync($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        return $this->getEmailsOffsetPaginatedAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsOffsetPaginatedAsyncWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getEmailsOffsetPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailsOffsetPaginatedRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {

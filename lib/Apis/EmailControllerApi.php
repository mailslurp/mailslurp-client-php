...
class EmailControllerApi
{
     ...
     */
    public function replyToEmail1($email_id, $reply_to_email_options)
    {
        list($response) = $this->replyToEmail1WithHttpInfo($email_id, $reply_to_email_options);
        return $response;
    }

    /**
     * Operation replyToEmail1WithHttpInfo
     *
     * Reply to an email
     *
     * @param  string $email_id ID of the email that should be replied to (required)
     ...
     */
    public function replyToEmail1WithHttpInfo($email_id, $reply_to_email_options)
    {
        $request = $this->replyToEmail1Request($email_id, $reply_to_email_options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replyToEmail1Async($email_id, $reply_to_email_options)
    {
        return $this->replyToEmail1AsyncWithHttpInfo($email_id, $reply_to_email_options)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation replyToEmail1AsyncWithHttpInfo
     *
     * Reply to an email
     *
     * @param  string $email_id ID of the email that should be replied to (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replyToEmail1AsyncWithHttpInfo($email_id, $reply_to_email_options)
    {
        $returnType = '\MailSlurp\Models\SentEmailDto';
        $request = $this->replyToEmail1Request($email_id, $reply_to_email_options);
    ...
    /**
     * Create request for operation 'replyToEmail1'
     *
     * @param  string $email_id ID of the email that should be replied to (required)
     * @param  \MailSlurp\Models\ReplyToEmailOptions $reply_to_email_options replyToEmailOptions (required)
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function replyToEmail1Request($email_id, $reply_to_email_options)
    {
        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling replyToEmail1'
            );
        }
        ...
        if ($reply_to_email_options === null || (is_array($reply_to_email_options) && count($reply_to_email_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reply_to_email_options when calling replyToEmail1'
            );
        }

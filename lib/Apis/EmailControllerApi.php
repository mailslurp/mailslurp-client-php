...
class EmailControllerApi
{
     ...
     */
    public function getEmailsPaginated($before = null, $inbox_id = null, $page = 0, $search_filter = 'false', $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        list($response) = $this->getEmailsPaginatedWithHttpInfo($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
        return $response;
    }
     ...
     */
    public function getEmailsPaginatedWithHttpInfo($before = null, $inbox_id = null, $page = 0, $search_filter = 'false', $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        $request = $this->getEmailsPaginatedRequest($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsPaginatedAsync($before = null, $inbox_id = null, $page = 0, $search_filter = 'false', $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        return $this->getEmailsPaginatedAsyncWithHttpInfo($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsPaginatedAsyncWithHttpInfo($before = null, $inbox_id = null, $page = 0, $search_filter = 'false', $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getEmailsPaginatedRequest($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmailsPaginatedRequest($before = null, $inbox_id = null, $page = 0, $search_filter = 'false', $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
     ...
     * @return \MailSlurp\Models\PageEmailProjection
     */
    public function getOrganizationEmailsPaginated($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        list($response) = $this->getOrganizationEmailsPaginatedWithHttpInfo($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageEmailProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationEmailsPaginatedWithHttpInfo($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        $request = $this->getOrganizationEmailsPaginatedRequest($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationEmailsPaginatedAsync($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        return $this->getOrganizationEmailsPaginatedAsyncWithHttpInfo($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationEmailsPaginatedAsyncWithHttpInfo($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getOrganizationEmailsPaginatedRequest($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getOrganizationEmailsPaginatedRequest($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC', $unread_only = false)
    {
    ...
    protected function markAsReadRequest($email_id, $read = true)
    {
        ...
        // query params
        if (is_array($read)) {
            $read = ObjectSerializer::serializeCollection($read, '', true);
        }
        if ($read !== null) {

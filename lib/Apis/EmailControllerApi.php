...
/**
     ...
     * @return string
     */
    public function getEmailHTML($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        list($response) = $this->getEmailHTMLWithHttpInfo($email_id, $decode, $contentType);
        return $response;
    }
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailHTMLWithHttpInfo($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        $request = $this->getEmailHTMLRequest($email_id, $decode, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLAsync($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        return $this->getEmailHTMLAsyncWithHttpInfo($email_id, $decode, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLAsyncWithHttpInfo($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        $returnType = 'string';
        $request = $this->getEmailHTMLRequest($email_id, $decode, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailHTMLRequest($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
     ...
     */
    public function getEmailHTMLJson($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        list($response) = $this->getEmailHTMLJsonWithHttpInfo($email_id, $decode, $contentType);
        return $response;
    }
     ...
     */
    public function getEmailHTMLJsonWithHttpInfo($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        $request = $this->getEmailHTMLJsonRequest($email_id, $decode, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLJsonAsync($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        return $this->getEmailHTMLJsonAsyncWithHttpInfo($email_id, $decode, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLJsonAsyncWithHttpInfo($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        $returnType = '\MailSlurp\Models\EmailHtmlDto';
        $request = $this->getEmailHTMLJsonRequest($email_id, $decode, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailHTMLJsonRequest($email_id, $decode = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
    ...
    {
        list($response) = $this->getRawEmailContentsWithHttpInfo($email_id, $contentType);
        return $response;
    }

...
class EmailControllerApi
{
     ...
     * @return \MailSlurp\Models\EmailTextLinesResult
     */
    public function getEmailTextLines($email_id, $decode_html_entities = null)
    {
        list($response) = $this->getEmailTextLinesWithHttpInfo($email_id, $decode_html_entities);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\EmailTextLinesResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailTextLinesWithHttpInfo($email_id, $decode_html_entities = null)
    {
        $request = $this->getEmailTextLinesRequest($email_id, $decode_html_entities);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailTextLinesAsync($email_id, $decode_html_entities = null)
    {
        return $this->getEmailTextLinesAsyncWithHttpInfo($email_id, $decode_html_entities)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailTextLinesAsyncWithHttpInfo($email_id, $decode_html_entities = null)
    {
        $returnType = '\MailSlurp\Models\EmailTextLinesResult';
        $request = $this->getEmailTextLinesRequest($email_id, $decode_html_entities);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getEmailTextLinesRequest($email_id, $decode_html_entities = null)
    {
        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(

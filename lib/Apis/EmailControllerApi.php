...
/**
    ...
    /**
     * Operation checkEmailAudit1
     *
     * Run aggregate email audit for a stored email
     *
     * @param  string $email_id email_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkEmailAudit1'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\EmailAuditAnalysisResult
     */
    public function checkEmailAudit1($email_id, string $contentType = self::contentTypes['checkEmailAudit1'][0])
    {
        list($response) = $this->checkEmailAudit1WithHttpInfo($email_id, $contentType);
        return $response;
    }

    /**
     * Operation checkEmailAudit1WithHttpInfo
     *
     * Run aggregate email audit for a stored email
     *
     * @param  string $email_id (required)
     ...
     */
    public function checkEmailAudit1WithHttpInfo($email_id, string $contentType = self::contentTypes['checkEmailAudit1'][0])
    {
        $request = $this->checkEmailAudit1Request($email_id, $contentType);
    ...
    /**
     * Operation checkEmailAudit1Async
     *
     * Run aggregate email audit for a stored email
     *
     * @param  string $email_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkEmailAudit1Async($email_id, string $contentType = self::contentTypes['checkEmailAudit1'][0])
    {
        return $this->checkEmailAudit1AsyncWithHttpInfo($email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation checkEmailAudit1AsyncWithHttpInfo
     *
     * Run aggregate email audit for a stored email
     *
     * @param  string $email_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function checkEmailAudit1AsyncWithHttpInfo($email_id, string $contentType = self::contentTypes['checkEmailAudit1'][0])
    {
        $returnType = '\MailSlurp\Models\EmailAuditAnalysisResult';
        $request = $this->checkEmailAudit1Request($email_id, $contentType);
    ...
    /**
     * Create request for operation 'checkEmailAudit1'
     *
     * @param  string $email_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['checkEmailAudit1'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function checkEmailAudit1Request($email_id, string $contentType = self::contentTypes['checkEmailAudit1'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling checkEmailAudit1'
            );
        }


        $resourcePath = '/emails/{emailId}/check-email-audit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation createEmailAuditForEmail
     *
     * Persist aggregate email audit for a stored email
     *
     * @param  string $email_id email_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailAuditForEmail'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\EmailAuditDto
     */
    public function createEmailAuditForEmail($email_id, string $contentType = self::contentTypes['createEmailAuditForEmail'][0])
    {
        list($response) = $this->createEmailAuditForEmailWithHttpInfo($email_id, $contentType);
        return $response;
    }

    /**
     * Operation createEmailAuditForEmailWithHttpInfo
     *
     * Persist aggregate email audit for a stored email
     *
     * @param  string $email_id (required)
     ...
     */
    public function createEmailAuditForEmailWithHttpInfo($email_id, string $contentType = self::contentTypes['createEmailAuditForEmail'][0])
    {
        $request = $this->createEmailAuditForEmailRequest($email_id, $contentType);
    ...
    /**
     * Operation createEmailAuditForEmailAsync
     *
     * Persist aggregate email audit for a stored email
     *
     * @param  string $email_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailAuditForEmailAsync($email_id, string $contentType = self::contentTypes['createEmailAuditForEmail'][0])
    {
        return $this->createEmailAuditForEmailAsyncWithHttpInfo($email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation createEmailAuditForEmailAsyncWithHttpInfo
     *
     * Persist aggregate email audit for a stored email
     *
     * @param  string $email_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createEmailAuditForEmailAsyncWithHttpInfo($email_id, string $contentType = self::contentTypes['createEmailAuditForEmail'][0])
    {
        $returnType = '\MailSlurp\Models\EmailAuditDto';
        $request = $this->createEmailAuditForEmailRequest($email_id, $contentType);
    ...
    /**
     * Create request for operation 'createEmailAuditForEmail'
     *
     * @param  string $email_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['createEmailAuditForEmail'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createEmailAuditForEmailRequest($email_id, string $contentType = self::contentTypes['createEmailAuditForEmail'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling createEmailAuditForEmail'
            );
        }


        $resourcePath = '/emails/{emailId}/audit';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    public function getEmailRequest($email_id, string $contentType = self::contentTypes['getEmail'][0])
    {
        ...
        $headers = $this->headerSelector->selectHeaders(
            ['application/json;charset=UTF-8', 'application/xml;charset=UTF-8', 'application/json; charset=UTF-8', 'application/xml; charset=UTF-8', ],
            $contentType,
            $multipart
        );
    ...
    /**
     * Operation getEmailCodes
     *
     * Extract verification codes from an email
     *
     * @param  string $email_id ID of email to extract codes from (required)
     * @param  \MailSlurp\Models\ExtractCodesOptions $extract_codes_options extract_codes_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailCodes'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\ExtractCodesResult
     */
    public function getEmailCodes($email_id, $extract_codes_options = null, string $contentType = self::contentTypes['getEmailCodes'][0])
    {
        list($response) = $this->getEmailCodesWithHttpInfo($email_id, $extract_codes_options, $contentType);
        return $response;
    }

    /**
     * Operation getEmailCodesWithHttpInfo
     *
     * Extract verification codes from an email
     *
     * @param  string $email_id ID of email to extract codes from (required)
     * @param  \MailSlurp\Models\ExtractCodesOptions $extract_codes_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailCodes'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\ExtractCodesResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailCodesWithHttpInfo($email_id, $extract_codes_options = null, string $contentType = self::contentTypes['getEmailCodes'][0])
    {
        $request = $this->getEmailCodesRequest($email_id, $extract_codes_options, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\ExtractCodesResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\ExtractCodesResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\ExtractCodesResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\ExtractCodesResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\ExtractCodesResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailCodesAsync($email_id, $extract_codes_options = null, string $contentType = self::contentTypes['getEmailCodes'][0])
    {
        return $this->getEmailCodesAsyncWithHttpInfo($email_id, $extract_codes_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailCodesAsyncWithHttpInfo
     *
     * Extract verification codes from an email
     *
     * @param  string $email_id ID of email to extract codes from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailCodesAsyncWithHttpInfo($email_id, $extract_codes_options = null, string $contentType = self::contentTypes['getEmailCodes'][0])
    {
        $returnType = '\MailSlurp\Models\ExtractCodesResult';
        $request = $this->getEmailCodesRequest($email_id, $extract_codes_options, $contentType);
    ...
    /**
     * Create request for operation 'getEmailCodes'
     *
     * @param  string $email_id ID of email to extract codes from (required)
     * @param  \MailSlurp\Models\ExtractCodesOptions $extract_codes_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailCodes'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailCodesRequest($email_id, $extract_codes_options = null, string $contentType = self::contentTypes['getEmailCodes'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling getEmailCodes'
            );
        }



        $resourcePath = '/emails/{emailId}/codes';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($extract_codes_options)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($extract_codes_options));
            } else {
                $httpBody = $extract_codes_options;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @param  bool $strict Strict content type match (optional)
     ...
     */
    public function getEmailContentPart($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPart'][0])
    {
        list($response) = $this->getEmailContentPartWithHttpInfo($email_id, $content_type, $strict, $index, $contentType);
        return $response;
    }
     ...
     */
    public function getEmailContentPartWithHttpInfo($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPart'][0])
    {
        $request = $this->getEmailContentPartRequest($email_id, $content_type, $strict, $index, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailContentPartAsync($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPart'][0])
    {
        return $this->getEmailContentPartAsyncWithHttpInfo($email_id, $content_type, $strict, $index, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailContentPartAsyncWithHttpInfo($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPart'][0])
    {
        $returnType = '\MailSlurp\Models\EmailContentPartResult';
        $request = $this->getEmailContentPartRequest($email_id, $content_type, $strict, $index, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailContentPartRequest($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPart'][0])
    {
    ...
    /**
     * Operation getEmailContentPartContent
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailContentPartContent'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return string
     */
    public function getEmailContentPartContent($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPartContent'][0])
    {
        list($response) = $this->getEmailContentPartContentWithHttpInfo($email_id, $content_type, $strict, $index, $contentType);
        return $response;
    }

    /**
     * Operation getEmailContentPartContentWithHttpInfo
     *
     * Get multipart content part as raw response
     *
     * @param  string $email_id ID of email to match against (required)
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailContentPartContentWithHttpInfo($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPartContent'][0])
    {
        $request = $this->getEmailContentPartContentRequest($email_id, $content_type, $strict, $index, $contentType);
    ...
    /**
     * Operation getEmailContentPartContentAsync
     *
     * Get multipart content part as raw response
     *
     * @param  string $email_id ID of email to match against (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailContentPartContentAsync($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPartContent'][0])
    {
        return $this->getEmailContentPartContentAsyncWithHttpInfo($email_id, $content_type, $strict, $index, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailContentPartContentAsyncWithHttpInfo
     *
     * Get multipart content part as raw response
     *
     * @param  string $email_id ID of email to match against (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailContentPartContentAsyncWithHttpInfo($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPartContent'][0])
    {
        $returnType = 'string';
        $request = $this->getEmailContentPartContentRequest($email_id, $content_type, $strict, $index, $contentType);
    ...
    /**
     * Create request for operation 'getEmailContentPartContent'
     *
     * @param  string $email_id ID of email to match against (required)
     * @param  string $content_type Content type (required)
     * @param  bool $strict Strict content type match (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailContentPartContentRequest($email_id, $content_type, $strict = null, $index = null, string $contentType = self::contentTypes['getEmailContentPartContent'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling getEmailContentPartContent'
            );
        }
        ...
        if ($content_type === null || (is_array($content_type) && count($content_type) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $content_type when calling getEmailContentPartContent'
            );
        }
        ...
        $resourcePath = '/emails/{emailId}/contentPart/raw';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @return string
     */
    public function getEmailHTML($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        list($response) = $this->getEmailHTMLWithHttpInfo($email_id, $replace_cid_images, $contentType);
        return $response;
    }
     ...
     * @return array of string, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailHTMLWithHttpInfo($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        $request = $this->getEmailHTMLRequest($email_id, $replace_cid_images, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLAsync($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        return $this->getEmailHTMLAsyncWithHttpInfo($email_id, $replace_cid_images, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLAsyncWithHttpInfo($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
        $returnType = 'string';
        $request = $this->getEmailHTMLRequest($email_id, $replace_cid_images, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailHTMLRequest($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTML'][0])
    {
     ...
     */
    public function getEmailHTMLJson($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        list($response) = $this->getEmailHTMLJsonWithHttpInfo($email_id, $replace_cid_images, $contentType);
        return $response;
    }
     ...
     */
    public function getEmailHTMLJsonWithHttpInfo($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        $request = $this->getEmailHTMLJsonRequest($email_id, $replace_cid_images, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLJsonAsync($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        return $this->getEmailHTMLJsonAsyncWithHttpInfo($email_id, $replace_cid_images, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailHTMLJsonAsyncWithHttpInfo($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
        $returnType = '\MailSlurp\Models\EmailHtmlDto';
        $request = $this->getEmailHTMLJsonRequest($email_id, $replace_cid_images, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailHTMLJsonRequest($email_id, $replace_cid_images = false, string $contentType = self::contentTypes['getEmailHTMLJson'][0])
    {
     ...
     */
    public function getEmailLinks($email_id, $selector = null, string $contentType = self::contentTypes['getEmailLinks'][0])
    {
        list($response) = $this->getEmailLinksWithHttpInfo($email_id, $selector, $contentType);
        return $response;
    }
     ...
     */
    public function getEmailLinksWithHttpInfo($email_id, $selector = null, string $contentType = self::contentTypes['getEmailLinks'][0])
    {
        $request = $this->getEmailLinksRequest($email_id, $selector, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailLinksAsync($email_id, $selector = null, string $contentType = self::contentTypes['getEmailLinks'][0])
    {
        return $this->getEmailLinksAsyncWithHttpInfo($email_id, $selector, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailLinksAsyncWithHttpInfo($email_id, $selector = null, string $contentType = self::contentTypes['getEmailLinks'][0])
    {
        $returnType = '\MailSlurp\Models\EmailLinksResult';
        $request = $this->getEmailLinksRequest($email_id, $selector, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailLinksRequest($email_id, $selector = null, string $contentType = self::contentTypes['getEmailLinks'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailSignature'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\EmailSignatureParseResult
     */
    public function getEmailSignature($email_id, string $contentType = self::contentTypes['getEmailSignature'][0])
    {
        list($response) = $this->getEmailSignatureWithHttpInfo($email_id, $contentType);
        return $response;
    }

    /**
     * Operation getEmailSignatureWithHttpInfo
     *
     * Extract signature from an inbound email
     *
     * @param  string $email_id ID of email to extract signature from (required)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\EmailSignatureParseResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailSignatureWithHttpInfo($email_id, string $contentType = self::contentTypes['getEmailSignature'][0])
    {
        $request = $this->getEmailSignatureRequest($email_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\EmailSignatureParseResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\EmailSignatureParseResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\EmailSignatureParseResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\EmailSignatureParseResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\EmailSignatureParseResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getEmailSignatureAsync
     *
     * Extract signature from an inbound email
     *
     * @param  string $email_id ID of email to extract signature from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailSignatureAsync($email_id, string $contentType = self::contentTypes['getEmailSignature'][0])
    {
        return $this->getEmailSignatureAsyncWithHttpInfo($email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailSignatureAsyncWithHttpInfo
     *
     * Extract signature from an inbound email
     *
     * @param  string $email_id ID of email to extract signature from (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailSignatureAsyncWithHttpInfo($email_id, string $contentType = self::contentTypes['getEmailSignature'][0])
    {
        $returnType = '\MailSlurp\Models\EmailSignatureParseResult';
        $request = $this->getEmailSignatureRequest($email_id, $contentType);
    ...
    /**
     * Create request for operation 'getEmailSignature'
     *
     * @param  string $email_id ID of email to extract signature from (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailSignature'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailSignatureRequest($email_id, string $contentType = self::contentTypes['getEmailSignature'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling getEmailSignature'
            );
        }


        $resourcePath = '/emails/{emailId}/signature';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     *
     * @param  string $email_id email_id (required)
     * @param  bool $decode Deprecated and ignored. Retained for backwards compatibility. (optional)
     ...
     * @return \MailSlurp\Models\EmailPreview
     */
    public function getEmailSummary($email_id, $decode = null, string $contentType = self::contentTypes['getEmailSummary'][0])
    {
        list($response) = $this->getEmailSummaryWithHttpInfo($email_id, $decode, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\EmailPreview, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailSummaryWithHttpInfo($email_id, $decode = null, string $contentType = self::contentTypes['getEmailSummary'][0])
    {
        $request = $this->getEmailSummaryRequest($email_id, $decode, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailSummaryAsync($email_id, $decode = null, string $contentType = self::contentTypes['getEmailSummary'][0])
    {
        return $this->getEmailSummaryAsyncWithHttpInfo($email_id, $decode, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailSummaryAsyncWithHttpInfo($email_id, $decode = null, string $contentType = self::contentTypes['getEmailSummary'][0])
    {
        $returnType = '\MailSlurp\Models\EmailPreview';
        $request = $this->getEmailSummaryRequest($email_id, $decode, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailSummaryRequest($email_id, $decode = null, string $contentType = self::contentTypes['getEmailSummary'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling getEmailSummary'
            );
        }



        $resourcePath = '/emails/{emailId}/summary';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\EmailThreadDto
     */
    public function getEmailThread($thread_id, string $contentType = self::contentTypes['getEmailThread'][0])
    {
        list($response) = $this->getEmailThreadWithHttpInfo($thread_id, $contentType);
        return $response;
    }
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\EmailThreadDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailThreadWithHttpInfo($thread_id, string $contentType = self::contentTypes['getEmailThread'][0])
    {
        $request = $this->getEmailThreadRequest($thread_id, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\EmailThreadDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\EmailThreadDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\EmailThreadDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\EmailThreadDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\EmailThreadDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailThreadAsync($thread_id, string $contentType = self::contentTypes['getEmailThread'][0])
    {
        return $this->getEmailThreadAsyncWithHttpInfo($thread_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailThreadAsyncWithHttpInfo($thread_id, string $contentType = self::contentTypes['getEmailThread'][0])
    {
        $returnType = '\MailSlurp\Models\EmailThreadDto';
        $request = $this->getEmailThreadRequest($thread_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailThreadRequest($thread_id, string $contentType = self::contentTypes['getEmailThread'][0])
    {

        // verify the required parameter 'thread_id' is set
        if ($thread_id === null || (is_array($thread_id) && count($thread_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $thread_id when calling getEmailThread'
            );
        }


        $resourcePath = '/emails/threads/{threadId}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getEmailThreadItems
     *
     * Get messages in a specific email thread
     *
     * @param  string $thread_id thread_id (required)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailThreadItems'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\EmailThreadItemsDto
     */
    public function getEmailThreadItems($thread_id, $sort = 'ASC', string $contentType = self::contentTypes['getEmailThreadItems'][0])
    {
        list($response) = $this->getEmailThreadItemsWithHttpInfo($thread_id, $sort, $contentType);
        return $response;
    }

    /**
     * Operation getEmailThreadItemsWithHttpInfo
     *
     * Get messages in a specific email thread
     *
     * @param  string $thread_id (required)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\EmailThreadItemsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailThreadItemsWithHttpInfo($thread_id, $sort = 'ASC', string $contentType = self::contentTypes['getEmailThreadItems'][0])
    {
        $request = $this->getEmailThreadItemsRequest($thread_id, $sort, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\EmailThreadItemsDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\EmailThreadItemsDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\EmailThreadItemsDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\EmailThreadItemsDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\EmailThreadItemsDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getEmailThreadItemsAsync
     *
     * Get messages in a specific email thread
     *
     * @param  string $thread_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailThreadItemsAsync($thread_id, $sort = 'ASC', string $contentType = self::contentTypes['getEmailThreadItems'][0])
    {
        return $this->getEmailThreadItemsAsyncWithHttpInfo($thread_id, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailThreadItemsAsyncWithHttpInfo
     *
     * Get messages in a specific email thread
     *
     * @param  string $thread_id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailThreadItemsAsyncWithHttpInfo($thread_id, $sort = 'ASC', string $contentType = self::contentTypes['getEmailThreadItems'][0])
    {
        $returnType = '\MailSlurp\Models\EmailThreadItemsDto';
        $request = $this->getEmailThreadItemsRequest($thread_id, $sort, $contentType);
    ...
    /**
     * Create request for operation 'getEmailThreadItems'
     *
     * @param  string $thread_id (required)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailThreadItems'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailThreadItemsRequest($thread_id, $sort = 'ASC', string $contentType = self::contentTypes['getEmailThreadItems'][0])
    {

        // verify the required parameter 'thread_id' is set
        if ($thread_id === null || (is_array($thread_id) && count($thread_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $thread_id when calling getEmailThreadItems'
            );
        }



        $resourcePath = '/emails/threads/{threadId}/items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailThreads'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageEmailThreadProjection
     */
    public function getEmailThreads($html_selector = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getEmailThreads'][0])
    {
        list($response) = $this->getEmailThreadsWithHttpInfo($html_selector, $page, $size, $sort, $search_filter, $since, $before, $contentType);
        return $response;
    }

    /**
     * Operation getEmailThreadsWithHttpInfo
     *
     * List email threads in paginated form
     *
     * @param  string $html_selector Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility. (optional)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\PageEmailThreadProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailThreadsWithHttpInfo($html_selector = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getEmailThreads'][0])
    {
        $request = $this->getEmailThreadsRequest($html_selector, $page, $size, $sort, $search_filter, $since, $before, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\PageEmailThreadProjection' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\PageEmailThreadProjection' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\PageEmailThreadProjection', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\PageEmailThreadProjection';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\PageEmailThreadProjection',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getEmailThreadsAsync
     *
     * List email threads in paginated form
     *
     * @param  string $html_selector Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailThreadsAsync($html_selector = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getEmailThreads'][0])
    {
        return $this->getEmailThreadsAsyncWithHttpInfo($html_selector, $page, $size, $sort, $search_filter, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailThreadsAsyncWithHttpInfo
     *
     * List email threads in paginated form
     *
     * @param  string $html_selector Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility. (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailThreadsAsyncWithHttpInfo($html_selector = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getEmailThreads'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailThreadProjection';
        $request = $this->getEmailThreadsRequest($html_selector, $page, $size, $sort, $search_filter, $since, $before, $contentType);
    ...
    /**
     * Create request for operation 'getEmailThreads'
     *
     * @param  string $html_selector Optional inbox filter. Query parameter name is &#x60;htmlSelector&#x60; for legacy compatibility. (optional)
     * @param  int $page Optional page index in email thread pagination (optional, default to 0)
     * @param  int $size Optional page size in email thread pagination. Maximum size is 100. Use page index and sort to page through larger results (optional, default to 20)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailThreadsRequest($html_selector = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getEmailThreads'][0])
    {



        if ($size !== null && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling EmailControllerApi.getEmailThreads, must be smaller than or equal to 100.');
        }
     ...
     * @param  bool $favourited Optional filter emails that are favourited (optional)
     * @param  bool $sync_connectors Sync connectors (optional)
     ...
     */
    public function getEmailsOffsetPaginated($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, $include = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        list($response) = $this->getEmailsOffsetPaginatedWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $include, $contentType);
        return $response;
    }
     ...
     */
    public function getEmailsOffsetPaginatedWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, $include = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        $request = $this->getEmailsOffsetPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $include, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsOffsetPaginatedAsync($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, $include = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        return $this->getEmailsOffsetPaginatedAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsOffsetPaginatedAsyncWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, $include = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getEmailsOffsetPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $favourited, $sync_connectors, $plus_address_id, $include, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailsOffsetPaginatedRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $favourited = null, $sync_connectors = null, $plus_address_id = null, $include = null, string $contentType = self::contentTypes['getEmailsOffsetPaginated'][0])
    {
     ...
     * @return \MailSlurp\Models\PageEmailProjection
     */
    public function getEmailsPaginated($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $plus_address_id = null, $favourited = null, string $contentType = self::contentTypes['getEmailsPaginated'][0])
    {
        list($response) = $this->getEmailsPaginatedWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $plus_address_id, $favourited, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageEmailProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailsPaginatedWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $plus_address_id = null, $favourited = null, string $contentType = self::contentTypes['getEmailsPaginated'][0])
    {
        $request = $this->getEmailsPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $plus_address_id, $favourited, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsPaginatedAsync($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $plus_address_id = null, $favourited = null, string $contentType = self::contentTypes['getEmailsPaginated'][0])
    {
        return $this->getEmailsPaginatedAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $plus_address_id, $favourited, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailsPaginatedAsyncWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $plus_address_id = null, $favourited = null, string $contentType = self::contentTypes['getEmailsPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getEmailsPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $plus_address_id, $favourited, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailsPaginatedRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $plus_address_id = null, $favourited = null, string $contentType = self::contentTypes['getEmailsPaginated'][0])
    {
     ...
     * @param  \DateTime $before Optional filter emails received before given date time (optional)
     * @param  bool $sync_connectors Sync connectors (optional)
     * @param  bool $favourited Search only favorited emails (optional)
     * @param  string $plus_address_id Optional plus address ID filter (optional)
     ...
     * @return \MailSlurp\Models\PageEmailProjection
     */
    public function getOrganizationEmailsPaginated($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['getOrganizationEmailsPaginated'][0])
    {
        list($response) = $this->getOrganizationEmailsPaginatedWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $favourited, $plus_address_id, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageEmailProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrganizationEmailsPaginatedWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['getOrganizationEmailsPaginated'][0])
    {
        $request = $this->getOrganizationEmailsPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $favourited, $plus_address_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationEmailsPaginatedAsync($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['getOrganizationEmailsPaginated'][0])
    {
        return $this->getOrganizationEmailsPaginatedAsyncWithHttpInfo($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $favourited, $plus_address_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getOrganizationEmailsPaginatedAsyncWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['getOrganizationEmailsPaginated'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getOrganizationEmailsPaginatedRequest($inbox_id, $page, $size, $sort, $unread_only, $search_filter, $since, $before, $sync_connectors, $favourited, $plus_address_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getOrganizationEmailsPaginatedRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $unread_only = false, $search_filter = null, $since = null, $before = null, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['getOrganizationEmailsPaginated'][0])
    {
     ...
     * @param  bool $sync_connectors Sync connectors (optional)
     * @param  bool $favourited Search only favourited emails (optional)
     * @param  string $plus_address_id Optional plus address ID filter (optional)
     ...
     * @return \MailSlurp\Models\PageEmailProjection
     */
    public function searchEmails($search_emails_options, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['searchEmails'][0])
    {
        list($response) = $this->searchEmailsWithHttpInfo($search_emails_options, $sync_connectors, $favourited, $plus_address_id, $contentType);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageEmailProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function searchEmailsWithHttpInfo($search_emails_options, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['searchEmails'][0])
    {
        $request = $this->searchEmailsRequest($search_emails_options, $sync_connectors, $favourited, $plus_address_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchEmailsAsync($search_emails_options, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['searchEmails'][0])
    {
        return $this->searchEmailsAsyncWithHttpInfo($search_emails_options, $sync_connectors, $favourited, $plus_address_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function searchEmailsAsyncWithHttpInfo($search_emails_options, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['searchEmails'][0])
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->searchEmailsRequest($search_emails_options, $sync_connectors, $favourited, $plus_address_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function searchEmailsRequest($search_emails_options, $sync_connectors = null, $favourited = null, $plus_address_id = null, string $contentType = self::contentTypes['searchEmails'][0])
    {
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setEmailFavourited'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
     */
    public function setEmailFavourited($email_id, $favourited, string $contentType = self::contentTypes['setEmailFavourited'][0])
    {
        $this->setEmailFavouritedWithHttpInfo($email_id, $favourited, $contentType);
    }

    /**
     * Operation setEmailFavouritedWithHttpInfo
     *
     * Set email favourited state
     *
     * @param  string $email_id ID of email to set favourite state (required)
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function setEmailFavouritedWithHttpInfo($email_id, $favourited, string $contentType = self::contentTypes['setEmailFavourited'][0])
    {
        $request = $this->setEmailFavouritedRequest($email_id, $favourited, $contentType);
    ...
    /**
     * Operation setEmailFavouritedAsync
     *
     * Set email favourited state
     *
     * @param  string $email_id ID of email to set favourite state (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setEmailFavouritedAsync($email_id, $favourited, string $contentType = self::contentTypes['setEmailFavourited'][0])
    {
        return $this->setEmailFavouritedAsyncWithHttpInfo($email_id, $favourited, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation setEmailFavouritedAsyncWithHttpInfo
     *
     * Set email favourited state
     *
     * @param  string $email_id ID of email to set favourite state (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function setEmailFavouritedAsyncWithHttpInfo($email_id, $favourited, string $contentType = self::contentTypes['setEmailFavourited'][0])
    {
        $returnType = '';
        $request = $this->setEmailFavouritedRequest($email_id, $favourited, $contentType);
    ...
    /**
     * Create request for operation 'setEmailFavourited'
     *
     * @param  string $email_id ID of email to set favourite state (required)
     * @param  bool $favourited (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['setEmailFavourited'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function setEmailFavouritedRequest($email_id, $favourited, string $contentType = self::contentTypes['setEmailFavourited'][0])
    {

        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_id when calling setEmailFavourited'
            );
        }
        ...
        if ($favourited === null || (is_array($favourited) && count($favourited) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $favourited when calling setEmailFavourited'
            );
        }


        $resourcePath = '/emails/{emailId}/favourite';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

...
class TemplateControllerApi
{
     ...
     * Create a Template
     *
     * @param  \MailSlurp\Models\CreateTemplateOptions $create_template_options createTemplateOptions (required)
     *
     ...
     */
    public function getAllTemplates($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllTemplatesWithHttpInfo($before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllTemplatesWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllTemplatesRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTemplatesAsync($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAllTemplatesAsyncWithHttpInfo($before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTemplatesAsyncWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageTemplateProjection';
        $request = $this->getAllTemplatesRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllTemplatesRequest($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {

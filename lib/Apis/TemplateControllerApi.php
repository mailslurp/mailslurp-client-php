...
class TemplateControllerApi
{
     ...
     */
    public function getAllTemplates($page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllTemplatesWithHttpInfo($page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllTemplatesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllTemplatesRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTemplatesAsync($page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getAllTemplatesAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTemplatesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageTemplateProjection';
        $request = $this->getAllTemplatesRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllTemplatesRequest($page = 0, $size = 20, $sort = 'ASC')
    {

...
class MailServerControllerApi
{
     ...
     */
    public function describeMailServerDomainRequest($describe_domain_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getDnsLookupRequest($dns_lookup_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getIpAddressRequest($name)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function verifyEmailAddressRequest($verify_email_address_options)
    {

...
class SentEmailsControllerApi
{
     ...
     */
    public function deleteAllSentEmailsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteSentEmailRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllSentTrackingPixelsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRawSentEmailContentsRequest($email_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getRawSentEmailJsonRequest($email_id)
    {
        // verify the required parameter 'email_id' is set
        if ($email_id === null || (is_array($email_id) && count($email_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentDeliveryStatusRequest($delivery_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentDeliveryStatusesRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentDeliveryStatusesBySentIdRequest($sent_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentEmailRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentEmailHTMLContentRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentEmailPreviewURLsRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentEmailTrackingPixelsRequest($id, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentEmailsRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentEmailsWithQueueResultsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getSentOrganizationEmailsRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function waitForDeliveryStatusesRequest($sent_id = null, $inbox_id = null, $timeout = null, $index = null, $since = null, $before = null)
    {

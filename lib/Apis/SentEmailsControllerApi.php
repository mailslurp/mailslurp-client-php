...
class SentEmailsControllerApi
{
     ...
     */
    public function getSentEmails($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getSentEmailsWithHttpInfo($inbox_id, $page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getSentEmailsWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getSentEmailsRequest($inbox_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentEmailsAsync($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getSentEmailsAsyncWithHttpInfo($inbox_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentEmailsAsyncWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageSentEmailProjection';
        $request = $this->getSentEmailsRequest($inbox_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSentEmailsRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
     ...
     * @return \MailSlurp\Models\PageSentEmailProjection
     */
    public function getSentOrganizationEmails($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getSentOrganizationEmailsWithHttpInfo($inbox_id, $page, $size, $sort);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageSentEmailProjection, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSentOrganizationEmailsWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getSentOrganizationEmailsRequest($inbox_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentOrganizationEmailsAsync($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getSentOrganizationEmailsAsyncWithHttpInfo($inbox_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentOrganizationEmailsAsyncWithHttpInfo($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageSentEmailProjection';
        $request = $this->getSentOrganizationEmailsRequest($inbox_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSentOrganizationEmailsRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC')
    {

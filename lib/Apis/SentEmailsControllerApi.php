...
class SentEmailsControllerApi
{
     ...
     */
    public function getSentDeliveryStatus($delivery_id)
    {
        list($response) = $this->getSentDeliveryStatusWithHttpInfo($delivery_id);
        return $response;
    }
     ...
     */
    public function getSentDeliveryStatusWithHttpInfo($delivery_id)
    {
        $request = $this->getSentDeliveryStatusRequest($delivery_id);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDeliveryStatusAsync($delivery_id)
    {
        return $this->getSentDeliveryStatusAsyncWithHttpInfo($delivery_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDeliveryStatusAsyncWithHttpInfo($delivery_id)
    {
        $returnType = '\MailSlurp\Models\DeliveryStatusDto';
        $request = $this->getSentDeliveryStatusRequest($delivery_id);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSentDeliveryStatusRequest($delivery_id)
    {
     ...
     */
    public function getSentDeliveryStatuses($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        list($response) = $this->getSentDeliveryStatusesWithHttpInfo($page, $size, $sort, $since, $before);
        return $response;
    }
     ...
     */
    public function getSentDeliveryStatusesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $request = $this->getSentDeliveryStatusesRequest($page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDeliveryStatusesAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        return $this->getSentDeliveryStatusesAsyncWithHttpInfo($page, $size, $sort, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDeliveryStatusesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\PageDeliveryStatus';
        $request = $this->getSentDeliveryStatusesRequest($page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSentDeliveryStatusesRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     *
     * @param  string $sent_id sent_id (required)
     * @param  int $page Optional page index in delivery status list pagination (optional, default to 0)
     * @param  int $size Optional page size in delivery status list pagination (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'ASC')
     * @param  \DateTime $since Filter by created at after the given timestamp (optional)
     ...
     * @return \MailSlurp\Models\PageDeliveryStatus
     */
    public function getSentDeliveryStatusesBySentId($sent_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        list($response) = $this->getSentDeliveryStatusesBySentIdWithHttpInfo($sent_id, $page, $size, $sort, $since, $before);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\PageDeliveryStatus, HTTP status code, HTTP response headers (array of strings)
     */
    public function getSentDeliveryStatusesBySentIdWithHttpInfo($sent_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $request = $this->getSentDeliveryStatusesBySentIdRequest($sent_id, $page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDeliveryStatusesBySentIdAsync($sent_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        return $this->getSentDeliveryStatusesBySentIdAsyncWithHttpInfo($sent_id, $page, $size, $sort, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentDeliveryStatusesBySentIdAsyncWithHttpInfo($sent_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\PageDeliveryStatus';
        $request = $this->getSentDeliveryStatusesBySentIdRequest($sent_id, $page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSentDeliveryStatusesBySentIdRequest($sent_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     */
    public function getSentEmailsWithQueueResults($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        list($response) = $this->getSentEmailsWithQueueResultsWithHttpInfo($page, $size, $sort, $since, $before);
        return $response;
    }
     ...
     */
    public function getSentEmailsWithQueueResultsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $request = $this->getSentEmailsWithQueueResultsRequest($page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentEmailsWithQueueResultsAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        return $this->getSentEmailsWithQueueResultsAsyncWithHttpInfo($page, $size, $sort, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getSentEmailsWithQueueResultsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\PageSentEmailWithQueueProjection';
        $request = $this->getSentEmailsWithQueueResultsRequest($page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getSentEmailsWithQueueResultsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \MailSlurp\Models\DeliveryStatusDto
     */
    public function waitForDeliveryStatuses($sent_id = null, $inbox_id = null, $timeout = null, $index = null, $since = null, $before = null)
    {
        list($response) = $this->waitForDeliveryStatusesWithHttpInfo($sent_id, $inbox_id, $timeout, $index, $since, $before);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\DeliveryStatusDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function waitForDeliveryStatusesWithHttpInfo($sent_id = null, $inbox_id = null, $timeout = null, $index = null, $since = null, $before = null)
    {
        $request = $this->waitForDeliveryStatusesRequest($sent_id, $inbox_id, $timeout, $index, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForDeliveryStatusesAsync($sent_id = null, $inbox_id = null, $timeout = null, $index = null, $since = null, $before = null)
    {
        return $this->waitForDeliveryStatusesAsyncWithHttpInfo($sent_id, $inbox_id, $timeout, $index, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForDeliveryStatusesAsyncWithHttpInfo($sent_id = null, $inbox_id = null, $timeout = null, $index = null, $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\DeliveryStatusDto';
        $request = $this->waitForDeliveryStatusesRequest($sent_id, $inbox_id, $timeout, $index, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function waitForDeliveryStatusesRequest($sent_id = null, $inbox_id = null, $timeout = null, $index = null, $since = null, $before = null)
    {
        ...
        // query params
        if ($sent_id !== null) {
            if('form' === 'form' && is_array($sent_id)) {
                foreach($sent_id as $key => $value) {
                    $queryParams[$key] = $value;
                }
            }
            else {
                $queryParams['sentId'] = $sent_id;
            }
        }
        // query params
        if ($inbox_id !== null) {

...
/**
     ...
     */
    public function getAllContacts($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAllContacts'][0])
    {
        list($response) = $this->getAllContactsWithHttpInfo($page, $size, $sort, $since, $before, $contentType);
        return $response;
    }
     ...
     */
    public function getAllContactsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAllContacts'][0])
    {
        $request = $this->getAllContactsRequest($page, $size, $sort, $since, $before, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllContactsAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAllContacts'][0])
    {
        return $this->getAllContactsAsyncWithHttpInfo($page, $size, $sort, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllContactsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAllContacts'][0])
    {
        $returnType = '\MailSlurp\Models\PageContactProjection';
        $request = $this->getAllContactsRequest($page, $size, $sort, $since, $before, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllContactsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAllContacts'][0])
    {
    ...
    {
        list($response) = $this->getContactVCardWithHttpInfo($contact_id, $contentType);
        return $response;
    }

...
class ContactControllerApi
{
     ...
     */
    public function getAllContacts($page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllContactsWithHttpInfo($page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllContactsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllContactsRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllContactsAsync($page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getAllContactsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllContactsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageContactProjection';
        $request = $this->getAllContactsRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllContactsRequest($page = 0, $size = 20, $sort = 'ASC')
    {

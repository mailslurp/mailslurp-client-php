...
class ContactControllerApi
{
     ...
     */
    public function createContactRequest($create_contact_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteContactRequest($contact_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllContactsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactRequest($contact_id)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getContactVCardRequest($contact_id)
    {
        // verify the required parameter 'contact_id' is set
        if ($contact_id === null || (is_array($contact_id) && count($contact_id) === 0)) {
            throw new \InvalidArgumentException(

...
class CommonActionsControllerApi
{
     ...
     */
    public function createNewEmailAddress($use_domain_pool)
    {
        list($response) = $this->createNewEmailAddressWithHttpInfo($use_domain_pool);
        return $response;
    }
     ...
     */
    public function createNewEmailAddressWithHttpInfo($use_domain_pool)
    {
        $request = $this->createNewEmailAddressRequest($use_domain_pool);
     ...
     */
    public function createNewEmailAddressAsync($use_domain_pool)
    {
        return $this->createNewEmailAddressAsyncWithHttpInfo($use_domain_pool)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewEmailAddressAsyncWithHttpInfo($use_domain_pool)
    {
        $returnType = '\MailSlurp\Models\Inbox';
        $request = $this->createNewEmailAddressRequest($use_domain_pool);
     ...
     */
    protected function createNewEmailAddressRequest($use_domain_pool)
    {
        // verify the required parameter 'use_domain_pool' is set
        if ($use_domain_pool === null || (is_array($use_domain_pool) && count($use_domain_pool) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $use_domain_pool when calling createNewEmailAddress'
            );
        }
     ...
     * @return \MailSlurp\Models\Inbox
     */
    public function createNewEmailAddress1($use_domain_pool)
    {
        list($response) = $this->createNewEmailAddress1WithHttpInfo($use_domain_pool);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\Inbox, HTTP status code, HTTP response headers (array of strings)
     */
    public function createNewEmailAddress1WithHttpInfo($use_domain_pool)
    {
        $request = $this->createNewEmailAddress1Request($use_domain_pool);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewEmailAddress1Async($use_domain_pool)
    {
        return $this->createNewEmailAddress1AsyncWithHttpInfo($use_domain_pool)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewEmailAddress1AsyncWithHttpInfo($use_domain_pool)
    {
        $returnType = '\MailSlurp\Models\Inbox';
        $request = $this->createNewEmailAddress1Request($use_domain_pool);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function createNewEmailAddress1Request($use_domain_pool)
    {
        // verify the required parameter 'use_domain_pool' is set
        if ($use_domain_pool === null || (is_array($use_domain_pool) && count($use_domain_pool) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $use_domain_pool when calling createNewEmailAddress1'
            );
        }

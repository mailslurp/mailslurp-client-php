...
/**
     ...
     */
    public function createNewEmailAddress($allow_team_access = null, $use_domain_pool = null, $expires_at = null, $expires_in = null, $email_address = null, $inbox_type = null, $description = null, $name = null, $tags = null, $favourite = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createNewEmailAddress'][0])
    {
        list($response) = $this->createNewEmailAddressWithHttpInfo($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite, $virtual_inbox, $use_short_address, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createNewEmailAddressRequest($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite, $virtual_inbox, $use_short_address, $contentType);
    ...
    {
        return $this->createNewEmailAddressAsyncWithHttpInfo($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite, $virtual_inbox, $use_short_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \MailSlurp\Models\InboxDto
     */
    public function createRandomInbox($allow_team_access = null, $use_domain_pool = null, $expires_at = null, $expires_in = null, $email_address = null, $inbox_type = null, $description = null, $name = null, $tags = null, $favourite = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createRandomInbox'][0])
    {
        list($response) = $this->createRandomInboxWithHttpInfo($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite, $virtual_inbox, $use_short_address, $contentType);
        return $response;
    }
    ...
    {
        $request = $this->createRandomInboxRequest($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite, $virtual_inbox, $use_short_address, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createRandomInboxAsync($allow_team_access = null, $use_domain_pool = null, $expires_at = null, $expires_in = null, $email_address = null, $inbox_type = null, $description = null, $name = null, $tags = null, $favourite = null, $virtual_inbox = null, $use_short_address = null, string $contentType = self::contentTypes['createRandomInbox'][0])
    {
        return $this->createRandomInboxAsyncWithHttpInfo($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite, $virtual_inbox, $use_short_address, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }

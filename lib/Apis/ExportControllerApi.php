...
class ExportControllerApi
{
     ...
     * @param  bool $exclude_previously_exported excludePreviouslyExported (optional)
     ...
     * @return string
     */
    public function exportEntities($api_key, $export_type, $output_format, $created_earliest_time = null, $created_oldest_time = null, $exclude_previously_exported = null, $filter = null, $list_separator_token = null)
    {
        list($response) = $this->exportEntitiesWithHttpInfo($api_key, $export_type, $output_format, $created_earliest_time, $created_oldest_time, $exclude_previously_exported, $filter, $list_separator_token);
        return $response;
    }
     ...
     */
    public function exportEntitiesWithHttpInfo($api_key, $export_type, $output_format, $created_earliest_time = null, $created_oldest_time = null, $exclude_previously_exported = null, $filter = null, $list_separator_token = null)
    {
        $request = $this->exportEntitiesRequest($api_key, $export_type, $output_format, $created_earliest_time, $created_oldest_time, $exclude_previously_exported, $filter, $list_separator_token);
     ...
     */
    public function exportEntitiesAsync($api_key, $export_type, $output_format, $created_earliest_time = null, $created_oldest_time = null, $exclude_previously_exported = null, $filter = null, $list_separator_token = null)
    {
        return $this->exportEntitiesAsyncWithHttpInfo($api_key, $export_type, $output_format, $created_earliest_time, $created_oldest_time, $exclude_previously_exported, $filter, $list_separator_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function exportEntitiesAsyncWithHttpInfo($api_key, $export_type, $output_format, $created_earliest_time = null, $created_oldest_time = null, $exclude_previously_exported = null, $filter = null, $list_separator_token = null)
    {
        $returnType = 'string';
        $request = $this->exportEntitiesRequest($api_key, $export_type, $output_format, $created_earliest_time, $created_oldest_time, $exclude_previously_exported, $filter, $list_separator_token);
     ...
     */
    protected function exportEntitiesRequest($api_key, $export_type, $output_format, $created_earliest_time = null, $created_oldest_time = null, $exclude_previously_exported = null, $filter = null, $list_separator_token = null)
    {
        ...
        // query params
        if (is_array($created_earliest_time)) {
            $created_earliest_time = ObjectSerializer::serializeCollection($created_earliest_time, '', true);
        }
        if ($created_earliest_time !== null) {
            $queryParams['createdEarliestTime'] = $created_earliest_time;
        }
        // query params
        if (is_array($created_oldest_time)) {
            $created_oldest_time = ObjectSerializer::serializeCollection($created_oldest_time, '', true);
        }
        if ($created_oldest_time !== null) {
            $queryParams['createdOldestTime'] = $created_oldest_time;
        }
        // query params
        if (is_array($exclude_previously_exported)) {
            $exclude_previously_exported = ObjectSerializer::serializeCollection($exclude_previously_exported, '', true);
        }
        ...
        // query params
        if (is_array($list_separator_token)) {
            $list_separator_token = ObjectSerializer::serializeCollection($list_separator_token, '', true);
        }
        ...
        if (is_array($output_format)) {
            $output_format = ObjectSerializer::serializeCollection($output_format, '', true);
        }
     ...
     *
     * @param  string $export_type exportType (required)
     * @param  \MailSlurp\Models\ExportOptions $export_options exportOptions (required)

...
/**
     ...
     * @param  \DateTime $since Filter by created at after the given timestamp (optional)
     * @param  \DateTime $before Filter by created at before the given timestamp (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getReputationItems'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageReputationItems
     */
    public function getReputationItems($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, string $contentType = self::contentTypes['getReputationItems'][0])
    {
        list($response) = $this->getReputationItemsWithHttpInfo($page, $size, $sort, $since, $before, $contentType);
        return $response;
    }

    /**
     * Operation getReputationItemsWithHttpInfo
     *
     * Get paginated list of reputation items.
     *
     * @param  int $page Optional page index (optional, default to 0)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\PageReputationItems, HTTP status code, HTTP response headers (array of strings)
     */
    public function getReputationItemsWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, string $contentType = self::contentTypes['getReputationItems'][0])
    {
        $request = $this->getReputationItemsRequest($page, $size, $sort, $since, $before, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\PageReputationItems' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\PageReputationItems' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\PageReputationItems', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\PageReputationItems';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\PageReputationItems',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getReputationItemsAsync
     *
     * Get paginated list of reputation items.
     *
     * @param  int $page Optional page index (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReputationItemsAsync($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, string $contentType = self::contentTypes['getReputationItems'][0])
    {
        return $this->getReputationItemsAsyncWithHttpInfo($page, $size, $sort, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getReputationItemsAsyncWithHttpInfo
     *
     * Get paginated list of reputation items.
     *
     * @param  int $page Optional page index (optional, default to 0)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getReputationItemsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, string $contentType = self::contentTypes['getReputationItems'][0])
    {
        $returnType = '\MailSlurp\Models\PageReputationItems';
        $request = $this->getReputationItemsRequest($page, $size, $sort, $since, $before, $contentType);
    ...
    /**
     * Create request for operation 'getReputationItems'
     *
     * @param  int $page Optional page index (optional, default to 0)
     * @param  int $size Optional page size (optional, default to 20)
     * @param  string $sort Optional createdAt sort direction ASC or DESC (optional, default to 'DESC')
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getReputationItemsRequest($page = 0, $size = 20, $sort = 'DESC', $since = null, $before = null, string $contentType = self::contentTypes['getReputationItems'][0])
    {


        if ($size !== null && $size > 100) {
            throw new \InvalidArgumentException('invalid value for "$size" when calling BounceControllerApi.getReputationItems, must be smaller than or equal to 100.');
        }
        ...
        $resourcePath = '/bounce/reputation-items';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getTenantReputationFindings
     *
     * Get SES tenant reputation findings
     *
     * @param  string $account_region Optional account region filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTenantReputationFindings'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\TenantReputationFindingsDto
     */
    public function getTenantReputationFindings($account_region = null, string $contentType = self::contentTypes['getTenantReputationFindings'][0])
    {
        list($response) = $this->getTenantReputationFindingsWithHttpInfo($account_region, $contentType);
        return $response;
    }

    /**
     * Operation getTenantReputationFindingsWithHttpInfo
     *
     * Get SES tenant reputation findings
     *
     * @param  string $account_region Optional account region filter (optional)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\TenantReputationFindingsDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTenantReputationFindingsWithHttpInfo($account_region = null, string $contentType = self::contentTypes['getTenantReputationFindings'][0])
    {
        $request = $this->getTenantReputationFindingsRequest($account_region, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\TenantReputationFindingsDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\TenantReputationFindingsDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\TenantReputationFindingsDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\TenantReputationFindingsDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\TenantReputationFindingsDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getTenantReputationFindingsAsync
     *
     * Get SES tenant reputation findings
     *
     * @param  string $account_region Optional account region filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTenantReputationFindingsAsync($account_region = null, string $contentType = self::contentTypes['getTenantReputationFindings'][0])
    {
        return $this->getTenantReputationFindingsAsyncWithHttpInfo($account_region, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTenantReputationFindingsAsyncWithHttpInfo
     *
     * Get SES tenant reputation findings
     *
     * @param  string $account_region Optional account region filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTenantReputationFindingsAsyncWithHttpInfo($account_region = null, string $contentType = self::contentTypes['getTenantReputationFindings'][0])
    {
        $returnType = '\MailSlurp\Models\TenantReputationFindingsDto';
        $request = $this->getTenantReputationFindingsRequest($account_region, $contentType);
    ...
    /**
     * Create request for operation 'getTenantReputationFindings'
     *
     * @param  string $account_region Optional account region filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTenantReputationFindings'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTenantReputationFindingsRequest($account_region = null, string $contentType = self::contentTypes['getTenantReputationFindings'][0])
    {



        $resourcePath = '/bounce/tenant-findings';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    /**
     * Operation getTenantReputationStatusSummary
     *
     * Get SES tenant status summary
     *
     * @param  string $account_region Optional account region filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTenantReputationStatusSummary'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\TenantReputationStatusSummaryDto
     */
    public function getTenantReputationStatusSummary($account_region = null, string $contentType = self::contentTypes['getTenantReputationStatusSummary'][0])
    {
        list($response) = $this->getTenantReputationStatusSummaryWithHttpInfo($account_region, $contentType);
        return $response;
    }

    /**
     * Operation getTenantReputationStatusSummaryWithHttpInfo
     *
     * Get SES tenant status summary
     *
     * @param  string $account_region Optional account region filter (optional)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\TenantReputationStatusSummaryDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTenantReputationStatusSummaryWithHttpInfo($account_region = null, string $contentType = self::contentTypes['getTenantReputationStatusSummary'][0])
    {
        $request = $this->getTenantReputationStatusSummaryRequest($account_region, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\TenantReputationStatusSummaryDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\TenantReputationStatusSummaryDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\TenantReputationStatusSummaryDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\TenantReputationStatusSummaryDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\TenantReputationStatusSummaryDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getTenantReputationStatusSummaryAsync
     *
     * Get SES tenant status summary
     *
     * @param  string $account_region Optional account region filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTenantReputationStatusSummaryAsync($account_region = null, string $contentType = self::contentTypes['getTenantReputationStatusSummary'][0])
    {
        return $this->getTenantReputationStatusSummaryAsyncWithHttpInfo($account_region, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getTenantReputationStatusSummaryAsyncWithHttpInfo
     *
     * Get SES tenant status summary
     *
     * @param  string $account_region Optional account region filter (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getTenantReputationStatusSummaryAsyncWithHttpInfo($account_region = null, string $contentType = self::contentTypes['getTenantReputationStatusSummary'][0])
    {
        $returnType = '\MailSlurp\Models\TenantReputationStatusSummaryDto';
        $request = $this->getTenantReputationStatusSummaryRequest($account_region, $contentType);
    ...
    /**
     * Create request for operation 'getTenantReputationStatusSummary'
     *
     * @param  string $account_region Optional account region filter (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getTenantReputationStatusSummary'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTenantReputationStatusSummaryRequest($account_region = null, string $contentType = self::contentTypes['getTenantReputationStatusSummary'][0])
    {



        $resourcePath = '/bounce/tenant-status';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';

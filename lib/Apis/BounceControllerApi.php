...
class BounceControllerApi
{
     ...
     */
    public function getBouncedEmails($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getBouncedEmailsWithHttpInfo($before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getBouncedEmailsWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getBouncedEmailsRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBouncedEmailsAsync($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getBouncedEmailsAsyncWithHttpInfo($before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBouncedEmailsAsyncWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageBouncedEmail';
        $request = $this->getBouncedEmailsRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBouncedEmailsRequest($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
     ...
     */
    public function getBouncedRecipients($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getBouncedRecipientsWithHttpInfo($before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getBouncedRecipientsWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getBouncedRecipientsRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBouncedRecipientsAsync($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getBouncedRecipientsAsyncWithHttpInfo($before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getBouncedRecipientsAsyncWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageBouncedRecipients';
        $request = $this->getBouncedRecipientsRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getBouncedRecipientsRequest($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {

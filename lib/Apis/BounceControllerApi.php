...
class BounceControllerApi
{
     ...
     */
    public function getComplaints($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        list($response) = $this->getComplaintsWithHttpInfo($page, $size, $sort, $since, $before);
        return $response;
    }
     ...
     */
    public function getComplaintsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $request = $this->getComplaintsRequest($page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getComplaintsAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        return $this->getComplaintsAsyncWithHttpInfo($page, $size, $sort, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getComplaintsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\PageComplaint';
        $request = $this->getComplaintsRequest($page, $size, $sort, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getComplaintsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        if ($size !== null && $size > 100) {

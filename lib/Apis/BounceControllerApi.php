...
class BounceControllerApi
{
     ...
     */
    public function filterBouncedRecipientRequest($filter_bounced_recipients_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBouncedEmailRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBouncedEmailsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBouncedRecipientRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getBouncedRecipientsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        if ($size !== null && $size > 100) {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getComplaintsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        if ($size !== null && $size > 100) {

...
class InboxForwarderControllerApi
{
     ...
     *
     * @param  \MailSlurp\Models\CreateInboxForwarderOptions $create_inbox_forwarder_options createInboxForwarderOptions (required)
     ...
     */
    public function createNewInboxForwarder($create_inbox_forwarder_options, $inbox_id = null)
    {
        list($response) = $this->createNewInboxForwarderWithHttpInfo($create_inbox_forwarder_options, $inbox_id);
        return $response;
    }
     ...
     */
    public function createNewInboxForwarderWithHttpInfo($create_inbox_forwarder_options, $inbox_id = null)
    {
        $request = $this->createNewInboxForwarderRequest($create_inbox_forwarder_options, $inbox_id);
     ...
     */
    public function createNewInboxForwarderAsync($create_inbox_forwarder_options, $inbox_id = null)
    {
        return $this->createNewInboxForwarderAsyncWithHttpInfo($create_inbox_forwarder_options, $inbox_id)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewInboxForwarderAsyncWithHttpInfo($create_inbox_forwarder_options, $inbox_id = null)
    {
        $returnType = '\MailSlurp\Models\InboxForwarderDto';
        $request = $this->createNewInboxForwarderRequest($create_inbox_forwarder_options, $inbox_id);
     ...
     */
    protected function createNewInboxForwarderRequest($create_inbox_forwarder_options, $inbox_id = null)
    {
     ...
     */
    public function getInboxForwarders($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getInboxForwardersWithHttpInfo($before, $inbox_id, $page, $search_filter, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getInboxForwardersWithHttpInfo($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getInboxForwardersRequest($before, $inbox_id, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxForwardersAsync($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getInboxForwardersAsyncWithHttpInfo($before, $inbox_id, $page, $search_filter, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxForwardersAsyncWithHttpInfo($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageInboxForwarderDto';
        $request = $this->getInboxForwardersRequest($before, $inbox_id, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxForwardersRequest($before = null, $inbox_id = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
     ...
     *
     * @param  string $id ID of inbox forwarder (required)
     * @param  \MailSlurp\Models\InboxForwarderTestOptions $inbox_forwarder_test_options inboxForwarderTestOptions (required)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  \MailSlurp\Models\TestNewInboxForwarderOptions $test_new_inbox_forwarder_options testNewInboxForwarderOptions (required)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\InboxForwarderTestResult

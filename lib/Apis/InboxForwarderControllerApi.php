...
/**
     ...
     */
    public function createNewInboxForwarder($create_inbox_forwarder_options, $inbox_id = null, string $contentType = self::contentTypes['createNewInboxForwarder'][0])
    {
        list($response) = $this->createNewInboxForwarderWithHttpInfo($create_inbox_forwarder_options, $inbox_id, $contentType);
        return $response;
    }
     ...
     */
    public function createNewInboxForwarderWithHttpInfo($create_inbox_forwarder_options, $inbox_id = null, string $contentType = self::contentTypes['createNewInboxForwarder'][0])
    {
        $request = $this->createNewInboxForwarderRequest($create_inbox_forwarder_options, $inbox_id, $contentType);
     ...
     */
    public function createNewInboxForwarderAsync($create_inbox_forwarder_options, $inbox_id = null, string $contentType = self::contentTypes['createNewInboxForwarder'][0])
    {
        return $this->createNewInboxForwarderAsyncWithHttpInfo($create_inbox_forwarder_options, $inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewInboxForwarderAsyncWithHttpInfo($create_inbox_forwarder_options, $inbox_id = null, string $contentType = self::contentTypes['createNewInboxForwarder'][0])
    {
        $returnType = '\MailSlurp\Models\InboxForwarderDto';
        $request = $this->createNewInboxForwarderRequest($create_inbox_forwarder_options, $inbox_id, $contentType);
     ...
     */
    public function createNewInboxForwarderRequest($create_inbox_forwarder_options, $inbox_id = null, string $contentType = self::contentTypes['createNewInboxForwarder'][0])
    {
     ...
     */
    public function getAllInboxForwarderEvents($page = 0, $size = 20, $inbox_id = null, $email_id = null, $sent_id = null, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxForwarderEvents'][0])
    {
        list($response) = $this->getAllInboxForwarderEventsWithHttpInfo($page, $size, $inbox_id, $email_id, $sent_id, $sort, $contentType);
        return $response;
    }
     ...
     */
    public function getAllInboxForwarderEventsWithHttpInfo($page = 0, $size = 20, $inbox_id = null, $email_id = null, $sent_id = null, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxForwarderEvents'][0])
    {
        $request = $this->getAllInboxForwarderEventsRequest($page, $size, $inbox_id, $email_id, $sent_id, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxForwarderEventsAsync($page = 0, $size = 20, $inbox_id = null, $email_id = null, $sent_id = null, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxForwarderEvents'][0])
    {
        return $this->getAllInboxForwarderEventsAsyncWithHttpInfo($page, $size, $inbox_id, $email_id, $sent_id, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxForwarderEventsAsyncWithHttpInfo($page = 0, $size = 20, $inbox_id = null, $email_id = null, $sent_id = null, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxForwarderEvents'][0])
    {
        $returnType = '\MailSlurp\Models\PageInboxForwarderEvents';
        $request = $this->getAllInboxForwarderEventsRequest($page, $size, $inbox_id, $email_id, $sent_id, $sort, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllInboxForwarderEventsRequest($page = 0, $size = 20, $inbox_id = null, $email_id = null, $sent_id = null, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxForwarderEvents'][0])
    {

...
class InboxForwarderControllerApi
{
     ...
     */
    public function getInboxForwarders($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getInboxForwardersWithHttpInfo($inbox_id, $page, $search_filter, $size, $sort);
        return $response;
    }
     ...
     */
    public function getInboxForwardersWithHttpInfo($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getInboxForwardersRequest($inbox_id, $page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxForwardersAsync($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        return $this->getInboxForwardersAsyncWithHttpInfo($inbox_id, $page, $search_filter, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxForwardersAsyncWithHttpInfo($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageInboxForwarderDto';
        $request = $this->getInboxForwardersRequest($inbox_id, $page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxForwardersRequest($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {

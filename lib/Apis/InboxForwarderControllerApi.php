...
class InboxForwarderControllerApi
{
     ...
     */
    public function createNewInboxForwarderRequest($inbox_id, $create_inbox_forwarder_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteInboxForwarderRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteInboxForwardersRequest($inbox_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxForwarderRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxForwardersRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testInboxForwarderRequest($id, $inbox_forwarder_test_options)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testInboxForwardersForInboxRequest($inbox_id, $inbox_forwarder_test_options)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testNewInboxForwarderRequest($test_new_inbox_forwarder_options)
    {

...
class GroupControllerApi
{
     ...
     */
    public function getGroupWithContactsPaginated($group_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getGroupWithContactsPaginatedWithHttpInfo($group_id, $page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getGroupWithContactsPaginatedWithHttpInfo($group_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getGroupWithContactsPaginatedRequest($group_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupWithContactsPaginatedAsync($group_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getGroupWithContactsPaginatedAsyncWithHttpInfo($group_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupWithContactsPaginatedAsyncWithHttpInfo($group_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageContactProjection';
        $request = $this->getGroupWithContactsPaginatedRequest($group_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGroupWithContactsPaginatedRequest($group_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(

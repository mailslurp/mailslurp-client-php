...
class GroupControllerApi
{
     ...
     */
    public function addContactsToGroupRequest($group_id, $update_group_contacts)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function createGroupRequest($create_group_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllGroupsRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getGroupRequest($group_id)
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getGroupWithContactsRequest($group_id)
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getGroupWithContactsPaginatedRequest($group_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function removeContactsFromGroupRequest($group_id, $update_group_contacts)
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(

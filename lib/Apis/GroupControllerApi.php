...
class GroupControllerApi
{
     ...
     */
    public function getAllGroups($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllGroupsWithHttpInfo($before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllGroupsWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllGroupsRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllGroupsAsync($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAllGroupsAsyncWithHttpInfo($before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllGroupsAsyncWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageGroupProjection';
        $request = $this->getAllGroupsRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllGroupsRequest($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
     ...
     */
    public function getGroupWithContactsPaginated($group_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getGroupWithContactsPaginatedWithHttpInfo($group_id, $before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getGroupWithContactsPaginatedWithHttpInfo($group_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getGroupWithContactsPaginatedRequest($group_id, $before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupWithContactsPaginatedAsync($group_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getGroupWithContactsPaginatedAsyncWithHttpInfo($group_id, $before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getGroupWithContactsPaginatedAsyncWithHttpInfo($group_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageContactProjection';
        $request = $this->getGroupWithContactsPaginatedRequest($group_id, $before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getGroupWithContactsPaginatedRequest($group_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'group_id' is set
        if ($group_id === null || (is_array($group_id) && count($group_id) === 0)) {
            throw new \InvalidArgumentException(

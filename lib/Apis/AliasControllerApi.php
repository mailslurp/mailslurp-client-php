...
class AliasControllerApi
{
     ...
     */
    public function getAliasEmails($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAliasEmailsWithHttpInfo($alias_id, $before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAliasEmailsWithHttpInfo($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAliasEmailsRequest($alias_id, $before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasEmailsAsync($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAliasEmailsAsyncWithHttpInfo($alias_id, $before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasEmailsAsyncWithHttpInfo($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getAliasEmailsRequest($alias_id, $before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAliasEmailsRequest($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getAliasThreads($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAliasThreadsWithHttpInfo($alias_id, $before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAliasThreadsWithHttpInfo($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAliasThreadsRequest($alias_id, $before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasThreadsAsync($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAliasThreadsAsyncWithHttpInfo($alias_id, $before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasThreadsAsyncWithHttpInfo($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageThreadProjection';
        $request = $this->getAliasThreadsRequest($alias_id, $before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAliasThreadsRequest($alias_id, $before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function getAliases($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAliasesWithHttpInfo($before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAliasesWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAliasesRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasesAsync($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAliasesAsyncWithHttpInfo($before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasesAsyncWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageAlias';
        $request = $this->getAliasesRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAliasesRequest($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
     ...
     * @param  \MailSlurp\Models\ReplyToAliasEmailOptions $reply_to_alias_email_options replyToAliasEmailOptions (required)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $alias_id aliasId (required)
     * @param  \MailSlurp\Models\SendEmailOptions $send_email_options Options for the email to be sent (optional)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\SentEmailDto
     */
    public function sendAliasEmail($alias_id, $send_email_options = null)
    {
     ...
     * @return array of \MailSlurp\Models\SentEmailDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function sendAliasEmailWithHttpInfo($alias_id, $send_email_options = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAliasEmailAsync($alias_id, $send_email_options = null)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function sendAliasEmailAsyncWithHttpInfo($alias_id, $send_email_options = null)
    {
        $returnType = '\MailSlurp\Models\SentEmailDto';
        $request = $this->sendAliasEmailRequest($alias_id, $send_email_options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function sendAliasEmailRequest($alias_id, $send_email_options = null)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(

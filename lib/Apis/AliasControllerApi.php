...
class AliasControllerApi
{
    ...
    /**
     * Operation getAliasVerification
     *
     * Get validation result from alias verification
     *
     * @param  string $alias_id aliasId (required)
     * @param  string $email_address emailAddress (required)
     * @param  string $verification_token verificationToken (required)
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\AliasVerificationResult
     */
    public function getAliasVerification($alias_id, $email_address, $verification_token)
    {
        list($response) = $this->getAliasVerificationWithHttpInfo($alias_id, $email_address, $verification_token);
        return $response;
    }

    /**
     * Operation getAliasVerificationWithHttpInfo
     *
     * Get validation result from alias verification
     *
     * @param  string $alias_id aliasId (required)
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\AliasVerificationResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAliasVerificationWithHttpInfo($alias_id, $email_address, $verification_token)
    {
        $request = $this->getAliasVerificationRequest($alias_id, $email_address, $verification_token);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\AliasVerificationResult' === '\SplFileObject') {
                        $content = $responseBody; //stream goes to serializer
                    } else {
                        $content = (string) $responseBody;
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\AliasVerificationResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\AliasVerificationResult';
            $responseBody = $response->getBody();
            if ($returnType === '\SplFileObject') {
                $content = $responseBody; //stream goes to serializer
            } else {
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\AliasVerificationResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation getAliasVerificationAsync
     *
     * Get validation result from alias verification
     *
     * @param  string $alias_id aliasId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasVerificationAsync($alias_id, $email_address, $verification_token)
    {
        return $this->getAliasVerificationAsyncWithHttpInfo($alias_id, $email_address, $verification_token)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAliasVerificationAsyncWithHttpInfo
     *
     * Get validation result from alias verification
     *
     * @param  string $alias_id aliasId (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasVerificationAsyncWithHttpInfo($alias_id, $email_address, $verification_token)
    {
        $returnType = '\MailSlurp\Models\AliasVerificationResult';
        $request = $this->getAliasVerificationRequest($alias_id, $email_address, $verification_token);
    ...
    /**
     * Create request for operation 'getAliasVerification'
     *
     * @param  string $alias_id aliasId (required)
     * @param  string $email_address emailAddress (required)
     * @param  string $verification_token verificationToken (required)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAliasVerificationRequest($alias_id, $email_address, $verification_token)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $alias_id when calling getAliasVerification'
            );
        }
        // verify the required parameter 'email_address' is set
        if ($email_address === null || (is_array($email_address) && count($email_address) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_address when calling getAliasVerification'
            );
        }
        ...
        if ($verification_token === null || (is_array($verification_token) && count($verification_token) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $verification_token when calling getAliasVerification'
            );
        }

        $resourcePath = '/aliases/{aliasId}/verification';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // query params
        if (is_array($verification_token)) {
            $verification_token = ObjectSerializer::serializeCollection($verification_token, '', true);
        }
        if ($verification_token !== null) {
            $queryParams['verificationToken'] = $verification_token;
        }

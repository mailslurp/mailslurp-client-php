...
class AliasControllerApi
{
     ...
     */
    public function getAliasEmails($alias_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAliasEmailsWithHttpInfo($alias_id, $page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAliasEmailsWithHttpInfo($alias_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAliasEmailsRequest($alias_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasEmailsAsync($alias_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getAliasEmailsAsyncWithHttpInfo($alias_id, $page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasEmailsAsyncWithHttpInfo($alias_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageEmailProjection';
        $request = $this->getAliasEmailsRequest($alias_id, $page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAliasEmailsRequest($alias_id, $page = 0, $size = 20, $sort = 'ASC')
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     */
    public function replyToEmail($alias_id, $email_id, $reply_to_alias_email_options)
    {
        list($response) = $this->replyToEmailWithHttpInfo($alias_id, $email_id, $reply_to_alias_email_options);
        return $response;
    }
     ...
     */
    public function replyToEmailWithHttpInfo($alias_id, $email_id, $reply_to_alias_email_options)
    {
        $request = $this->replyToEmailRequest($alias_id, $email_id, $reply_to_alias_email_options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replyToEmailAsync($alias_id, $email_id, $reply_to_alias_email_options)
    {
        return $this->replyToEmailAsyncWithHttpInfo($alias_id, $email_id, $reply_to_alias_email_options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function replyToEmailAsyncWithHttpInfo($alias_id, $email_id, $reply_to_alias_email_options)
    {
        $returnType = '\MailSlurp\Models\SentEmailDto';
        $request = $this->replyToEmailRequest($alias_id, $email_id, $reply_to_alias_email_options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function replyToEmailRequest($alias_id, $email_id, $reply_to_alias_email_options)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $alias_id when calling replyToEmail'
            );
        }
        ...
        if ($reply_to_alias_email_options === null || (is_array($reply_to_alias_email_options) && count($reply_to_alias_email_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $reply_to_alias_email_options when calling replyToEmail'
            );
        }

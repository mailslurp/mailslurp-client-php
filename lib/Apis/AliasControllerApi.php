...
class AliasControllerApi
{
     ...
     */
    public function createAliasRequest($create_alias_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteAliasRequest($alias_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAliasRequest($alias_id)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAliasEmailsRequest($alias_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAliasThreadsRequest($alias_id, $page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAliasesRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function replyToAliasEmailRequest($alias_id, $email_id, $reply_to_alias_email_options)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function sendAliasEmailRequest($alias_id, $send_email_options)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function updateAliasRequest($alias_id, $update_alias_options)
    {
        // verify the required parameter 'alias_id' is set
        if ($alias_id === null || (is_array($alias_id) && count($alias_id) === 0)) {
            throw new \InvalidArgumentException(

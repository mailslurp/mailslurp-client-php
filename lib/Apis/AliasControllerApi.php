...
/**
     ...
     */
    public function getAliases($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAliases'][0])
    {
        list($response) = $this->getAliasesWithHttpInfo($page, $size, $sort, $since, $before, $contentType);
        return $response;
    }
     ...
     */
    public function getAliasesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAliases'][0])
    {
        $request = $this->getAliasesRequest($page, $size, $sort, $since, $before, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasesAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAliases'][0])
    {
        return $this->getAliasesAsyncWithHttpInfo($page, $size, $sort, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAliasesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAliases'][0])
    {
        $returnType = '\MailSlurp\Models\PageAlias';
        $request = $this->getAliasesRequest($page, $size, $sort, $since, $before, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAliasesRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, string $contentType = self::contentTypes['getAliases'][0])
    {

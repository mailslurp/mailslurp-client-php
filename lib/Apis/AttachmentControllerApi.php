...
class AttachmentControllerApi
{
     ...
     */
    public function getAttachments($page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAttachmentsWithHttpInfo($page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAttachmentsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAttachmentsRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsync($page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getAttachmentsAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageAttachmentEntity';
        $request = $this->getAttachmentsRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAttachmentsRequest($page = 0, $size = 20, $sort = 'ASC')
    {

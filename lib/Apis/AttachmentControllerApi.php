...
/**
     ...
     */
    public function getAttachments($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        list($response) = $this->getAttachmentsWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before, $contentType);
        return $response;
    }
     ...
     */
    public function getAttachmentsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        $request = $this->getAttachmentsRequest($page, $size, $sort, $file_name_filter, $since, $before, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsync($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        return $this->getAttachmentsAsyncWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        $returnType = '\MailSlurp\Models\PageAttachmentEntity';
        $request = $this->getAttachmentsRequest($page, $size, $sort, $file_name_filter, $since, $before, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAttachmentsRequest($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
     ...
     *
     * @param  \MailSlurp\Models\UploadAttachmentBytesRequest $upload_attachment_bytes_request upload_attachment_bytes_request (required)
     ...
     * @return string[]
     */
    public function uploadAttachmentBytes($upload_attachment_bytes_request, $content_type = null, $filename = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        list($response) = $this->uploadAttachmentBytesWithHttpInfo($upload_attachment_bytes_request, $content_type, $filename, $contentType);
        return $response;
    }
     ...
     * Upload an attachment for sending using file byte stream input octet stream. Returns an array whose first element is the ID of the uploaded attachment.
     *
     * @param  \MailSlurp\Models\UploadAttachmentBytesRequest $upload_attachment_bytes_request (required)
     * @param  string $content_type Optional contentType for file. For instance &#x60;application/pdf&#x60; (optional)
     * @param  string $filename Optional filename to save upload with (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadAttachmentBytes'] to see the possible values for this operation
     *
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadAttachmentBytesWithHttpInfo($upload_attachment_bytes_request, $content_type = null, $filename = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        $request = $this->uploadAttachmentBytesRequest($upload_attachment_bytes_request, $content_type, $filename, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsync($upload_attachment_bytes_request, $content_type = null, $filename = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        return $this->uploadAttachmentBytesAsyncWithHttpInfo($upload_attachment_bytes_request, $content_type, $filename, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsyncWithHttpInfo($upload_attachment_bytes_request, $content_type = null, $filename = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        $returnType = 'string[]';
        $request = $this->uploadAttachmentBytesRequest($upload_attachment_bytes_request, $content_type, $filename, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadAttachmentBytesRequest($upload_attachment_bytes_request, $content_type = null, $filename = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {

        // verify the required parameter 'upload_attachment_bytes_request' is set
        if ($upload_attachment_bytes_request === null || (is_array($upload_attachment_bytes_request) && count($upload_attachment_bytes_request) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $upload_attachment_bytes_request when calling uploadAttachmentBytes'
            );
        }
        ...
        // for model (json/xml)
        if (isset($upload_attachment_bytes_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($upload_attachment_bytes_request));
            } else {
                $httpBody = $upload_attachment_bytes_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];
     ...
     * @return string[]
     */
    public function uploadMultipartForm($content_type = null, $filename = null, $x_filename = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        list($response) = $this->uploadMultipartFormWithHttpInfo($content_type, $filename, $x_filename, $upload_multipart_form_request, $contentType);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadMultipartFormWithHttpInfo($content_type = null, $filename = null, $x_filename = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipartFormAsync($content_type = null, $filename = null, $x_filename = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        return $this->uploadMultipartFormAsyncWithHttpInfo($content_type, $filename, $x_filename, $upload_multipart_form_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipartFormAsyncWithHttpInfo($content_type = null, $filename = null, $x_filename = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        $returnType = 'string[]';
        $request = $this->uploadMultipartFormRequest($content_type, $filename, $x_filename, $upload_multipart_form_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadMultipartFormRequest($content_type = null, $filename = null, $x_filename = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {

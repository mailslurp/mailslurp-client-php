...
class AttachmentControllerApi
{
     ...
     * @return string[]
     */
    public function uploadAttachmentBytes($filename = null)
    {
        list($response) = $this->uploadAttachmentBytesWithHttpInfo($filename);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadAttachmentBytesWithHttpInfo($filename = null)
    {
        $request = $this->uploadAttachmentBytesRequest($filename);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsync($filename = null)
    {
        return $this->uploadAttachmentBytesAsyncWithHttpInfo($filename)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsyncWithHttpInfo($filename = null)
    {
        $returnType = 'string[]';
        $request = $this->uploadAttachmentBytesRequest($filename);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadAttachmentBytesRequest($filename = null)
    {

...
/**
    ...
    /**
     * Operation extractAttachmentText
     *
     * Extract text from an attachment
     *
     * @param  string $attachment_id ID of attachment (required)
     * @param  \MailSlurp\Models\ExtractAttachmentTextOptions $extract_attachment_text_options extract_attachment_text_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['extractAttachmentText'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\ExtractAttachmentTextResult
     */
    public function extractAttachmentText($attachment_id, $extract_attachment_text_options = null, string $contentType = self::contentTypes['extractAttachmentText'][0])
    {
        list($response) = $this->extractAttachmentTextWithHttpInfo($attachment_id, $extract_attachment_text_options, $contentType);
        return $response;
    }

    /**
     * Operation extractAttachmentTextWithHttpInfo
     *
     * Extract text from an attachment
     *
     * @param  string $attachment_id ID of attachment (required)
     * @param  \MailSlurp\Models\ExtractAttachmentTextOptions $extract_attachment_text_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['extractAttachmentText'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\ExtractAttachmentTextResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function extractAttachmentTextWithHttpInfo($attachment_id, $extract_attachment_text_options = null, string $contentType = self::contentTypes['extractAttachmentText'][0])
    {
        $request = $this->extractAttachmentTextRequest($attachment_id, $extract_attachment_text_options, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\ExtractAttachmentTextResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\ExtractAttachmentTextResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\ExtractAttachmentTextResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\ExtractAttachmentTextResult';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\ExtractAttachmentTextResult',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
    ...
    /**
     * Operation extractAttachmentTextAsync
     *
     * Extract text from an attachment
     *
     * @param  string $attachment_id ID of attachment (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extractAttachmentTextAsync($attachment_id, $extract_attachment_text_options = null, string $contentType = self::contentTypes['extractAttachmentText'][0])
    {
        return $this->extractAttachmentTextAsyncWithHttpInfo($attachment_id, $extract_attachment_text_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation extractAttachmentTextAsyncWithHttpInfo
     *
     * Extract text from an attachment
     *
     * @param  string $attachment_id ID of attachment (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function extractAttachmentTextAsyncWithHttpInfo($attachment_id, $extract_attachment_text_options = null, string $contentType = self::contentTypes['extractAttachmentText'][0])
    {
        $returnType = '\MailSlurp\Models\ExtractAttachmentTextResult';
        $request = $this->extractAttachmentTextRequest($attachment_id, $extract_attachment_text_options, $contentType);
    ...
    /**
     * Create request for operation 'extractAttachmentText'
     *
     * @param  string $attachment_id ID of attachment (required)
     * @param  \MailSlurp\Models\ExtractAttachmentTextOptions $extract_attachment_text_options (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['extractAttachmentText'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function extractAttachmentTextRequest($attachment_id, $extract_attachment_text_options = null, string $contentType = self::contentTypes['extractAttachmentText'][0])
    {

        // verify the required parameter 'attachment_id' is set
        if ($attachment_id === null || (is_array($attachment_id) && count($attachment_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $attachment_id when calling extractAttachmentText'
            );
        }



        $resourcePath = '/attachments/{attachmentId}/text';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($extract_attachment_text_options)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($extract_attachment_text_options));
            } else {
                $httpBody = $extract_attachment_text_options;
            }
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\AttachmentEntityDto
     */
     ...
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\AttachmentEntityDto, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAttachmentWithHttpInfo($attachment_id, string $contentType = self::contentTypes['getAttachment'][0])
    {
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\AttachmentEntityDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\AttachmentEntityDto' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\AttachmentEntityDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\AttachmentEntityDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\AttachmentEntityDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     */
    public function getAttachments($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, $include = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        list($response) = $this->getAttachmentsWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $include, $contentType);
        return $response;
    }
     ...
     */
    public function getAttachmentsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, $include = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        $request = $this->getAttachmentsRequest($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $include, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsync($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, $include = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        return $this->getAttachmentsAsyncWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $include, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, $include = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        $returnType = '\MailSlurp\Models\PageAttachmentEntity';
        $request = $this->getAttachmentsRequest($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $include, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAttachmentsRequest($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, $include = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
     ...
     * @return string[]
     */
    public function uploadAttachmentBytes($content_type = null, $content_type2 = null, $content_id = null, $filename = null, $file_size = null, $filename2 = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        list($response) = $this->uploadAttachmentBytesWithHttpInfo($content_type, $content_type2, $content_id, $filename, $file_size, $filename2, $contentType);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadAttachmentBytesWithHttpInfo($content_type = null, $content_type2 = null, $content_id = null, $filename = null, $file_size = null, $filename2 = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        $request = $this->uploadAttachmentBytesRequest($content_type, $content_type2, $content_id, $filename, $file_size, $filename2, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsync($content_type = null, $content_type2 = null, $content_id = null, $filename = null, $file_size = null, $filename2 = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        return $this->uploadAttachmentBytesAsyncWithHttpInfo($content_type, $content_type2, $content_id, $filename, $file_size, $filename2, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsyncWithHttpInfo($content_type = null, $content_type2 = null, $content_id = null, $filename = null, $file_size = null, $filename2 = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
        $returnType = 'string[]';
        $request = $this->uploadAttachmentBytesRequest($content_type, $content_type2, $content_id, $filename, $file_size, $filename2, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadAttachmentBytesRequest($content_type = null, $content_type2 = null, $content_id = null, $filename = null, $file_size = null, $filename2 = null, string $contentType = self::contentTypes['uploadAttachmentBytes'][0])
    {
     ...
     * @param  \MailSlurp\Models\ImportEmailIntoInboxMultipartRequest $import_email_into_inbox_multipart_request import_email_into_inbox_multipart_request (optional)
     ...
     * @return string[]
     */
    public function uploadMultipartForm($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $import_email_into_inbox_multipart_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        list($response) = $this->uploadMultipartFormWithHttpInfo($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $import_email_into_inbox_multipart_request, $contentType);
        return $response;
    }
     ...
     * @param  string $x_filename_raw Optional raw filename header of attachment that will be converted to punycode (optional)
     * @param  int $x_filesize Optional content size of attachment (optional)
     * @param  \MailSlurp\Models\ImportEmailIntoInboxMultipartRequest $import_email_into_inbox_multipart_request (optional)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['uploadMultipartForm'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadMultipartFormWithHttpInfo($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $import_email_into_inbox_multipart_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        $request = $this->uploadMultipartFormRequest($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $import_email_into_inbox_multipart_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipartFormAsync($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $import_email_into_inbox_multipart_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        return $this->uploadMultipartFormAsyncWithHttpInfo($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $import_email_into_inbox_multipart_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipartFormAsyncWithHttpInfo($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $import_email_into_inbox_multipart_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        $returnType = 'string[]';
        $request = $this->uploadMultipartFormRequest($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $import_email_into_inbox_multipart_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadMultipartFormRequest($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $import_email_into_inbox_multipart_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $content_type_header,
            'contentTypeHeader', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $x_filename_raw,
            'x-filename-raw', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required
        ...
        // for model (json/xml)
        if (isset($import_email_into_inbox_multipart_request)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($import_email_into_inbox_multipart_request));
            } else {
                $httpBody = $import_email_into_inbox_multipart_request;
            }
        } elseif (count($formParams) > 0) {
            if ($multipart) {
                $multipartContents = [];

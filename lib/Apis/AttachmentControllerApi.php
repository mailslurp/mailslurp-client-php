...
class AttachmentControllerApi
{
     ...
     */
    public function getAttachments($before = null, $file_name_filter = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAttachmentsWithHttpInfo($before, $file_name_filter, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAttachmentsWithHttpInfo($before = null, $file_name_filter = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAttachmentsRequest($before, $file_name_filter, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsync($before = null, $file_name_filter = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAttachmentsAsyncWithHttpInfo($before, $file_name_filter, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsyncWithHttpInfo($before = null, $file_name_filter = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageAttachmentEntity';
        $request = $this->getAttachmentsRequest($before, $file_name_filter, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAttachmentsRequest($before = null, $file_name_filter = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
     ...
     * @return string[]
     */
    public function uploadAttachmentBytes($content_type = null, $filename = null, $byte_array = null)
    {
        list($response) = $this->uploadAttachmentBytesWithHttpInfo($content_type, $filename, $byte_array);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadAttachmentBytesWithHttpInfo($content_type = null, $filename = null, $byte_array = null)
    {
        $request = $this->uploadAttachmentBytesRequest($content_type, $filename, $byte_array);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsync($content_type = null, $filename = null, $byte_array = null)
    {
        return $this->uploadAttachmentBytesAsyncWithHttpInfo($content_type, $filename, $byte_array)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadAttachmentBytesAsyncWithHttpInfo($content_type = null, $filename = null, $byte_array = null)
    {
        $returnType = 'string[]';
        $request = $this->uploadAttachmentBytesRequest($content_type, $filename, $byte_array);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function uploadAttachmentBytesRequest($content_type = null, $filename = null, $byte_array = null)
    {

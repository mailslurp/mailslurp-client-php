...
/**
     ...
     */
    public function getAttachments($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        list($response) = $this->getAttachmentsWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $contentType);
        return $response;
    }
     ...
     */
    public function getAttachmentsWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        $request = $this->getAttachmentsRequest($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsync($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        return $this->getAttachmentsAsyncWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachmentsAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, string $contentType = self::contentTypes['getAttachments'][0])
    {
        $returnType = '\MailSlurp\Models\PageAttachmentEntity';
        $request = $this->getAttachmentsRequest($page, $size, $sort, $file_name_filter, $since, $before, $inbox_id, $email_id, $sent_email_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAttachmentsRequest($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null, $inbox_id = null, $email_id = null, $sent_email_id = null, string $contentType = self::contentTypes['getAttachments'][0])
    {

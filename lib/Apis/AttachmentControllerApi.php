...
class AttachmentControllerApi
{
     ...
     */
    public function getAttachments1($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null)
    {
        list($response) = $this->getAttachments1WithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before);
        return $response;
    }
     ...
     */
    public function getAttachments1WithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null)
    {
        $request = $this->getAttachments1Request($page, $size, $sort, $file_name_filter, $since, $before);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachments1Async($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null)
    {
        return $this->getAttachments1AsyncWithHttpInfo($page, $size, $sort, $file_name_filter, $since, $before)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAttachments1AsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null)
    {
        $returnType = '\MailSlurp\Models\PageAttachmentEntity';
        $request = $this->getAttachments1Request($page, $size, $sort, $file_name_filter, $since, $before);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAttachments1Request($page = 0, $size = 20, $sort = 'ASC', $file_name_filter = null, $since = null, $before = null)
    {

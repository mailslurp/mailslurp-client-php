...
/**
     ...
     * @return string[]
     */
    public function uploadMultipartForm($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        list($response) = $this->uploadMultipartFormWithHttpInfo($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $upload_multipart_form_request, $contentType);
        return $response;
    }
     ...
     * @return array of string[], HTTP status code, HTTP response headers (array of strings)
     */
    public function uploadMultipartFormWithHttpInfo($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        $request = $this->uploadMultipartFormRequest($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $upload_multipart_form_request, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipartFormAsync($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        return $this->uploadMultipartFormAsyncWithHttpInfo($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $upload_multipart_form_request, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function uploadMultipartFormAsyncWithHttpInfo($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {
        $returnType = 'string[]';
        $request = $this->uploadMultipartFormRequest($content_id, $content_type, $filename, $content_type_header, $x_filename, $x_filename_raw, $x_filesize, $upload_multipart_form_request, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function uploadMultipartFormRequest($content_id = null, $content_type = null, $filename = null, $content_type_header = null, $x_filename = null, $x_filename_raw = null, $x_filesize = null, $upload_multipart_form_request = null, string $contentType = self::contentTypes['uploadMultipartForm'][0])
    {

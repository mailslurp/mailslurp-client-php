...
/**
     ...
     */
    public function createNewInboxRuleset($inbox_id, $create_inbox_ruleset_options, string $contentType = self::contentTypes['createNewInboxRuleset'][0])
    {
        list($response) = $this->createNewInboxRulesetWithHttpInfo($inbox_id, $create_inbox_ruleset_options, $contentType);
        return $response;
    }
     ...
     */
    public function createNewInboxRulesetWithHttpInfo($inbox_id, $create_inbox_ruleset_options, string $contentType = self::contentTypes['createNewInboxRuleset'][0])
    {
        $request = $this->createNewInboxRulesetRequest($inbox_id, $create_inbox_ruleset_options, $contentType);
     ...
     */
    public function createNewInboxRulesetAsync($inbox_id, $create_inbox_ruleset_options, string $contentType = self::contentTypes['createNewInboxRuleset'][0])
    {
        return $this->createNewInboxRulesetAsyncWithHttpInfo($inbox_id, $create_inbox_ruleset_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function createNewInboxRulesetAsyncWithHttpInfo($inbox_id, $create_inbox_ruleset_options, string $contentType = self::contentTypes['createNewInboxRuleset'][0])
    {
        $returnType = '\MailSlurp\Models\InboxRulesetDto';
        $request = $this->createNewInboxRulesetRequest($inbox_id, $create_inbox_ruleset_options, $contentType);
     ...
     */
    public function createNewInboxRulesetRequest($inbox_id, $create_inbox_ruleset_options, string $contentType = self::contentTypes['createNewInboxRuleset'][0])
    {

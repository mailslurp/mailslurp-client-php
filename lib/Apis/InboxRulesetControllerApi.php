...
class InboxRulesetControllerApi
{
     ...
     */
    public function getInboxRulesets($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getInboxRulesetsWithHttpInfo($inbox_id, $page, $search_filter, $size, $sort);
        return $response;
    }
     ...
     */
    public function getInboxRulesetsWithHttpInfo($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getInboxRulesetsRequest($inbox_id, $page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxRulesetsAsync($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        return $this->getInboxRulesetsAsyncWithHttpInfo($inbox_id, $page, $search_filter, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getInboxRulesetsAsyncWithHttpInfo($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageInboxRulesetDto';
        $request = $this->getInboxRulesetsRequest($inbox_id, $page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getInboxRulesetsRequest($inbox_id = null, $page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {

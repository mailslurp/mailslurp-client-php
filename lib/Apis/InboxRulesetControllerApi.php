...
class InboxRulesetControllerApi
{
     ...
     */
    public function createNewInboxRulesetRequest($inbox_id, $create_inbox_ruleset_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteInboxRulesetRequest($id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function deleteInboxRulesetsRequest($inbox_id = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxRulesetRequest($id)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getInboxRulesetsRequest($inbox_id = null, $page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testInboxRulesetRequest($id, $inbox_ruleset_test_options)
    {
        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testInboxRulesetsForInboxRequest($inbox_id, $inbox_ruleset_test_options)
    {
        // verify the required parameter 'inbox_id' is set
        if ($inbox_id === null || (is_array($inbox_id) && count($inbox_id) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function testNewInboxRulesetRequest($test_new_inbox_ruleset_options)
    {

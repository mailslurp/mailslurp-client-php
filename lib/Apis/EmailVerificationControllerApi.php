...
class EmailVerificationControllerApi
{
     ...
     */
    public function getValidationRequestsRequest($page = 0, $size = 20, $sort = 'DESC', $search_filter = null, $since = null, $before = null, $is_valid = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function validateEmailAddressListRequest($validate_email_address_list_options)
    {

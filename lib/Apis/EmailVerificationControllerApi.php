...
/**
    ...
    /**
     * Operation getEmailIntelligence
     *
     * Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
     *
     * @param  \MailSlurp\Models\EmailIntelligenceOptions $email_intelligence_options email_intelligence_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailIntelligence'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\EmailIntelligenceListResult
     */
    public function getEmailIntelligence($email_intelligence_options, string $contentType = self::contentTypes['getEmailIntelligence'][0])
    {
        list($response) = $this->getEmailIntelligenceWithHttpInfo($email_intelligence_options, $contentType);
        return $response;
    }

    /**
     * Operation getEmailIntelligenceWithHttpInfo
     *
     * Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
     *
     * @param  \MailSlurp\Models\EmailIntelligenceOptions $email_intelligence_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailIntelligence'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \MailSlurp\Models\EmailIntelligenceListResult, HTTP status code, HTTP response headers (array of strings)
     */
    public function getEmailIntelligenceWithHttpInfo($email_intelligence_options, string $contentType = self::contentTypes['getEmailIntelligence'][0])
    {
        $request = $this->getEmailIntelligenceRequest($email_intelligence_options, $contentType);
        ...
        try {
            ...
            switch($statusCode) {
                case 200:
                    if ('\MailSlurp\Models\EmailIntelligenceListResult' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                        if ('\MailSlurp\Models\EmailIntelligenceListResult' !== 'string') {
                            $content = json_decode($content);
                        }
                    }

                    return [
                        ObjectSerializer::deserialize($content, '\MailSlurp\Models\EmailIntelligenceListResult', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\MailSlurp\Models\EmailIntelligenceListResult';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\MailSlurp\Models\EmailIntelligenceListResult',
    ...
    /**
     * Operation getEmailIntelligenceAsync
     *
     * Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
     *
     * @param  \MailSlurp\Models\EmailIntelligenceOptions $email_intelligence_options (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailIntelligenceAsync($email_intelligence_options, string $contentType = self::contentTypes['getEmailIntelligence'][0])
    {
        return $this->getEmailIntelligenceAsyncWithHttpInfo($email_intelligence_options, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getEmailIntelligenceAsyncWithHttpInfo
     *
     * Get intelligence score and breakdown for email/domain targets. Per unit billing for non-cached evaluations.
     *
     * @param  \MailSlurp\Models\EmailIntelligenceOptions $email_intelligence_options (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getEmailIntelligenceAsyncWithHttpInfo($email_intelligence_options, string $contentType = self::contentTypes['getEmailIntelligence'][0])
    {
        $returnType = '\MailSlurp\Models\EmailIntelligenceListResult';
        $request = $this->getEmailIntelligenceRequest($email_intelligence_options, $contentType);
    ...
    /**
     * Create request for operation 'getEmailIntelligence'
     *
     * @param  \MailSlurp\Models\EmailIntelligenceOptions $email_intelligence_options (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getEmailIntelligence'] to see the possible values for this operation
     *
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getEmailIntelligenceRequest($email_intelligence_options, string $contentType = self::contentTypes['getEmailIntelligence'][0])
    {

        // verify the required parameter 'email_intelligence_options' is set
        if ($email_intelligence_options === null || (is_array($email_intelligence_options) && count($email_intelligence_options) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $email_intelligence_options when calling getEmailIntelligence'
            );
        }


        $resourcePath = '/email-verification/intelligence';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
        ...
        // for model (json/xml)
        if (isset($email_intelligence_options)) {
            if (stripos($headers['Content-Type'], 'application/json') !== false) {
                # if Content-Type contains "application/json", json_encode the body
                $httpBody = \GuzzleHttp\json_encode(ObjectSerializer::sanitizeForSerialization($email_intelligence_options));
            } else {
                $httpBody = $email_intelligence_options;
            }

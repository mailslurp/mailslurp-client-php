...
class ApiUserControllerApi
{
     ...
     * @return string
     */
    public function getJsonPropertyAsString($property, $body)
    {
        list($response) = $this->getJsonPropertyAsStringWithHttpInfo($property, $body);
        return $response;
    }
     ...
     */
    public function getJsonPropertyAsStringWithHttpInfo($property, $body)
    {
        $request = $this->getJsonPropertyAsStringRequest($property, $body);
     ...
     */
    public function getJsonPropertyAsStringAsync($property, $body)
    {
        return $this->getJsonPropertyAsStringAsyncWithHttpInfo($property, $body)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getJsonPropertyAsStringAsyncWithHttpInfo($property, $body)
    {
        $returnType = 'string';
        $request = $this->getJsonPropertyAsStringRequest($property, $body);
     ...
     */
    public function getJsonPropertyAsStringRequest($property, $body)
    {

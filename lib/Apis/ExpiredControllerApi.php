...
/**
     ...
     */
    public function getExpiredInboxes($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getExpiredInboxes'][0])
    {
        list($response) = $this->getExpiredInboxesWithHttpInfo($page, $size, $sort, $since, $before, $inbox_id, $contentType);
        return $response;
    }
     ...
     */
    public function getExpiredInboxesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getExpiredInboxes'][0])
    {
        $request = $this->getExpiredInboxesRequest($page, $size, $sort, $since, $before, $inbox_id, $contentType);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxesAsync($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getExpiredInboxes'][0])
    {
        return $this->getExpiredInboxesAsyncWithHttpInfo($page, $size, $sort, $since, $before, $inbox_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getExpiredInboxes'][0])
    {
        $returnType = '\MailSlurp\Models\PageExpiredInboxRecordProjection';
        $request = $this->getExpiredInboxesRequest($page, $size, $sort, $since, $before, $inbox_id, $contentType);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpiredInboxesRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null, $inbox_id = null, string $contentType = self::contentTypes['getExpiredInboxes'][0])
    {

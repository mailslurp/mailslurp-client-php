...
class ExpiredControllerApi
{
     ...
     */
    public function getExpirationDefaultsRequest()
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpiredInboxByInboxIdRequest($inbox_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpiredInboxRecordRequest($expired_id)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getExpiredInboxesRequest($page = 0, $size = 20, $sort = 'ASC', $since = null, $before = null)
    {

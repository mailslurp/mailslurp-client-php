...
class ExpiredControllerApi
{
     ...
     */
    public function getExpiredInboxes($page = 0, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getExpiredInboxesWithHttpInfo($page, $size, $sort);
        return $response;
    }
     ...
     */
    public function getExpiredInboxesWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $request = $this->getExpiredInboxesRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxesAsync($page = 0, $size = 20, $sort = 'ASC')
    {
        return $this->getExpiredInboxesAsyncWithHttpInfo($page, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxesAsyncWithHttpInfo($page = 0, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageExpiredInboxRecordProjection';
        $request = $this->getExpiredInboxesRequest($page, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExpiredInboxesRequest($page = 0, $size = 20, $sort = 'ASC')
    {

...
class ExpiredControllerApi
{
     ...
     */
    public function getExpiredInboxes($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getExpiredInboxesWithHttpInfo($before, $page, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getExpiredInboxesWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getExpiredInboxesRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxesAsync($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getExpiredInboxesAsyncWithHttpInfo($before, $page, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getExpiredInboxesAsyncWithHttpInfo($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageExpiredInboxRecordProjection';
        $request = $this->getExpiredInboxesRequest($before, $page, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getExpiredInboxesRequest($before = null, $page = 0, $since = null, $size = 20, $sort = 'ASC')
    {

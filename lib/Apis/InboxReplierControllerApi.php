...
/**
    ...
    /**
     * Operation getAllInboxReplierEvents
     *
     ...
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['getAllInboxReplierEvents'] to see the possible values for this operation
     *
     * @throws \MailSlurp\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \MailSlurp\Models\PageInboxReplierEvents
     */
    public function getAllInboxReplierEvents($inbox_replier_id = null, $inbox_id = null, $email_id = null, $sent_id = null, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxReplierEvents'][0])
    {
        list($response) = $this->getAllInboxReplierEventsWithHttpInfo($inbox_replier_id, $inbox_id, $email_id, $sent_id, $page, $size, $sort, $contentType);
        return $response;
    }

    /**
     * Operation getAllInboxReplierEventsWithHttpInfo
     *
     * Get inbox replier event list
     *
     * @param  string $inbox_replier_id ID of inbox replier (optional)
     ...
     */
    public function getAllInboxReplierEventsWithHttpInfo($inbox_replier_id = null, $inbox_id = null, $email_id = null, $sent_id = null, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxReplierEvents'][0])
    {
        $request = $this->getAllInboxReplierEventsRequest($inbox_replier_id, $inbox_id, $email_id, $sent_id, $page, $size, $sort, $contentType);
    ...
    /**
     * Operation getAllInboxReplierEventsAsync
     *
     * Get inbox replier event list
     *
     * @param  string $inbox_replier_id ID of inbox replier (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxReplierEventsAsync($inbox_replier_id = null, $inbox_id = null, $email_id = null, $sent_id = null, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxReplierEvents'][0])
    {
        return $this->getAllInboxReplierEventsAsyncWithHttpInfo($inbox_replier_id, $inbox_id, $email_id, $sent_id, $page, $size, $sort, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation getAllInboxReplierEventsAsyncWithHttpInfo
     *
     * Get inbox replier event list
     *
     * @param  string $inbox_replier_id ID of inbox replier (optional)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllInboxReplierEventsAsyncWithHttpInfo($inbox_replier_id = null, $inbox_id = null, $email_id = null, $sent_id = null, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxReplierEvents'][0])
    {
        $returnType = '\MailSlurp\Models\PageInboxReplierEvents';
        $request = $this->getAllInboxReplierEventsRequest($inbox_replier_id, $inbox_id, $email_id, $sent_id, $page, $size, $sort, $contentType);
    ...
    /**
     * Create request for operation 'getAllInboxReplierEvents'
     *
     * @param  string $inbox_replier_id ID of inbox replier (optional)
     * @param  string $inbox_id ID of inbox (optional)
     * @param  string $email_id ID of email (optional)
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllInboxReplierEventsRequest($inbox_replier_id = null, $inbox_id = null, $email_id = null, $sent_id = null, $page = 0, $size = 20, $sort = 'ASC', string $contentType = self::contentTypes['getAllInboxReplierEvents'][0])
    {
        ...
        $queryParams = array_merge($queryParams, ObjectSerializer::toQueryValue(
            $inbox_replier_id,
            'inboxReplierId', // param base name
            'string', // openApiType
            'form', // style
            true, // explode
            false // required

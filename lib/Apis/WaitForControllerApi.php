...
class WaitForControllerApi
{
     ...
     * @return \MailSlurp\Models\Email
     */
    public function waitForMatchingFirstEmail($match_options, $inbox_id = null, $timeout = null, $unread_only = false)
    {
        list($response) = $this->waitForMatchingFirstEmailWithHttpInfo($match_options, $inbox_id, $timeout, $unread_only);
        return $response;
    }
     ...
     * @return array of \MailSlurp\Models\Email, HTTP status code, HTTP response headers (array of strings)
     */
    public function waitForMatchingFirstEmailWithHttpInfo($match_options, $inbox_id = null, $timeout = null, $unread_only = false)
    {
        $request = $this->waitForMatchingFirstEmailRequest($match_options, $inbox_id, $timeout, $unread_only);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForMatchingFirstEmailAsync($match_options, $inbox_id = null, $timeout = null, $unread_only = false)
    {
        return $this->waitForMatchingFirstEmailAsyncWithHttpInfo($match_options, $inbox_id, $timeout, $unread_only)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForMatchingFirstEmailAsyncWithHttpInfo($match_options, $inbox_id = null, $timeout = null, $unread_only = false)
    {
        $returnType = '\MailSlurp\Models\Email';
        $request = $this->waitForMatchingFirstEmailRequest($match_options, $inbox_id, $timeout, $unread_only);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function waitForMatchingFirstEmailRequest($match_options, $inbox_id = null, $timeout = null, $unread_only = false)
    {
        // verify the required parameter 'match_options' is set
        if ($match_options === null || (is_array($match_options) && count($match_options) === 0)) {
            throw new \InvalidArgumentException(
     ...
     * @return \MailSlurp\Models\Email
     */
    public function waitForNthEmail($inbox_id = null, $index = 0, $timeout = null, $unread_only = false)
    {
     ...
     * @return array of \MailSlurp\Models\Email, HTTP status code, HTTP response headers (array of strings)
     */
    public function waitForNthEmailWithHttpInfo($inbox_id = null, $index = 0, $timeout = null, $unread_only = false)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForNthEmailAsync($inbox_id = null, $index = 0, $timeout = null, $unread_only = false)
    {
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForNthEmailAsyncWithHttpInfo($inbox_id = null, $index = 0, $timeout = null, $unread_only = false)
    {
        $returnType = '\MailSlurp\Models\Email';
        $request = $this->waitForNthEmailRequest($inbox_id, $index, $timeout, $unread_only);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function waitForNthEmailRequest($inbox_id = null, $index = 0, $timeout = null, $unread_only = false)
    {

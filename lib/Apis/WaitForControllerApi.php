...
class WaitForControllerApi
{
     ...
     * @param  int $index Zero based index of the email to wait for. If an inbox has 1 email already and you want to wait for the 2nd email pass index&#x3D;1 (optional)

...
class WaitForControllerApi
{
     ...
     */
    public function waitForLatestSms($wait_for_single_sms_options)
    {
        list($response) = $this->waitForLatestSmsWithHttpInfo($wait_for_single_sms_options);
        return $response;
    }
     ...
     */
    public function waitForLatestSmsWithHttpInfo($wait_for_single_sms_options)
    {
        $request = $this->waitForLatestSmsRequest($wait_for_single_sms_options);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForLatestSmsAsync($wait_for_single_sms_options)
    {
        return $this->waitForLatestSmsAsyncWithHttpInfo($wait_for_single_sms_options)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function waitForLatestSmsAsyncWithHttpInfo($wait_for_single_sms_options)
    {
        $returnType = '\MailSlurp\Models\SmsDto';
        $request = $this->waitForLatestSmsRequest($wait_for_single_sms_options);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function waitForLatestSmsRequest($wait_for_single_sms_options)
    {

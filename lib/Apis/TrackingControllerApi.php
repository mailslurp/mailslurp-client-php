...
class TrackingControllerApi
{
     ...
     */
    public function getAllTrackingPixels($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllTrackingPixelsWithHttpInfo($page, $search_filter, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllTrackingPixelsWithHttpInfo($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllTrackingPixelsRequest($page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTrackingPixelsAsync($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAllTrackingPixelsAsyncWithHttpInfo($page, $search_filter, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTrackingPixelsAsyncWithHttpInfo($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageTrackingPixelProjection';
        $request = $this->getAllTrackingPixelsRequest($page, $search_filter, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllTrackingPixelsRequest($page = 0, $search_filter = null, $size = 20, $sort = 'ASC')
    {

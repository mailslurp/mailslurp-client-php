...
class TrackingControllerApi
{
     ...
     *
     * @param  \MailSlurp\Models\CreateTrackingPixelOptions $create_tracking_pixel_options createTrackingPixelOptions (required)
     *
     ...
     */
    public function getAllTrackingPixels($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        list($response) = $this->getAllTrackingPixelsWithHttpInfo($before, $page, $search_filter, $since, $size, $sort);
        return $response;
    }
     ...
     */
    public function getAllTrackingPixelsWithHttpInfo($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        $request = $this->getAllTrackingPixelsRequest($before, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTrackingPixelsAsync($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        return $this->getAllTrackingPixelsAsyncWithHttpInfo($before, $page, $search_filter, $since, $size, $sort)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function getAllTrackingPixelsAsyncWithHttpInfo($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {
        $returnType = '\MailSlurp\Models\PageTrackingPixelProjection';
        $request = $this->getAllTrackingPixelsRequest($before, $page, $search_filter, $since, $size, $sort);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function getAllTrackingPixelsRequest($before = null, $page = 0, $search_filter = null, $since = null, $size = 20, $sort = 'ASC')
    {

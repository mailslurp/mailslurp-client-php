...
class TrackingControllerApi
{
     ...
     */
    public function createTrackingPixelRequest($create_tracking_pixel_options)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getAllTrackingPixelsRequest($page = 0, $size = 20, $sort = 'ASC', $search_filter = null, $since = null, $before = null)
    {
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function getTrackingPixelRequest($id)
    {

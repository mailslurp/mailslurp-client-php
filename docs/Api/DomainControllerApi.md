...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **domain_options** | [**\MailSlurp\Models\CreateDomainOptions**](../Model/CreateDomainOptions)| domainOptions |
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/)| id |
 **update_domain_dto** | [**\MailSlurp\Models\UpdateDomainOptions**](../Model/UpdateDomainOptions)| updateDomainDto |

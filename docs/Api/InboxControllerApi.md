...
> \MailSlurp\Models\EmailPreview[] getEmails($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_, $limit, $sort_the_results_by_received_date_and_direction_asc_or_desc, $retry_timeout, $delay_timeout, $min_count, $unread_only, $before, $since)
...
try {
    $result = $apiInstance->getEmails($inbox_id, $alias_for_limit__assessed_first_before_assessing_any_passed_limit_, $limit, $sort_the_results_by_received_date_and_direction_asc_or_desc, $retry_timeout, $delay_timeout, $min_count, $unread_only, $before, $since);
    print_r($result);
} catch (Exception $e) {

...
> createInboxRuleset($inbox_id, $create_inbox_ruleset_options)
...
try {
    $apiInstance->createInboxRuleset($inbox_id, $create_inbox_ruleset_options);
} catch (Exception $e) {
...
> listInboxRulesets($inbox_id, $page, $search_filter, $size, $sort)
...
try {
    $apiInstance->listInboxRulesets($inbox_id, $page, $search_filter, $size, $sort);
} catch (Exception $e) {

...
> \MailSlurp\Models\EmailPreview[] getEmails($inbox_id, $delay_timeout, $limit, $min_count, $retry_timeout, $since, $size, $sort, $unread_only)
...
try {
    $result = $apiInstance->getEmails($inbox_id, $delay_timeout, $limit, $min_count, $retry_timeout, $since, $size, $sort, $unread_only);
    print_r($result);
} catch (Exception $e) {

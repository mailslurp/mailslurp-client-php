...
> \MailSlurp\Models\InboxDto createInbox($email_address, $tags, $name, $description, $use_domain_pool, $favourite, $expires_at, $expires_in, $allow_team_access, $inbox_type, $virtual_inbox)
...
> \MailSlurp\Models\PageInboxProjection getAllInboxes($page, $size, $sort, $favourite, $search, $tag, $team_access, $since, $before, $inbox_type, $domain_id)
 ...
 **domain_id** | [**string**](../Model/)| Optional domain ID filter | [optional]
...
> \MailSlurp\Models\PageDeliveryStatus getDeliveryStatusesByInboxId($inbox_id, $page, $size, $sort, $since, $before)
...
> \MailSlurp\Models\InboxByNameResult getInboxByName($name)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**string**](../Model/)| ID of inbox to set favourite state |

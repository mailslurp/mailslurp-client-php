...
> \MailSlurp\Models\Inbox createInbox($allow_team_access, $description, $email_address, $expires_at, $expires_in, $favourite, $name, $tags, $use_domain_pool)
...
try {
    $result = $apiInstance->createInbox($allow_team_access, $description, $email_address, $expires_at, $expires_in, $favourite, $name, $tags, $use_domain_pool);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\PageOrganizationInboxProjection getOrganizationInboxes($page, $size, $sort)
...
try {
    $result = $apiInstance->getOrganizationInboxes($page, $size, $sort);
    print_r($result);
} catch (Exception $e) {
...
[**\MailSlurp\Models\PageOrganizationInboxProjection**](../Model/PageOrganizationInboxProjection.md)

...
```php
addContactsToGroup($group_id, $update_group_contacts): \MailSlurp\Models\GroupContactsDto
```
...
```php
createGroup($create_group_options): \MailSlurp\Models\GroupDto
```
...
```php
getAllGroups($page, $size, $sort, $since, $before): \MailSlurp\Models\PageGroupProjection
```
...
```php
getGroup($group_id): \MailSlurp\Models\GroupDto
```
...
```php
getGroupWithContacts($group_id): \MailSlurp\Models\GroupContactsDto
```
...
```php
getGroupWithContactsPaginated($group_id, $page, $size, $sort, $since, $before): \MailSlurp\Models\PageContactProjection
```
...
```php
getGroups(): \MailSlurp\Models\GroupProjection[]
```
...
```php
removeContactsFromGroup($group_id, $update_group_contacts): \MailSlurp\Models\GroupContactsDto
```

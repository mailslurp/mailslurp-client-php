...
> \MailSlurp\Models\PageBouncedEmail getBouncedEmails($before, $page, $since, $size, $sort)
...
try {
    $result = $apiInstance->getBouncedEmails($before, $page, $since, $size, $sort);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\PageBouncedRecipients getBouncedRecipients($before, $page, $since, $size, $sort)
...
try {
    $result = $apiInstance->getBouncedRecipients($before, $page, $since, $size, $sort);
    print_r($result);
} catch (Exception $e) {

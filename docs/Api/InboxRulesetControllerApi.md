...
> \MailSlurp\Models\PageInboxRulesetDto getInboxRulesets($before, $inbox_id, $page, $search_filter, $since, $size, $sort)
...
try {
    $result = $apiInstance->getInboxRulesets($before, $inbox_id, $page, $search_filter, $since, $size, $sort);
    print_r($result);
} catch (Exception $e) {
...
$id = 'id_example'; // string | ID of inbox ruleset
$inbox_ruleset_test_options = new \MailSlurp\Models\InboxRulesetTestOptions(); // \MailSlurp\Models\InboxRulesetTestOptions | inboxRulesetTestOptions
...
------------- | ------------- | ------------- | -------------
 **id** | [**string**](../Model/)| ID of inbox ruleset |
 **inbox_ruleset_test_options** | [**\MailSlurp\Models\InboxRulesetTestOptions**](../Model/InboxRulesetTestOptions)| inboxRulesetTestOptions |
...
$test_new_inbox_ruleset_options = new \MailSlurp\Models\TestNewInboxRulesetOptions(); // \MailSlurp\Models\TestNewInboxRulesetOptions | testNewInboxRulesetOptions
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **test_new_inbox_ruleset_options** | [**\MailSlurp\Models\TestNewInboxRulesetOptions**](../Model/TestNewInboxRulesetOptions)| testNewInboxRulesetOptions |

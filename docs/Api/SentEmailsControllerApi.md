...
> \MailSlurp\Models\DeliveryStatusDto getSentDeliveryStatus($delivery_id)
...
> \MailSlurp\Models\PageDeliveryStatus getSentDeliveryStatuses($page, $size, $sort, $since, $before)
...
> \MailSlurp\Models\PageDeliveryStatus getSentDeliveryStatusesBySentId($sent_id, $page, $size, $sort, $since, $before)
...
> \MailSlurp\Models\PageSentEmailWithQueueProjection getSentEmailsWithQueueResults($page, $size, $sort, $since, $before)
...
> \MailSlurp\Models\DeliveryStatusDto waitForDeliveryStatuses($sent_id, $inbox_id, $timeout, $index, $since, $before)

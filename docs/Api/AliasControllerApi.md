...
```php
createAlias($create_alias_options): \MailSlurp\Models\AliasDto
```
...
```php
getAlias($alias_id): \MailSlurp\Models\AliasDto
```
...
```php
getAliasEmails($alias_id, $page, $size, $sort, $since, $before): \MailSlurp\Models\PageEmailProjection
```
...
```php
getAliasThreads($alias_id, $page, $size, $sort, $since, $before): \MailSlurp\Models\PageThreadProjection
```
...
```php
getAliases($page, $size, $sort, $since, $before): \MailSlurp\Models\PageAlias
```
...
```php
replyToAliasEmail($alias_id, $email_id, $reply_to_alias_email_options): \MailSlurp\Models\SentEmailDto
```
...
```php
sendAliasEmail($alias_id, $send_email_options): \MailSlurp\Models\SentEmailDto
```
...
```php
updateAlias($alias_id, $update_alias_options): \MailSlurp\Models\AliasDto
```

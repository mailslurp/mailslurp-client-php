...
------------- | ------------- | ------------- | -------------
 **create_alias_options** | [**\MailSlurp\Models\CreateAliasOptions**](../Model/CreateAliasOptions)| createAliasOptions |
...
> \MailSlurp\Models\PageEmailProjection getAliasEmails($alias_id, $before, $page, $since, $size, $sort)
...
> \MailSlurp\Models\PageThreadProjection getAliasThreads($alias_id, $before, $page, $since, $size, $sort)
...
> \MailSlurp\Models\PageAlias getAliases($before, $page, $since, $size, $sort)
 ...
 **reply_to_alias_email_options** | [**\MailSlurp\Models\ReplyToAliasEmailOptions**](../Model/ReplyToAliasEmailOptions)| replyToAliasEmailOptions |
...
------------- | ------------- | ------------- | -------------
 **alias_id** | [**string**](../Model/)| aliasId |
 **send_email_options** | [**\MailSlurp\Models\SendEmailOptions**](../Model/SendEmailOptions)| Options for the email to be sent | [optional]
...
------------- | ------------- | ------------- | -------------
 **alias_id** | [**string**](../Model/)| aliasId |
 **update_alias_options** | [**\MailSlurp\Models\UpdateAliasOptions**](../Model/UpdateAliasOptions)| updateAliasOptions |

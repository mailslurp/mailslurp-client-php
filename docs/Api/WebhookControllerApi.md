...
> \MailSlurp\Models\PageWebhookResult getAllWebhookResults($before, $page, $search_filter, $since, $size, $sort)
...
try {
    $result = $apiInstance->getAllWebhookResults($before, $page, $search_filter, $since, $size, $sort);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\PageWebhookResult getWebhookResults($webhook_id, $before, $page, $search_filter, $since, $size, $sort)
...
try {
    $result = $apiInstance->getWebhookResults($webhook_id, $before, $page, $search_filter, $since, $size, $sort);
    print_r($result);
} catch (Exception $e) {

...
> \MailSlurp\Models\PageTrackingPixelProjection getAllTrackingPixels($page, $search_filter, $size, $sort)
...
try {
    $result = $apiInstance->getAllTrackingPixels($page, $search_filter, $size, $sort);
    print_r($result);
} catch (Exception $e) {

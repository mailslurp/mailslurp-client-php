...
> \MailSlurp\Models\EmailPreview[] waitForMatchingEmail($match_options, $count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForMatchingEmail($match_options, $count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {

...
> \MailSlurp\Models\EmailPreview[] waitForEmailCount($before, $count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
> \MailSlurp\Models\Email waitForLatestEmail($before, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
> \MailSlurp\Models\EmailPreview[] waitForMatchingEmails($match_options, $before, $count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
> \MailSlurp\Models\Email waitForMatchingFirstEmail($match_options, $before, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
> \MailSlurp\Models\Email waitForNthEmail($before, $delay, $inbox_id, $index, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForNthEmail($before, $delay, $inbox_id, $index, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {

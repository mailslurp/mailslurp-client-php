...
> \MailSlurp\Models\EmailPreview[] waitForEmailCount($count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForEmailCount($count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\Email waitForLatestEmail($delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForLatestEmail($delay, $inbox_id, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\EmailPreview[] waitForMatchingEmails($match_options, $count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForMatchingEmails($match_options, $count, $delay, $inbox_id, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\Email waitForMatchingFirstEmail($match_options, $delay, $inbox_id, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForMatchingFirstEmail($match_options, $delay, $inbox_id, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\Email waitForNthEmail($delay, $inbox_id, $index, $since, $sort, $timeout, $unread_only)
...
try {
    $result = $apiInstance->waitForNthEmail($delay, $inbox_id, $index, $since, $sort, $timeout, $unread_only);
    print_r($result);
} catch (Exception $e) {

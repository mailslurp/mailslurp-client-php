...
> \MailSlurp\Models\EmailTextLinesResult getEmailTextLines($email_id, $decode_html_entities)
...
try {
    $result = $apiInstance->getEmailTextLines($email_id, $decode_html_entities);
    print_r($result);
} catch (Exception $e) {

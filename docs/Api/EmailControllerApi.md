...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **email_id** | [**string**](../Model/.md)| ID of email to perform HTML query on |
...
[**\MailSlurp\Models\EmailTextLinesResult**](../Model/EmailTextLinesResult.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **email_id** | [**string**](../Model/.md)| ID of email to fetch text for |
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_ids** | [**string[]**](../Model/string.md)| Optional set of inboxes to filter by. Only get the latest email from these inbox IDs | [optional]
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**string**](../Model/.md)| ID of the inbox you want to get the latest email from | [optional]

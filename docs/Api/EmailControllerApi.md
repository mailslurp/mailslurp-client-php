...
> \MailSlurp\Models\AttachmentMetaData[] getAttachments1($email_id)
...
try {
    $result = $apiInstance->getAttachments1($email_id);
    print_r($result);
} catch (Exception $e) {
    echo 'Exception when calling EmailControllerApi->getAttachments1: ', $e->getMessage(), PHP_EOL;
}
?>
```
...
> \MailSlurp\Models\PageEmailProjection getEmailsPaginated($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only)
...
try {
    $result = $apiInstance->getEmailsPaginated($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\PageEmailProjection getOrganizationEmailsPaginated($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only)
...
try {
    $result = $apiInstance->getOrganizationEmailsPaginated($before, $inbox_id, $page, $search_filter, $since, $size, $sort, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> sendEmailSourceOptional($inbox_id, $use_domain_pool, $send_email_options)
...
try {
    $apiInstance->sendEmailSourceOptional($inbox_id, $use_domain_pool, $send_email_options);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**string**](../Model/)| ID of the inbox you want to send the email from | [optional]

...
> \MailSlurp\Models\EmailTextLinesResult getEmailTextLines($decode_html_entities, $email_id)
...
try {
    $result = $apiInstance->getEmailTextLines($decode_html_entities, $email_id);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **decode_html_entities** | **bool**| Decode HTML entities |

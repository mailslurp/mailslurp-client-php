...
> \MailSlurp\Models\PageEmailProjection getEmailsPaginated($inbox_id, $page, $search_filter, $size, $sort, $unread_only)
...
try {
    $result = $apiInstance->getEmailsPaginated($inbox_id, $page, $search_filter, $size, $sort, $unread_only);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\PageEmailProjection getOrganizationEmailsPaginated($inbox_id, $page, $search_filter, $size, $sort, $unread_only)
...
try {
    $result = $apiInstance->getOrganizationEmailsPaginated($inbox_id, $page, $search_filter, $size, $sort, $unread_only);
    print_r($result);
} catch (Exception $e) {

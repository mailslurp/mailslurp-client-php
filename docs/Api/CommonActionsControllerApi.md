...
> \MailSlurp\Models\Inbox createNewEmailAddress($allow_team_access, $description, $email_address, $expires_at, $expires_in, $favourite, $inbox_type, $name, $tags, $use_domain_pool)
...
$favourite = True; // bool | favourite
$inbox_type = 'inbox_type_example'; // string | inboxType
$name = 'name_example'; // string | name
$tags = array('tags_example'); // string[] | tags
$use_domain_pool = True; // bool | useDomainPool

try {
    $result = $apiInstance->createNewEmailAddress($allow_team_access, $description, $email_address, $expires_at, $expires_in, $favourite, $inbox_type, $name, $tags, $use_domain_pool);
    print_r($result);
} catch (Exception $e) {
 ...
 **tags** | [**string[]**](../Model/string)| tags | [optional]
...
> \MailSlurp\Models\Inbox createNewEmailAddress1($allow_team_access, $description, $email_address, $expires_at, $expires_in, $favourite, $inbox_type, $name, $tags, $use_domain_pool)
...
try {
    $result = $apiInstance->createNewEmailAddress1($allow_team_access, $description, $email_address, $expires_at, $expires_in, $favourite, $inbox_type, $name, $tags, $use_domain_pool);
    print_r($result);
} catch (Exception $e) {

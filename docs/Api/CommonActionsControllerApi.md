...
> \MailSlurp\Models\InboxDto createNewEmailAddress1($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite)
...
try {
    $result = $apiInstance->createNewEmailAddress1($allow_team_access, $use_domain_pool, $expires_at, $expires_in, $email_address, $inbox_type, $description, $name, $tags, $favourite);
    print_r($result);
} catch (Exception $e) {

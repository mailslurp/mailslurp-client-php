...
> \MailSlurp\Models\Inbox createNewEmailAddress($expires_at, $expires_in, $use_domain_pool)
...
try {
    $result = $apiInstance->createNewEmailAddress($expires_at, $expires_in, $use_domain_pool);
    print_r($result);
} catch (Exception $e) {
...
> \MailSlurp\Models\Inbox createNewEmailAddress1($expires_at, $expires_in, $use_domain_pool)
...
try {
    $result = $apiInstance->createNewEmailAddress1($expires_at, $expires_in, $use_domain_pool);
    print_r($result);
} catch (Exception $e) {

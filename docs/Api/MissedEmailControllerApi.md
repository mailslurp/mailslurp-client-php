...
> \MailSlurp\Models\MissedEmail waitForNthMissedEmail($inbox_id, $timeout, $index)
...
try {
    $result = $apiInstance->waitForNthMissedEmail($inbox_id, $timeout, $index);
    print_r($result);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **inbox_id** | [**string**](../Model/)| Optional inbox ID filter |

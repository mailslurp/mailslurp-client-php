...
> \MailSlurp\Models\PageMissedEmailProjection getAllMissedEmails($page, $search_filter, $size, $sort)
...
try {
    $result = $apiInstance->getAllMissedEmails($page, $search_filter, $size, $sort);
    print_r($result);
} catch (Exception $e) {

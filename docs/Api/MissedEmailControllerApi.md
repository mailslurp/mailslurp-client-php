...
> \MailSlurp\Models\PageUnknownMissedEmailProjection getAllUnknownMissedEmails($inbox_id, $page, $search_filter, $size, $sort)
...
try {
    $result = $apiInstance->getAllUnknownMissedEmails($inbox_id, $page, $search_filter, $size, $sort);
    print_r($result);
} catch (Exception $e) {

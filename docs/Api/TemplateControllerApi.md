...
> string getTemplatePreviewHtml($template_id)
...
> \MailSlurp\Models\TemplatePreview getTemplatePreviewJson($template_id)
...
[**\MailSlurp\Models\TemplatePreview**](../Model/TemplatePreview)

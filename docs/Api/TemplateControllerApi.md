...
------------- | ------------- | ------------- | -------------
 **create_template_options** | [**\MailSlurp\Models\CreateTemplateOptions**](../Model/CreateTemplateOptions.md)| createTemplateOptions |

### Return type

[**\MailSlurp\Models\TemplateDto**](../Model/TemplateDto.md)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **template_id** | [**string**](../Model/.md)| TemplateId |
...
[**\MailSlurp\Models\PageTemplateProjection**](../Model/PageTemplateProjection.md)
...
[**\MailSlurp\Models\TemplateProjection[]**](../Model/TemplateProjection.md)

...
> \MailSlurp\Models\PageInboxForwarderDto getInboxForwarders($inbox_id, $page, $search_filter, $size, $sort)
...
try {
    $result = $apiInstance->getInboxForwarders($inbox_id, $page, $search_filter, $size, $sort);
    print_r($result);
} catch (Exception $e) {

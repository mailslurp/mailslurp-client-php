...
- [Full method documentation](https://www.mailslurp.com/docs/php/docs/)
...
See the method documentation for a [list of all functions](https://www.mailslurp.com/docs/php/docs/).
...
To call the MailSlurp API you must create an instance of the controller you wish to access. Each instance must be configured with an API Key. See method documentation for a [list of all controllers and methods](https://www.mailslurp.com/docs/php/docs/).
...
For more functions and examples [read the library documentation](https://www.mailslurp.com/docs/php/docs/) or see the [PHP guides](https://www.mailslurp.com/tags/php).

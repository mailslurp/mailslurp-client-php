...
{{<gen_php_phpunit_simple_usecase>}}

## Video tutorial

[![PHP mailslurp tutorial](https://www.mailslurp.com/video-thumbnails/php-tutorial.jpeg)](https://youtu.be/7xEB2-gy150)
...
{{<gen_php_phpunit_get_config>}}

### Create a controller

{{<gen_php_phpunit_create_controller>}}
...
{{<gen_php_phpunit_create_smtp_inbox>}}

Then use the access settings to configure PHPMailer:

{{<gen_php_phpunit_phpmailer_config>}}
...
{{<gen_php_phpunit_extract_pattern>}}

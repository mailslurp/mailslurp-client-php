...
- [Full method documentation](https://mailslurp.github.io/mailslurp-client-php/)
...
See the method documentation for a [list of all functions](https://mailslurp.github.io/mailslurp-client-php/).
...
To call the MailSlurp API you must create an instance of the controller you wish to access. Each instance must be configured with an API Key. See method documentation for a [list of all controllers and methods](https://mailslurp.github.io/mailslurp-client-php/).
...
For more functions and examples [read the library documentation](https://mailslurp.github.io/mailslurp-client-php/) or see the [PHP guides](https://www.mailslurp.com/tags/php).

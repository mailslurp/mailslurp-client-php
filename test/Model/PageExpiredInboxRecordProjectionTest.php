<?php
/**
 * PageExpiredInboxRecordProjectionTest
 *
 * PHP version 5
 *
 * @category Class
...
/**
 * PageExpiredInboxRecordProjectionTest Class Doc Comment
 *
 * @category    Class
 * @description Paginated expired inbox results. Page index starts at zero. Projection results may omit larger entity fields. For fetching a full inbox entity use the projection ID with individual method calls.
 * @package     MailSlurp
 * @author      OpenAPI Generator team
 * @link        https://openapi-generator.tech
 */
class PageExpiredInboxRecordProjectionTest extends TestCase
{
     ...
     */
    public function testPageExpiredInboxRecordProjection()
    {
    }
